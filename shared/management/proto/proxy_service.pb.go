...
const file_proxy_service_proto_rawDesc = "" +
	...
	"management\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf6\x01\n" +
	"\x11ProxyCapabilities\x127\n" +
	"\x15supports_custom_ports\x18\x01 \x01(\bH\x00R\x13supportsCustomPorts\x88\x01\x01\x120\n" +
	"\x11require_subdomain\x18\x02 \x01(\bH\x01R\x10requireSubdomain\x88\x01\x01\x120\n" +
	"\x11supports_crowdsec\x18\x03 \x01(\bH\x02R\x10supportsCrowdsec\x88\x01\x01B\x18\n" +
	"\x16_supports_custom_portsB\x14\n" +
	"\x12_require_subdomainB\x14\n" +
	"\x12_supports_crowdsec\"\xe6\x01\n" +
	...
	"\fheader_auths\x18\x06 \x03(\v2\x16.management.HeaderAuthR\vheaderAuths\"\xdd\x01\n" +
	...
	"\x11blocked_countries\x18\x04 \x03(\tR\x10blockedCountries\x12#\n" +
	"\rcrowdsec_mode\x18\x05 \x01(\tR\fcrowdsecMode\"\xe6\x03\n" +
	"\fProxyMapping\x126\n" +
	...
	"\x15SendAccessLogResponse\"\x84\x05\n" +
	"\tAccessLog\x128\n" +
	...
	"\bprotocol\x18\x10 \x01(\tR\bprotocol\x12?\n" +
	"\bmetadata\x18\x11 \x03(\v2#.management.AccessLog.MetadataEntryR\bmetadata\x1a;\n" +
