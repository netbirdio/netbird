...
type ResolveCredentialRequest struct {
	...
	// AccountID owning the credential.
	AccountId string `protobuf:"bytes,1,opt,name=account_id,json=accountId,proto3" json:"account_id,omitempty"`
	// CredentialRef matches the dns_credentials_ref field on a ProxyMapping.
...
func (x *ResolveCredentialRequest) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
func (x *ResolveCredentialRequest) GetCredentialRef() string {
	if x != nil {
...
type ResolveCredentialResponse struct {
	...
	// Secret is the decrypted credential value to feed to the DNS provider
	// (e.g., a Cloudflare API token).
	Secret string `protobuf:"bytes,1,opt,name=secret,proto3" json:"secret,omitempty"`
	// ProviderType is the credential's stored provider name (e.g.,
	// "cloudflare"). The proxy validates this matches the service's
	// dns_provider field.
...
func (x *ResolveCredentialResponse) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *ResolveCredentialResponse) GetProviderType() string {
	if x != nil {
...
type ProxyMapping struct {
	...
	// ACME challenge type for cert issuance: "" (use server default),
	// "tls-alpn-01", "http-01", or "dns-01".
	ChallengeType *string `protobuf:"bytes,13,opt,name=challenge_type,json=challengeType,proto3,oneof" json:"challenge_type,omitempty"`
	// DNS provider name for dns-01 issuance (e.g., "cloudflare",
	// "route53", "rfc2136"). Required when challenge_type is "dns-01";
	// must be empty otherwise.
	DnsProvider *string `protobuf:"bytes,14,opt,name=dns_provider,json=dnsProvider,proto3,oneof" json:"dns_provider,omitempty"`
	// Opaque reference to the encrypted DNS provider credential record.
	// Resolved by the proxy when invoking the dns-01 issuer.
	DnsCredentialsRef *string `protobuf:"bytes,15,opt,name=dns_credentials_ref,json=dnsCredentialsRef,proto3,oneof" json:"dns_credentials_ref,omitempty"`
	// When true, the service is private: it lives entirely inside the
	// NetBird mesh, with no public listener and no public DNS record.
	// Older proxies that don't recognize this field treat the service
	// as public (the safe default).
	Private *bool `protobuf:"varint,16,opt,name=private,proto3,oneof" json:"private,omitempty"`
}
...
func (x *ProxyMapping) GetChallengeType() string {
...
func (x *ProxyMapping) GetDnsProvider() string {
	if x != nil && x.DnsProvider != nil {
		return *x.DnsProvider
	}
	return ""
}

func (x *ProxyMapping) GetDnsCredentialsRef() string {
	if x != nil && x.DnsCredentialsRef != nil {
		return *x.DnsCredentialsRef
	}
	return ""
}
...
var file_proxy_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x60, 0x0a, 0x18, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x43, 0x72, 0x65,
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d,
	0x0a, 0x0a, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x25, 0x0a,
	0x0e, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x5f, 0x72, 0x65, 0x66, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61,
	0x6c, 0x52, 0x65, 0x66, 0x22, 0x58, 0x0a, 0x19, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x43,
	...
	,
	...
	0x72, 0x6f, 0x77, 0x64, 0x73, 0x65, 0x63, 0x22, 0xe6, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x4d,
	0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x22, 0x82, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x55,
	...
	0x70, 0x6c, 0x65, 0x74, 0x65, 0x22, 0xce, 0x03, 0x0a, 0x11, 0x50, 0x61, 0x74, 0x68, 0x54, 0x61,
	0x72, 0x67, 0x65, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x26, 0x0a, 0x0f, 0x73,
	0x6b, 0x69, 0x70, 0x5f, 0x74, 0x6c, 0x73, 0x5f, 0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x73, 0x6b, 0x69, 0x70, 0x54, 0x6c, 0x73, 0x56, 0x65, 0x72,
	0x69, 0x66, 0x79, 0x12, 0x42, 0x0a, 0x0f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x73, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x84,
	0x05, 0x0a, 0x09, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4c, 0x6f, 0x67, 0x12, 0x38, 0x0a, 0x09,
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x09, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x15, 0x0a, 0x06, 0x6c, 0x6f, 0x67, 0x5f, 0x69, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x6f, 0x67, 0x49, 0x64, 0x12, 0x1d, 0x0a,
	...
	0x52, 0x09, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x68,
	...
	0x61, 0x74, 0x68, 0x12, 0x1f, 0x0a, 0x0b, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x6d, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x4d, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x08,
	...
	,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xf8, 0x01, 0x0a, 0x13, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e,
	...
	,
	...
	0x54, 0x55, 0x53, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x05, 0x32, 0xde, 0x05, 0x0a, 0x0c,
	...
	0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x54, 0x0a,
	0x0d, 0x53, 0x65, 0x6e, 0x64, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4c, 0x6f, 0x67, 0x12, 0x20,
	...
	0x1a, 0x21, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x65,
	...
	0x61, 0x74, 0x65, 0x12, 0x1f, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5d, 0x0a, 0x10, 0x53, 0x65, 0x6e, 0x64, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x23, 0x2e, 0x6d, 0x61, 0x6e,
	...
	0x24, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x65, 0x6e,
	0x64, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5a, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50,
	0x72, 0x6f, 0x78, 0x79, 0x50, 0x65, 0x65, 0x72, 0x12, 0x22, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x78,
	0x79, 0x50, 0x65, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x6d,
	...
	0x65, 0x12, 0x4b, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x4f, 0x49, 0x44, 0x43, 0x55, 0x52, 0x4c, 0x12,
	0x1d, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x47, 0x65, 0x74,
	0x4f, 0x49, 0x44, 0x43, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e,
	0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x4f,
	0x49, 0x44, 0x43, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5a,
	0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x12, 0x22, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x56,
	...
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x60, 0x0a, 0x11, 0x52, 0x65,
	0x73, 0x6f, 0x6c, 0x76, 0x65, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x12,
	0x24, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x52, 0x65, 0x73,
	0x6f, 0x6c, 0x76, 0x65, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65,
	0x6e, 0x74, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x08, 0x5a, 0x06,
...
var file_proxy_service_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_proxy_service_proto_goTypes = []interface{}{
	...
	(*ResolveCredentialRequest)(nil),  // 3: management.ResolveCredentialRequest
	(*ResolveCredentialResponse)(nil), // 4: management.ResolveCredentialResponse
	...
	(*PathMapping)(nil),               // 9: management.PathMapping
	(*HeaderAuth)(nil),                // 10: management.HeaderAuth
	(*Authentication)(nil),            // 11: management.Authentication
	(*AccessRestrictions)(nil),        // 12: management.AccessRestrictions
	(*ProxyMapping)(nil),              // 13: management.ProxyMapping
	(*SendAccessLogRequest)(nil),      // 14: management.SendAccessLogRequest
	(*SendAccessLogResponse)(nil),     // 15: management.SendAccessLogResponse
	(*AccessLog)(nil),                 // 16: management.AccessLog
	(*AuthenticateRequest)(nil),       // 17: management.AuthenticateRequest
	(*HeaderAuthRequest)(nil),         // 18: management.HeaderAuthRequest
	(*PasswordRequest)(nil),           // 19: management.PasswordRequest
	(*PinRequest)(nil),                // 20: management.PinRequest
	(*AuthenticateResponse)(nil),      // 21: management.AuthenticateResponse
	(*SendStatusUpdateRequest)(nil),   // 22: management.SendStatusUpdateRequest
	(*SendStatusUpdateResponse)(nil),  // 23: management.SendStatusUpdateResponse
	(*CreateProxyPeerRequest)(nil),    // 24: management.CreateProxyPeerRequest
	(*CreateProxyPeerResponse)(nil),   // 25: management.CreateProxyPeerResponse
	(*GetOIDCURLRequest)(nil),         // 26: management.GetOIDCURLRequest
	(*GetOIDCURLResponse)(nil),        // 27: management.GetOIDCURLResponse
	(*ValidateSessionRequest)(nil),    // 28: management.ValidateSessionRequest
	(*ValidateSessionResponse)(nil),   // 29: management.ValidateSessionResponse
	nil,                               // 30: management.PathTargetOptions.CustomHeadersEntry
	nil,                               // 31: management.AccessLog.MetadataEntry
	(*timestamppb.Timestamp)(nil),     // 32: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),       // 33: google.protobuf.Duration
}
var file_proxy_service_proto_depIdxs = []int32{
	32, // 0: management.GetMappingUpdateRequest.started_at:type_name -> google.protobuf.Timestamp
	5,  // 1: management.GetMappingUpdateRequest.capabilities:type_name -> management.ProxyCapabilities
	13, // 2: management.GetMappingUpdateResponse.mapping:type_name -> management.ProxyMapping
	33, // 3: management.PathTargetOptions.request_timeout:type_name -> google.protobuf.Duration
	1,  // 4: management.PathTargetOptions.path_rewrite:type_name -> management.PathRewriteMode
	30, // 5: management.PathTargetOptions.custom_headers:type_name -> management.PathTargetOptions.CustomHeadersEntry
	33, // 6: management.PathTargetOptions.session_idle_timeout:type_name -> google.protobuf.Duration
	8,  // 7: management.PathMapping.options:type_name -> management.PathTargetOptions
	10, // 8: management.Authentication.header_auths:type_name -> management.HeaderAuth
	0,  // 9: management.ProxyMapping.type:type_name -> management.ProxyMappingUpdateType
	9,  // 10: management.ProxyMapping.path:type_name -> management.PathMapping
	11, // 11: management.ProxyMapping.auth:type_name -> management.Authentication
	12, // 12: management.ProxyMapping.access_restrictions:type_name -> management.AccessRestrictions
	16, // 13: management.SendAccessLogRequest.log:type_name -> management.AccessLog
	32, // 14: management.AccessLog.timestamp:type_name -> google.protobuf.Timestamp
	31, // 15: management.AccessLog.metadata:type_name -> management.AccessLog.MetadataEntry
	19, // 16: management.AuthenticateRequest.password:type_name -> management.PasswordRequest
	20, // 17: management.AuthenticateRequest.pin:type_name -> management.PinRequest
	18, // 18: management.AuthenticateRequest.header_auth:type_name -> management.HeaderAuthRequest
	2,  // 19: management.SendStatusUpdateRequest.status:type_name -> management.ProxyStatus
	6,  // 20: management.ProxyService.GetMappingUpdate:input_type -> management.GetMappingUpdateRequest
	14, // 21: management.ProxyService.SendAccessLog:input_type -> management.SendAccessLogRequest
	17, // 22: management.ProxyService.Authenticate:input_type -> management.AuthenticateRequest
	22, // 23: management.ProxyService.SendStatusUpdate:input_type -> management.SendStatusUpdateRequest
	24, // 24: management.ProxyService.CreateProxyPeer:input_type -> management.CreateProxyPeerRequest
	26, // 25: management.ProxyService.GetOIDCURL:input_type -> management.GetOIDCURLRequest
	28, // 26: management.ProxyService.ValidateSession:input_type -> management.ValidateSessionRequest
	3,  // 27: management.ProxyService.ResolveCredential:input_type -> management.ResolveCredentialRequest
	7,  // 28: management.ProxyService.GetMappingUpdate:output_type -> management.GetMappingUpdateResponse
	15, // 29: management.ProxyService.SendAccessLog:output_type -> management.SendAccessLogResponse
	21, // 30: management.ProxyService.Authenticate:output_type -> management.AuthenticateResponse
	23, // 31: management.ProxyService.SendStatusUpdate:output_type -> management.SendStatusUpdateResponse
	25, // 32: management.ProxyService.CreateProxyPeer:output_type -> management.CreateProxyPeerResponse
	27, // 33: management.ProxyService.GetOIDCURL:output_type -> management.GetOIDCURLResponse
	29, // 34: management.ProxyService.ValidateSession:output_type -> management.ValidateSessionResponse
	4,  // 35: management.ProxyService.ResolveCredential:output_type -> management.ResolveCredentialResponse
...
func file_proxy_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proxy_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResolveCredentialRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proxy_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResolveCredentialResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proxy_service_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_proxy_service_proto_msgTypes[10].OneofWrappers = []interface{}{}
	...
	file_proxy_service_proto_msgTypes[19].OneofWrappers = []interface{}{}
