...
func (DeviceAuthorizationFlowProvider) EnumDescriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{26, 0}
}
...
type SSHAuth struct {
	...
	// AuthorizedUsers is a list of users that are authorized to access this peer via SSH
	AuthorizedUsers []string `protobuf:"bytes,2,rep,name=AuthorizedUsers,proto3" json:"AuthorizedUsers,omitempty"`
...
func (x *SSHAuth) GetAuthorizedUsers() []string {
	if x != nil {
...
func (x *MachineUserIndexes) GetIndexes() []int32 {
	if x != nil {
		return x.Indexes
	}
	return nil
...
func (*PortInfo_Range) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{39, 0}
}
...
var file_management_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x03, 0x6d, 0x74, 0x75, 0x22, 0xe8, 0x05, 0x0a, 0x0a, 0x4e, 0x65, 0x74, 0x77, 0x6f,
	...
	0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0f, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72,
	...
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x05, 0x52, 0x07, 0x69,
...
var file_management_proto_goTypes = []interface{}{
	...
	(*SSHAuth)(nil),                        // 26: management.SSHAuth
	(*MachineUserIndexes)(nil),             // 27: management.MachineUserIndexes
	(*RemotePeerConfig)(nil),               // 28: management.RemotePeerConfig
	(*SSHConfig)(nil),                      // 29: management.SSHConfig
	(*DeviceAuthorizationFlowRequest)(nil), // 30: management.DeviceAuthorizationFlowRequest
	(*DeviceAuthorizationFlow)(nil),        // 31: management.DeviceAuthorizationFlow
	(*PKCEAuthorizationFlowRequest)(nil),   // 32: management.PKCEAuthorizationFlowRequest
	(*PKCEAuthorizationFlow)(nil),          // 33: management.PKCEAuthorizationFlow
	(*ProviderConfig)(nil),                 // 34: management.ProviderConfig
	(*Route)(nil),                          // 35: management.Route
	(*DNSConfig)(nil),                      // 36: management.DNSConfig
	(*CustomZone)(nil),                     // 37: management.CustomZone
	(*SimpleRecord)(nil),                   // 38: management.SimpleRecord
	(*NameServerGroup)(nil),                // 39: management.NameServerGroup
	(*NameServer)(nil),                     // 40: management.NameServer
	(*FirewallRule)(nil),                   // 41: management.FirewallRule
	(*NetworkAddress)(nil),                 // 42: management.NetworkAddress
	(*Checks)(nil),                         // 43: management.Checks
	(*PortInfo)(nil),                       // 44: management.PortInfo
	(*RouteFirewallRule)(nil),              // 45: management.RouteFirewallRule
	(*ForwardingRule)(nil),                 // 46: management.ForwardingRule
	nil,                                    // 47: management.SSHAuth.MachineUsersEntry
...
var file_management_proto_depIdxs = []int32{
	...
	28, // 3: management.SyncResponse.remotePeers:type_name -> management.RemotePeerConfig
	25, // 4: management.SyncResponse.NetworkMap:type_name -> management.NetworkMap
	43, // 5: management.SyncResponse.Checks:type_name -> management.Checks
	...
	42, // 9: management.PeerSystemMeta.networkAddresses:type_name -> management.NetworkAddress
	...
	43, // 15: management.LoginResponse.Checks:type_name -> management.Checks
	49, // 16: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	50, // 23: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	19, // 24: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	29, // 25: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	24, // 26: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	28, // 27: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	35, // 28: management.NetworkMap.Routes:type_name -> management.Route
	36, // 29: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	28, // 30: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	41, // 31: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	45, // 32: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	46, // 33: management.NetworkMap.forwardingRules:type_name -> management.ForwardingRule
	26, // 34: management.NetworkMap.sshAuth:type_name -> management.SSHAuth
	47, // 35: management.SSHAuth.machine_users:type_name -> management.SSHAuth.MachineUsersEntry
	29, // 36: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	22, // 37: management.SSHConfig.jwtConfig:type_name -> management.JWTConfig
	4,  // 38: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	34, // 39: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	34, // 40: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	39, // 41: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	37, // 42: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	38, // 43: management.CustomZone.Records:type_name -> management.SimpleRecord
	40, // 44: management.NameServerGroup.NameServers:type_name -> management.NameServer
	1,  // 45: management.FirewallRule.Direction:type_name -> management.RuleDirection
	2,  // 46: management.FirewallRule.Action:type_name -> management.RuleAction
	0,  // 47: management.FirewallRule.Protocol:type_name -> management.RuleProtocol
	44, // 48: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	48, // 49: management.PortInfo.range:type_name -> management.PortInfo.Range
	2,  // 50: management.RouteFirewallRule.action:type_name -> management.RuleAction
	0,  // 51: management.RouteFirewallRule.protocol:type_name -> management.RuleProtocol
	44, // 52: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	0,  // 53: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	44, // 54: management.ForwardingRule.destinationPort:type_name -> management.PortInfo
	44, // 55: management.ForwardingRule.translatedPort:type_name -> management.PortInfo
	27, // 56: management.SSHAuth.MachineUsersEntry.value:type_name -> management.MachineUserIndexes
	5,  // 57: management.ManagementService.Login:input_type -> management.EncryptedMessage
	5,  // 58: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	17, // 59: management.ManagementService.GetServerKey:input_type -> management.Empty
	17, // 60: management.ManagementService.isHealthy:input_type -> management.Empty
	5,  // 61: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	5,  // 62: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	5,  // 63: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	5,  // 64: management.ManagementService.Logout:input_type -> management.EncryptedMessage
	5,  // 65: management.ManagementService.Login:output_type -> management.EncryptedMessage
	5,  // 66: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	16, // 67: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	17, // 68: management.ManagementService.isHealthy:output_type -> management.Empty
	5,  // 69: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	5,  // 70: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	17, // 71: management.ManagementService.SyncMeta:output_type -> management.Empty
	17, // 72: management.ManagementService.Logout:output_type -> management.Empty
...
func file_management_proto_init() {
	...
	file_management_proto_msgTypes[39].OneofWrappers = []interface{}{
		(*PortInfo_Port)(nil),
		(*PortInfo_Range_)(nil),
	}
	type x struct{}
