...
type SSHAuth struct {
	...
	// AuthorizedUsers is a list of hashed user IDs (FNV-1a 64-bit) authorized to access this peer via SSH
	AuthorizedUsers []uint64 `protobuf:"fixed64,2,rep,packed,name=AuthorizedUsers,proto3" json:"AuthorizedUsers,omitempty"`
...
func (x *SSHAuth) GetAuthorizedUsers() []uint64 {
	if x != nil {
...
var file_management_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x06, 0x52, 0x0f, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72,
