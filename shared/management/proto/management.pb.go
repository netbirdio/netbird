...
// Fields 1-3 are the v0.77 wire contract: their numbers and types are frozen,
// management and clients on either side of a release interoperate on them.
// New data goes on new field numbers only.
...
var file_management_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x80, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	0x78, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69,
	0x64, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x22, 0x24, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x4e,
...
var file_management_proto_depIdxs = []int32{
	...
	72,  // 99: management.GroupCompact.resources:type_name -> management.ResourceCompact
	51,  // 100: management.NameServerGroupRaw.nameservers:type_name -> management.NameServer
	80,  // 101: management.NetworkRouterList.entries:type_name -> management.NetworkRouterEntry
	...
	8,   // 121: management.ManagementService.Login:output_type -> management.EncryptedMessage
	8,   // 122: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	25,  // 123: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	26,  // 124: management.ManagementService.isHealthy:output_type -> management.Empty
	8,   // 125: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	8,   // 126: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	26,  // 127: management.ManagementService.SyncMeta:output_type -> management.Empty
	26,  // 128: management.ManagementService.Logout:output_type -> management.Empty
	8,   // 129: management.ManagementService.Job:output_type -> management.EncryptedMessage
	8,   // 130: management.ManagementService.ExtendAuthSession:output_type -> management.EncryptedMessage
	8,   // 131: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	8,   // 132: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	8,   // 133: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
