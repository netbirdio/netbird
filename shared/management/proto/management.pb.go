...
type ResourceCompactType int32

const (
	ResourceCompactType_unknown_type ResourceCompactType = 0 //placeholder
	ResourceCompactType_peer         ResourceCompactType = 1
	ResourceCompactType_domain       ResourceCompactType = 2
	ResourceCompactType_host         ResourceCompactType = 3
	ResourceCompactType_subnet       ResourceCompactType = 4
	ResourceCompactType_network      ResourceCompactType = 5
)

// Enum value maps for ResourceCompactType.
var (
	ResourceCompactType_name = map[int32]string{
		0: "unknown_type",
		1: "peer",
		2: "domain",
		3: "host",
	...
	ResourceCompactType_value = map[string]int32{
		"unknown_type": 0,
		"peer":         1,
		"domain":       2,
		"host":         3,
...
func (x ResourceCompactType) Enum() *ResourceCompactType {
	p := new(ResourceCompactType)
	*p = x
	return p
}

func (x ResourceCompactType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ResourceCompactType) Descriptor() protoreflect.EnumDescriptor {
	return file_management_proto_enumTypes[6].Descriptor()
}

func (ResourceCompactType) Type() protoreflect.EnumType {
	return &file_management_proto_enumTypes[6]
}

func (x ResourceCompactType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ResourceCompactType.Descriptor instead.
func (ResourceCompactType) EnumDescriptor() ([]byte, []int) {
...
type NetworkMapComponentsFull struct {
	...
	Peers []*PeerCompact `protobuf:"bytes,8,rep,name=peers,proto3" json:"peers,omitempty"`
	// Indexes into peers for the subset that may act as routers.
	RouterPeerIndexes []uint32 `protobuf:"varint,9,rep,packed,name=router_peer_indexes,json=routerPeerIndexes,proto3" json:"router_peer_indexes,omitempty"`
	// Policies that affect the receiving peer.
	Policies []*PolicyCompact `protobuf:"bytes,10,rep,name=policies,proto3" json:"policies,omitempty"`
	// Groups in unspecified order — clients key off id (public_id).
	Groups []*GroupCompact `protobuf:"bytes,11,rep,name=groups,proto3" json:"groups,omitempty"`
	// Routes relevant to this peer, raw shape (mirrors []*route.Route).
	Routes []*RouteRaw `protobuf:"bytes,12,rep,name=routes,proto3" json:"routes,omitempty"`
	// Nameserver groups (mirrors []*nbdns.NameServerGroup).
	NameserverGroups []*NameServerGroupRaw `protobuf:"bytes,13,rep,name=nameserver_groups,json=nameserverGroups,proto3" json:"nameserver_groups,omitempty"`
	// All DNS records the client needs to assemble its custom zone. Reuses
	// the existing SimpleRecord wire shape.
	AllDnsRecords []*SimpleRecord `protobuf:"bytes,14,rep,name=all_dns_records,json=allDnsRecords,proto3" json:"all_dns_records,omitempty"`
	// Custom zones (typically the peer's own zone). Reuses the existing
	// CustomZone wire shape.
	AccountZones []*CustomZone `protobuf:"bytes,15,rep,name=account_zones,json=accountZones,proto3" json:"account_zones,omitempty"`
	// Network resources (mirrors []*resourceTypes.NetworkResource).
	NetworkResources []*NetworkResourceRaw `protobuf:"bytes,16,rep,name=network_resources,json=networkResources,proto3" json:"network_resources,omitempty"`
	...
	RoutersMap map[string]*NetworkRouterList `protobuf:"bytes,17,rep,name=routers_map,json=routersMap,proto3" json:"routers_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Group-id (public_id) → user ids authorized for SSH on members.
	GroupIdToUserIds map[string]*UserIDList `protobuf:"bytes,19,rep,name=group_id_to_user_ids,json=groupIdToUserIds,proto3" json:"group_id_to_user_ids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Account-level allowed user ids (used by Calculate() when assembling SSH
	// authorized users for the receiving peer).
	AllowedUserIds []string `protobuf:"bytes,20,rep,name=allowed_user_ids,json=allowedUserIds,proto3" json:"allowed_user_ids,omitempty"`
	...
	PostureFailedPeers map[string]*PeerIndexSet `protobuf:"bytes,21,rep,name=posture_failed_peers,json=postureFailedPeers,proto3" json:"posture_failed_peers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	DnsForwarderPort int64 `protobuf:"varint,22,opt,name=dns_forwarder_port,json=dnsForwarderPort,proto3" json:"dns_forwarder_port,omitempty"`
	...
	ProxyPatch *ProxyPatch `protobuf:"bytes,23,opt,name=proxy_patch,json=proxyPatch,proto3" json:"proxy_patch,omitempty"`
	...
	UserIdClaim string `protobuf:"bytes,24,opt,name=user_id_claim,json=userIdClaim,proto3" json:"user_id_claim,omitempty"`
}
...
type ResourceCompact struct {
	...
	Type ResourceCompactType `protobuf:"varint,1,opt,name=type,proto3,enum=management.ResourceCompactType" json:"type,omitempty"`
	// Types that are assignable to ResourceId:
	//
	//	*ResourceCompact_Id
	//	*ResourceCompact_PeerIndex
	ResourceId isResourceCompact_ResourceId `protobuf_oneof:"resource_id"`
}
...
func (x *ResourceCompact) GetType() ResourceCompactType {
	if x != nil {
		return x.Type
	}
	return ResourceCompactType_unknown_type
}

func (m *ResourceCompact) GetResourceId() isResourceCompact_ResourceId {
	if m != nil {
		return m.ResourceId
	}
	return nil
...
func (x *ResourceCompact) GetId() string {
	if x, ok := x.GetResourceId().(*ResourceCompact_Id); ok {
		return x.Id
	}
	return ""
}
...
func (x *ResourceCompact) GetPeerIndex() uint32 {
	if x, ok := x.GetResourceId().(*ResourceCompact_PeerIndex); ok {
		return x.PeerIndex
	}
	return 0
}

type isResourceCompact_ResourceId interface {
	isResourceCompact_ResourceId()
}

type ResourceCompact_Id struct {
	Id string `protobuf:"bytes,2,opt,name=id,proto3,oneof"` // for domain/host/subnet resources
}

type ResourceCompact_PeerIndex struct {
	PeerIndex uint32 `protobuf:"varint,3,opt,name=peer_index,json=peerIndex,proto3,oneof"` // for peers
}

func (*ResourceCompact_Id) isResourceCompact_ResourceId() {}

func (*ResourceCompact_PeerIndex) isResourceCompact_ResourceId() {}
...
var file_management_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x22, 0xe1, 0x05, 0x0a, 0x05, 0x46, 0x6c, 0x61,
	...
	0x0b, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x50, 0x76, 0x36, 0x22, 0xe2, 0x05, 0x0a,
	...
	,
	...
	0x52, 0x0a, 0x70, 0x65, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x2a, 0x0a, 0x06,
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6d,
	0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73,
	0x52, 0x06, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x12, 0x46, 0x0a, 0x10, 0x73, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x18, 0x04, 0x20, 0x01,
	...
	0x22, 0x66, 0x0a, 0x18, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x64, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08,
	0x6a, 0x77, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x6a, 0x77, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x2e, 0x0a, 0x04, 0x6d, 0x65, 0x74, 0x61,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x22, 0x29, 0x0a, 0x0d, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x12, 0x18, 0x0a, 0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0xa3, 0x01,
	0x0a, 0x09, 0x4a, 0x57, 0x54, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x69,
	...
	,
	...
	0x6e, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x6e, 0x73, 0x12, 0x33, 0x0a,
	...
	0x52, 0x04, 0x66, 0x71, 0x64, 0x6e, 0x12, 0x48, 0x0a, 0x1f, 0x52, 0x6f, 0x75, 0x74, 0x69, 0x6e,
	0x67, 0x50, 0x65, 0x65, 0x72, 0x44, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69,
	0x6f, 0x6e, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52,
	...
	,
	...
	0x79, 0x12, 0x44, 0x0a, 0x0f, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x52,
	0x75, 0x6c, 0x65, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6d, 0x61, 0x6e,
	...
	,
	...
	0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x93, 0x0d, 0x0a, 0x18, 0x4e, 0x65, 0x74,
	...
	0x6d, 0x5a, 0x6f, 0x6e, 0x65, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x2d, 0x0a, 0x05, 0x70,
	0x65, 0x65, 0x72, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6d, 0x61, 0x6e,
	...
	0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x11, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x50,
	0x65, 0x65, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x73, 0x12, 0x35, 0x0a, 0x08, 0x70, 0x6f,
	0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6d,
	...
	0x73, 0x12, 0x30, 0x0a, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28,
	...
	0x75, 0x70, 0x73, 0x12, 0x2c, 0x0a, 0x06, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x18, 0x0c, 0x20,
	...
	0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6d,
	...
	0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	...
	0x73, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	...
	0x65, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x75, 0x74, 0x65, 0x72, 0x73, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x11, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x13, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x73, 0x18, 0x14, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64,
	...
	0x15, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3c, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65,
	...
	0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x16, 0x20,
	...
	0x61, 0x74, 0x63, 0x68, 0x18, 0x17, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6d, 0x61, 0x6e,
	...
	0x18, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x43, 0x6c, 0x61,
	...
	0x1a, 0x5b, 0x0a, 0x15, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x54, 0x6f, 0x55, 0x73, 0x65,
	...
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6d, 0x61, 0x6e,
	0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x4c, 0x69,
	0x73, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x5f, 0x0a,
	0x17, 0x50, 0x6f, 0x73, 0x74, 0x75, 0x72, 0x65, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x50, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x5f, 0x69, 0x70, 0x76, 0x36, 0x18, 0x0b, 0x20, 0x01,
	...
	0x72, 0x63, 0x65, 0x5f, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x65, 0x73, 0x18, 0x0c, 0x20, 0x01,
	...
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x73,
	0x68, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x22, 0x91, 0x06, 0x0a, 0x0d, 0x50, 0x6f, 0x6c,
	0x69, 0x63, 0x79, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x2e, 0x0a, 0x06, 0x61, 0x63,
	...
	0x6f, 0x6e, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x34, 0x0a, 0x08, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x6d,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x6b, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07,
	0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0xe1, 0x01, 0x0a, 0x12, 0x4e, 0x65, 0x74, 0x77,
	0x6f, 0x72, 0x6b, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d,
	0x0a, 0x0a, 0x70, 0x65, 0x65, 0x72, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	,
	...
	0x53, 0x54, 0x4f, 0x4d, 0x10, 0x05, 0x12, 0x0f, 0x0a, 0x0b, 0x4e, 0x45, 0x54, 0x42, 0x49, 0x52,
	0x44, 0x5f, 0x53, 0x53, 0x48, 0x10, 0x06, 0x2a, 0x20, 0x0a, 0x0d, 0x52, 0x75, 0x6c, 0x65, 0x44,
	...
	0x10, 0x04, 0x2a, 0x60, 0x0a, 0x13, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x6f,
	0x6d, 0x70, 0x61, 0x63, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x10, 0x0a, 0x0c, 0x75, 0x6e, 0x6b,
	0x6e, 0x6f, 0x77, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x70,
	0x65, 0x65, 0x72, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x10,
	0x02, 0x12, 0x08, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x73,
	0x75, 0x62, 0x6e, 0x65, 0x74, 0x10, 0x04, 0x12, 0x0b, 0x0a, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b, 0x10, 0x05, 0x32, 0xd0, 0x07, 0x0a, 0x11, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d,
	...
	0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x51, 0x0a,
	0x11, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x64, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	0x12, 0x4c, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x45, 0x78, 0x70, 0x6f, 0x73, 0x65,
	0x12, 0x1c, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e,
	0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x1c,
	0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x63, 0x72,
	0x79, 0x70, 0x74, 0x65, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x12, 0x4b,
	0x0a, 0x0b, 0x52, 0x65, 0x6e, 0x65, 0x77, 0x45, 0x78, 0x70, 0x6f, 0x73, 0x65, 0x12, 0x1c, 0x2e,
	...
	0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x65, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x12, 0x4a, 0x0a, 0x0a, 0x53,
	0x74, 0x6f, 0x70, 0x45, 0x78, 0x70, 0x6f, 0x73, 0x65, 0x12, 0x1c, 0x2e, 0x6d, 0x61, 0x6e, 0x61,
	0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x1c, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_management_proto_msgTypes = make([]protoimpl.MessageInfo, 82)
var file_management_proto_goTypes = []interface{}{
	...
	(ResourceCompactType)(0),               // 6: management.ResourceCompactType
...
var file_management_proto_depIdxs = []int32{
	...
	33,  // 48: management.SSHConfig.jwtConfig:type_name -> management.JWTConfig
	8,   // 49: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	46,  // 50: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	46,  // 51: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	51,  // 52: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	49,  // 53: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	50,  // 54: management.CustomZone.Records:type_name -> management.SimpleRecord
	52,  // 55: management.NameServerGroup.NameServers:type_name -> management.NameServer
	...
	56,  // 59: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	86,  // 60: management.PortInfo.range:type_name -> management.PortInfo.Range
	...
	56,  // 63: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	2,   // 64: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	56,  // 65: management.ForwardingRule.destinationPort:type_name -> management.PortInfo
	56,  // 66: management.ForwardingRule.translatedPort:type_name -> management.PortInfo
	5,   // 67: management.ExposeServiceRequest.protocol:type_name -> management.ExposeProtocol
	66,  // 68: management.NetworkMapEnvelope.full:type_name -> management.NetworkMapComponentsFull
	70,  // 69: management.NetworkMapEnvelope.delta:type_name -> management.NetworkMapComponentsDelta
	35,  // 70: management.NetworkMapComponentsFull.peer_config:type_name -> management.PeerConfig
	69,  // 71: management.NetworkMapComponentsFull.network:type_name -> management.AccountNetwork
	68,  // 72: management.NetworkMapComponentsFull.account_settings:type_name -> management.AccountSettingsCompact
	76,  // 73: management.NetworkMapComponentsFull.dns_settings:type_name -> management.DNSSettingsCompact
	71,  // 74: management.NetworkMapComponentsFull.peers:type_name -> management.PeerCompact
	72,  // 75: management.NetworkMapComponentsFull.policies:type_name -> management.PolicyCompact
	75,  // 76: management.NetworkMapComponentsFull.groups:type_name -> management.GroupCompact
	77,  // 77: management.NetworkMapComponentsFull.routes:type_name -> management.RouteRaw
	78,  // 78: management.NetworkMapComponentsFull.nameserver_groups:type_name -> management.NameServerGroupRaw
	50,  // 79: management.NetworkMapComponentsFull.all_dns_records:type_name -> management.SimpleRecord
	49,  // 80: management.NetworkMapComponentsFull.account_zones:type_name -> management.CustomZone
	79,  // 81: management.NetworkMapComponentsFull.network_resources:type_name -> management.NetworkResourceRaw
	87,  // 82: management.NetworkMapComponentsFull.routers_map:type_name -> management.NetworkMapComponentsFull.RoutersMapEntry
	88,  // 83: management.NetworkMapComponentsFull.group_id_to_user_ids:type_name -> management.NetworkMapComponentsFull.GroupIdToUserIdsEntry
	89,  // 84: management.NetworkMapComponentsFull.posture_failed_peers:type_name -> management.NetworkMapComponentsFull.PostureFailedPeersEntry
	67,  // 85: management.NetworkMapComponentsFull.proxy_patch:type_name -> management.ProxyPatch
	40,  // 86: management.ProxyPatch.peers:type_name -> management.RemotePeerConfig
	40,  // 87: management.ProxyPatch.offline_peers:type_name -> management.RemotePeerConfig
	53,  // 88: management.ProxyPatch.firewall_rules:type_name -> management.FirewallRule
	47,  // 89: management.ProxyPatch.routes:type_name -> management.Route
	57,  // 90: management.ProxyPatch.route_firewall_rules:type_name -> management.RouteFirewallRule
	58,  // 91: management.ProxyPatch.forwarding_rules:type_name -> management.ForwardingRule
	4,   // 92: management.PolicyCompact.action:type_name -> management.RuleAction
	2,   // 93: management.PolicyCompact.protocol:type_name -> management.RuleProtocol
	86,  // 94: management.PolicyCompact.port_ranges:type_name -> management.PortInfo.Range
	90,  // 95: management.PolicyCompact.authorized_groups:type_name -> management.PolicyCompact.AuthorizedGroupsEntry
	73,  // 96: management.PolicyCompact.source_resource:type_name -> management.ResourceCompact
	73,  // 97: management.PolicyCompact.destination_resource:type_name -> management.ResourceCompact
	6,   // 98: management.ResourceCompact.type:type_name -> management.ResourceCompactType
	73,  // 99: management.GroupCompact.resources:type_name -> management.ResourceCompact
	...
	83,  // 104: management.NetworkMapComponentsFull.GroupIdToUserIdsEntry.value:type_name -> management.UserIDList
	84,  // 105: management.NetworkMapComponentsFull.PostureFailedPeersEntry.value:type_name -> management.PeerIndexSet
	74,  // 106: management.PolicyCompact.AuthorizedGroupsEntry.value:type_name -> management.UserNameList
	9,   // 107: management.ManagementService.Login:input_type -> management.EncryptedMessage
	9,   // 108: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	27,  // 109: management.ManagementService.GetServerKey:input_type -> management.Empty
	27,  // 110: management.ManagementService.isHealthy:input_type -> management.Empty
	9,   // 111: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	9,   // 112: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	9,   // 113: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	9,   // 114: management.ManagementService.Logout:input_type -> management.EncryptedMessage
	9,   // 115: management.ManagementService.Job:input_type -> management.EncryptedMessage
	9,   // 116: management.ManagementService.ExtendAuthSession:input_type -> management.EncryptedMessage
	9,   // 117: management.ManagementService.CreateExpose:input_type -> management.EncryptedMessage
	9,   // 118: management.ManagementService.RenewExpose:input_type -> management.EncryptedMessage
	9,   // 119: management.ManagementService.StopExpose:input_type -> management.EncryptedMessage
	9,   // 120: management.ManagementService.Login:output_type -> management.EncryptedMessage
	9,   // 121: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	26,  // 122: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	27,  // 123: management.ManagementService.isHealthy:output_type -> management.Empty
	9,   // 124: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	9,   // 125: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	27,  // 126: management.ManagementService.SyncMeta:output_type -> management.Empty
	27,  // 127: management.ManagementService.Logout:output_type -> management.Empty
	9,   // 128: management.ManagementService.Job:output_type -> management.EncryptedMessage
	9,   // 129: management.ManagementService.ExtendAuthSession:output_type -> management.EncryptedMessage
	9,   // 130: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	9,   // 131: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	9,   // 132: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
...
func file_management_proto_init() {
	...
	file_management_proto_msgTypes[64].OneofWrappers = []interface{}{
		(*ResourceCompact_Id)(nil),
		(*ResourceCompact_PeerIndex)(nil),
	}
	type x struct{}
