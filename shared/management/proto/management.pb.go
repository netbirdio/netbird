...
func (x *ExposeServiceResponse) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
type ExposeServiceKeepAlive struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ExposeServiceKeepAlive) Reset() {
	*x = ExposeServiceKeepAlive{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExposeServiceKeepAlive) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExposeServiceKeepAlive) ProtoMessage() {}

func (x *ExposeServiceKeepAlive) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[49]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExposeServiceKeepAlive.ProtoReflect.Descriptor instead.
func (*ExposeServiceKeepAlive) Descriptor() ([]byte, []int) {
...
var file_management_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x0a, 0x6e, 0x61, 0x6d, 0x65, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x22, 0x92,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x61, 0x69, 0x6e, 0x22, 0x18, 0x0a, 0x16, 0x45, 0x78, 0x70, 0x6f, 0x73, 0x65, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x4b, 0x65, 0x65, 0x70, 0x41, 0x6c, 0x69, 0x76, 0x65, 0x22, 0x2e, 0x0a,
	0x12, 0x45, 0x78, 0x70, 0x6f, 0x73, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x45, 0x72,
	0x72, 0x6f, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x3a, 0x0a,
	...
	0x54, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x52, 0x4f, 0x50, 0x10, 0x01, 0x2a, 0x53, 0x0a,
	...
	0x10, 0x03, 0x32, 0xe9, 0x05, 0x0a, 0x11, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x51, 0x0a, 0x0d, 0x45,
	0x78, 0x70, 0x6f, 0x73, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1c, 0x2e, 0x6d,
	0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70,
...
var file_management_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_management_proto_goTypes = []interface{}{
	...
	(*ExposeServiceKeepAlive)(nil),         // 56: management.ExposeServiceKeepAlive
	(*ExposeServiceError)(nil),             // 57: management.ExposeServiceError
...
var file_management_proto_depIdxs = []int32{
	...
	60, // 19: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	61, // 26: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	...
	58, // 39: management.SSHAuth.machine_users:type_name -> management.SSHAuth.MachineUsersEntry
	...
	59, // 53: management.PortInfo.range:type_name -> management.PortInfo.Range
	...
	7,  // 71: management.ManagementService.ExposeService:input_type -> management.EncryptedMessage
	7,  // 72: management.ManagementService.Login:output_type -> management.EncryptedMessage
	7,  // 73: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	22, // 74: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	23, // 75: management.ManagementService.isHealthy:output_type -> management.Empty
	7,  // 76: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	7,  // 77: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	23, // 78: management.ManagementService.SyncMeta:output_type -> management.Empty
	23, // 79: management.ManagementService.Logout:output_type -> management.Empty
	7,  // 80: management.ManagementService.Job:output_type -> management.EncryptedMessage
	7,  // 81: management.ManagementService.ExposeService:output_type -> management.EncryptedMessage
...
func file_management_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_management_proto_msgTypes[49].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExposeServiceKeepAlive); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_management_proto_msgTypes[50].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExposeServiceError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
