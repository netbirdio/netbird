...
var file_management_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x85, 0x01, 0x0a, 0x09, 0x4a, 0x57, 0x54, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x0b, 0x6d, 0x61, 0x78, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x67, 0x65, 0x22, 0x7d, 0x0a, 0x13,
	...
	0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x93, 0x02, 0x0a, 0x0a,
	...
	0x75, 0x22, 0xb9, 0x05, 0x0a, 0x0a, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x4d, 0x61, 0x70,
	...
	0x72, 0x77, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x22, 0xbb, 0x01,
	...
	0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xb8, 0x03, 0x0a,
	...
	0x0d, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x72, 0x50, 0x6f, 0x72, 0x74, 0x22, 0x58,
	...
	0x73, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x50, 0x6f, 0x72, 0x74, 0x2a, 0x3a, 0x0a, 0x09, 0x4a, 0x6f,
	...
	0x12, 0x08, 0x0a, 0x04, 0x44, 0x52, 0x4f, 0x50, 0x10, 0x01, 0x32, 0x96, 0x05, 0x0a, 0x11, 0x4d,
...
var file_management_proto_depIdxs = []int32{
	...
	52, // 26: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	24, // 27: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	32, // 28: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	29, // 29: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	...
	32, // 37: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	27, // 38: management.SSHConfig.jwtConfig:type_name -> management.JWTConfig
	5,  // 39: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	37, // 40: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	37, // 41: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	42, // 42: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	40, // 43: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	41, // 44: management.CustomZone.Records:type_name -> management.SimpleRecord
	43, // 45: management.NameServerGroup.NameServers:type_name -> management.NameServer
	2,  // 46: management.FirewallRule.Direction:type_name -> management.RuleDirection
	3,  // 47: management.FirewallRule.Action:type_name -> management.RuleAction
	1,  // 48: management.FirewallRule.Protocol:type_name -> management.RuleProtocol
	47, // 49: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	50, // 50: management.PortInfo.range:type_name -> management.PortInfo.Range
	3,  // 51: management.RouteFirewallRule.action:type_name -> management.RuleAction
	1,  // 52: management.RouteFirewallRule.protocol:type_name -> management.RuleProtocol
	47, // 53: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	1,  // 54: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	47, // 55: management.ForwardingRule.destinationPort:type_name -> management.PortInfo
	47, // 56: management.ForwardingRule.translatedPort:type_name -> management.PortInfo
	6,  // 57: management.ManagementService.Login:input_type -> management.EncryptedMessage
	6,  // 58: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	22, // 59: management.ManagementService.GetServerKey:input_type -> management.Empty
	22, // 60: management.ManagementService.isHealthy:input_type -> management.Empty
	6,  // 61: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 62: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 63: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	6,  // 64: management.ManagementService.Logout:input_type -> management.EncryptedMessage
	6,  // 65: management.ManagementService.Job:input_type -> management.EncryptedMessage
	6,  // 66: management.ManagementService.Login:output_type -> management.EncryptedMessage
	6,  // 67: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	21, // 68: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	22, // 69: management.ManagementService.isHealthy:output_type -> management.Empty
	6,  // 70: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	6,  // 71: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	22, // 72: management.ManagementService.SyncMeta:output_type -> management.Empty
	22, // 73: management.ManagementService.Logout:output_type -> management.Empty
	6,  // 74: management.ManagementService.Job:output_type -> management.EncryptedMessage
