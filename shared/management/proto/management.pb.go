...
// AmneziaConfig contains AmneziaWG obfuscation parameters.
// If not set or all fields are default/zero, standard WireGuard will be used.
type AmneziaConfig struct {
	...
	// Junk packet count
	Jc *int32 `protobuf:"varint,1,opt,name=jc,proto3,oneof" json:"jc,omitempty"`
	// Junk packet minimum size
	Jmin *int32 `protobuf:"varint,2,opt,name=jmin,proto3,oneof" json:"jmin,omitempty"`
	// Junk packet maximum size
	Jmax *int32 `protobuf:"varint,3,opt,name=jmax,proto3,oneof" json:"jmax,omitempty"`
	// Init packet junk size
	S1 *int32 `protobuf:"varint,4,opt,name=s1,proto3,oneof" json:"s1,omitempty"`
	// Response packet junk size
	S2 *int32 `protobuf:"varint,5,opt,name=s2,proto3,oneof" json:"s2,omitempty"`
	// Init packet magic header 1
	H1 *uint32 `protobuf:"varint,6,opt,name=h1,proto3,oneof" json:"h1,omitempty"`
	// Init packet magic header 2
	H2 *uint32 `protobuf:"varint,7,opt,name=h2,proto3,oneof" json:"h2,omitempty"`
	// Init packet magic header 3
	H3 *uint32 `protobuf:"varint,8,opt,name=h3,proto3,oneof" json:"h3,omitempty"`
	// Init packet magic header 4
	H4 *uint32 `protobuf:"varint,9,opt,name=h4,proto3,oneof" json:"h4,omitempty"`
	// Init packet magic string 1
	I1 *string `protobuf:"bytes,10,opt,name=i1,proto3,oneof" json:"i1,omitempty"`
	// Init packet magic string 2
	I2 *string `protobuf:"bytes,11,opt,name=i2,proto3,oneof" json:"i2,omitempty"`
	// Init packet magic string 3
	I3 *string `protobuf:"bytes,12,opt,name=i3,proto3,oneof" json:"i3,omitempty"`
	// Init packet magic string 4
	I4 *string `protobuf:"bytes,13,opt,name=i4,proto3,oneof" json:"i4,omitempty"`
	// Init packet magic string 5
	I5 *string `protobuf:"bytes,14,opt,name=i5,proto3,oneof" json:"i5,omitempty"`
}

func (x *AmneziaConfig) Reset() {
	*x = AmneziaConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *AmneziaConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AmneziaConfig) ProtoMessage() {}

func (x *AmneziaConfig) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AmneziaConfig.ProtoReflect.Descriptor instead.
func (*AmneziaConfig) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{18}
}

func (x *AmneziaConfig) GetJc() int32 {
	if x != nil && x.Jc != nil {
		return *x.Jc
	}
	return 0
...
func (x *AmneziaConfig) GetJmin() int32 {
	if x != nil && x.Jmin != nil {
		return *x.Jmin
	}
	return 0
...
func (x *AmneziaConfig) GetJmax() int32 {
	if x != nil && x.Jmax != nil {
		return *x.Jmax
	}
	return 0
...
func (x *AmneziaConfig) GetS1() int32 {
	if x != nil && x.S1 != nil {
		return *x.S1
	}
	return 0
...
func (x *AmneziaConfig) GetS2() int32 {
	if x != nil && x.S2 != nil {
		return *x.S2
	}
	return 0
...
func (x *AmneziaConfig) GetH1() uint32 {
	if x != nil && x.H1 != nil {
		return *x.H1
	}
	return 0
...
func (x *AmneziaConfig) GetH2() uint32 {
	if x != nil && x.H2 != nil {
		return *x.H2
	}
	return 0
...
func (x *AmneziaConfig) GetH3() uint32 {
	if x != nil && x.H3 != nil {
		return *x.H3
	}
	return 0
...
func (x *AmneziaConfig) GetH4() uint32 {
	if x != nil && x.H4 != nil {
		return *x.H4
	}
	return 0
...
func (x *AmneziaConfig) GetI1() string {
	if x != nil && x.I1 != nil {
		return *x.I1
	}
	return ""
...
func (x *AmneziaConfig) GetI2() string {
	if x != nil && x.I2 != nil {
		return *x.I2
	}
	return ""
...
func (x *AmneziaConfig) GetI3() string {
	if x != nil && x.I3 != nil {
		return *x.I3
	}
	return ""
...
func (x *AmneziaConfig) GetI4() string {
	if x != nil && x.I4 != nil {
		return *x.I4
	}
	return ""
...
func (x *AmneziaConfig) GetI5() string {
	if x != nil && x.I5 != nil {
		return *x.I5
	}
	return ""
...
type PeerConfig struct {
	...
	// AmneziaWG obfuscation configuration. If not set, standard WireGuard is used.
	AmneziaConfig *AmneziaConfig `protobuf:"bytes,8,opt,name=amneziaConfig,proto3,oneof" json:"amneziaConfig,omitempty"`
}
...
func (x *PeerConfig) GetAmneziaConfig() *AmneziaConfig {
	if x != nil {
		return x.AmneziaConfig
	}
	return nil
}
...
var file_management_proto_rawDesc = []byte{
	...
	,
	...
	0x05, 0x52, 0x03, 0x6d, 0x74, 0x75, 0x12, 0x44, 0x0a, 0x0d, 0x61, 0x6d, 0x6e, 0x65, 0x7a, 0x69,
	0x61, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x41, 0x6d, 0x6e, 0x65, 0x7a,
	0x69, 0x61, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x00, 0x52, 0x0d, 0x61, 0x6d, 0x6e, 0x65,
	0x7a, 0x69, 0x61, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x88, 0x01, 0x01, 0x42, 0x10, 0x0a, 0x0e,
	0x5f, 0x61, 0x6d, 0x6e, 0x65, 0x7a, 0x69, 0x61, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xb9,
	...
	0x41, 0x70, 0x70, 0x6c, 0x79, 0x22, 0xda, 0x01, 0x0a, 0x09, 0x44, 0x4e, 0x53, 0x43, 0x6f, 0x6e,
	...
	0x0b, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5a, 0x6f, 0x6e, 0x65, 0x73, 0x12, 0x24, 0x0a, 0x0d,
	0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x72, 0x50, 0x6f, 0x72, 0x74, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x0d, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x72, 0x50, 0x6f,
	0x72, 0x74, 0x22, 0x58, 0x0a, 0x0a, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5a, 0x6f, 0x6e, 0x65,
	...
	0x6f, 0x72, 0x64, 0x52, 0x07, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x22, 0x74, 0x0a, 0x0c,
	...
	0x10, 0x01, 0x32, 0xcd, 0x04, 0x0a, 0x11, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e,
...
var file_management_proto_goTypes = []interface{}{
	...
	(*AmneziaConfig)(nil),                  // 23: management.AmneziaConfig
...
var file_management_proto_depIdxs = []int32{
	...
	23, // 26: management.PeerConfig.amneziaConfig:type_name -> management.AmneziaConfig
...
func file_management_proto_init() {
	...
	file_management_proto_msgTypes[18].OneofWrappers = []interface{}{}
	file_management_proto_msgTypes[19].OneofWrappers = []interface{}{}
