...
var file_management_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x45, 0x61, 0x67, 0x65, 0x72, 0x10, 0x02, 0x2a, 0x4c, 0x0a, 0x0c, 0x52, 0x75,
...
var file_management_proto_depIdxs = []int32{
	...
	67, // 9: management.SyncResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	...
	28, // 18: management.LoginResponse.netbirdConfig:type_name -> management.NetbirdConfig
	35, // 19: management.LoginResponse.peerConfig:type_name -> management.PeerConfig
	55, // 20: management.LoginResponse.Checks:type_name -> management.Checks
	67, // 21: management.LoginResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	22, // 22: management.ExtendAuthSessionRequest.meta:type_name -> management.PeerSystemMeta
	67, // 23: management.ExtendAuthSessionResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	67, // 24: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	29, // 25: management.NetbirdConfig.stuns:type_name -> management.HostConfig
	34, // 26: management.NetbirdConfig.turns:type_name -> management.ProtectedHostConfig
	29, // 27: management.NetbirdConfig.signal:type_name -> management.HostConfig
	30, // 28: management.NetbirdConfig.relay:type_name -> management.RelayConfig
	31, // 29: management.NetbirdConfig.flow:type_name -> management.FlowConfig
	32, // 30: management.NetbirdConfig.metrics:type_name -> management.MetricsConfig
	7,  // 31: management.HostConfig.protocol:type_name -> management.HostConfig.Protocol
	68, // 32: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	29, // 33: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	41, // 34: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	36, // 35: management.PeerConfig.autoUpdate:type_name -> management.AutoUpdateSettings
	35, // 36: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	40, // 37: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	47, // 38: management.NetworkMap.Routes:type_name -> management.Route
	48, // 39: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	40, // 40: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	53, // 41: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	57, // 42: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	58, // 43: management.NetworkMap.forwardingRules:type_name -> management.ForwardingRule
	38, // 44: management.NetworkMap.sshAuth:type_name -> management.SSHAuth
	65, // 45: management.SSHAuth.machine_users:type_name -> management.SSHAuth.MachineUsersEntry
	41, // 46: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	2,  // 47: management.RemotePeerConfig.lazyState:type_name -> management.LazyState
	...
	4,  // 56: management.FirewallRule.Direction:type_name -> management.RuleDirection
	5,  // 57: management.FirewallRule.Action:type_name -> management.RuleAction
	3,  // 58: management.FirewallRule.Protocol:type_name -> management.RuleProtocol
	56, // 59: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	66, // 60: management.PortInfo.range:type_name -> management.PortInfo.Range
	5,  // 61: management.RouteFirewallRule.action:type_name -> management.RuleAction
	3,  // 62: management.RouteFirewallRule.protocol:type_name -> management.RuleProtocol
	56, // 63: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	3,  // 64: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	...
	6,  // 67: management.ExposeServiceRequest.protocol:type_name -> management.ExposeProtocol
	39, // 68: management.SSHAuth.MachineUsersEntry.value:type_name -> management.MachineUserIndexes
	9,  // 69: management.ManagementService.Login:input_type -> management.EncryptedMessage
	9,  // 70: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	27, // 71: management.ManagementService.GetServerKey:input_type -> management.Empty
	27, // 72: management.ManagementService.isHealthy:input_type -> management.Empty
	9,  // 73: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	9,  // 74: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	9,  // 75: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	...
	9,  // 78: management.ManagementService.ExtendAuthSession:input_type -> management.EncryptedMessage
	9,  // 79: management.ManagementService.CreateExpose:input_type -> management.EncryptedMessage
	9,  // 80: management.ManagementService.RenewExpose:input_type -> management.EncryptedMessage
	9,  // 81: management.ManagementService.StopExpose:input_type -> management.EncryptedMessage
	9,  // 82: management.ManagementService.Login:output_type -> management.EncryptedMessage
	9,  // 83: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	26, // 84: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	27, // 85: management.ManagementService.isHealthy:output_type -> management.Empty
	9,  // 86: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	9,  // 87: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	27, // 88: management.ManagementService.SyncMeta:output_type -> management.Empty
	27, // 89: management.ManagementService.Logout:output_type -> management.Empty
	9,  // 90: management.ManagementService.Job:output_type -> management.EncryptedMessage
	9,  // 91: management.ManagementService.ExtendAuthSession:output_type -> management.EncryptedMessage
	9,  // 92: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	9,  // 93: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	9,  // 94: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
