...
type ServerKeyResponse struct {
	...
	// Version of the Netbird Management Service protocol
	Version int32 `protobuf:"varint,3,opt,name=version,proto3" json:"version,omitempty"`
	// Capabilities lists optional server features that clients can negotiate.
	// An absent or empty slice means the server does not support any optional features.
	// Old clients safely ignore this field (proto backward compatibility).
	// Known values: "DEVICE_CERT_AUTH", "DEVICE_ATTESTATION"
...
func (x *ServerKeyResponse) GetCapabilities() []string {
	if x != nil {
...
// DeviceEnrollRequest is the body of an EnrollDevice RPC call.
// The peer submits a PEM-encoded PKCS#10 CSR and its WireGuard public key.
type DeviceEnrollRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// wg_pub_key is the peer's WireGuard public key (also the CN of the issued certificate).
	...
	// system_info is a JSON-encoded snapshot of PeerSystemMeta for audit purposes.
	SystemInfo string `protobuf:"bytes,3,opt,name=system_info,json=systemInfo,proto3" json:"system_info,omitempty"`
	// attestation_proof carries the TPM attestation evidence when the client supports it.
	// When present the server attempts automatic enrollment without admin approval.
	// Absent on platforms that do not support TPM attestation (e.g. macOS Secure Enclave).
	AttestationProof *AttestationProof `protobuf:"bytes,4,opt,name=attestation_proof,json=attestationProof,proto3" json:"attestation_proof,omitempty"`
}

func (x *DeviceEnrollRequest) Reset() {
	*x = DeviceEnrollRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeviceEnrollRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeviceEnrollRequest) ProtoMessage() {}

func (x *DeviceEnrollRequest) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[53]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeviceEnrollRequest.ProtoReflect.Descriptor instead.
func (*DeviceEnrollRequest) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{53}
}

func (x *DeviceEnrollRequest) GetWgPubKey() string {
	if x != nil {
		return x.WgPubKey
	}
	return ""
...
func (x *DeviceEnrollRequest) GetCsrPem() string {
	if x != nil {
		return x.CsrPem
	}
	return ""
...
func (x *DeviceEnrollRequest) GetSystemInfo() string {
	if x != nil {
		return x.SystemInfo
	}
	return ""
...
func (x *DeviceEnrollRequest) GetAttestationProof() *AttestationProof {
	if x != nil {
...
// AttestationProof bundles the TPM 2.0 EK certificate and AK certify structures
// needed for server-side attestation verification.
type AttestationProof struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// ek_cert is the DER-encoded TPM Endorsement Key certificate issued by the manufacturer.
	EkCert []byte `protobuf:"bytes,1,opt,name=ek_cert,json=ekCert,proto3" json:"ek_cert,omitempty"`
	// certify_info is the TPMS_ATTEST structure returned by TPM2_Certify, DER-encoded.
	CertifyInfo []byte `protobuf:"bytes,2,opt,name=certify_info,json=certifyInfo,proto3" json:"certify_info,omitempty"`
	// certify_signature is the TPMT_SIGNATURE over certify_info, DER-encoded.
	CertifySignature []byte `protobuf:"bytes,3,opt,name=certify_signature,json=certifySignature,proto3" json:"certify_signature,omitempty"`
	// ak_pub is the DER-encoded SubjectPublicKeyInfo of the Attestation Key used to sign certify_info.
	AkPub []byte `protobuf:"bytes,4,opt,name=ak_pub,json=akPub,proto3" json:"ak_pub,omitempty"`
}
...
func (x *AttestationProof) GetEkCert() []byte {
	if x != nil {
		return x.EkCert
	}
	return nil
...
func (x *AttestationProof) GetCertifyInfo() []byte {
	if x != nil {
...
func (x *AttestationProof) GetCertifySignature() []byte {
	if x != nil {
...
func (x *AttestationProof) GetAkPub() []byte {
	if x != nil {
		return x.AkPub
	}
	return nil
...
// DeviceEnrollResponse is returned by EnrollDevice and GetEnrollmentStatus.
type DeviceEnrollResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// enrollment_id uniquely identifies this request (can be used to poll status).
	...
	// device_cert_pem is set when status == "approved".
	DeviceCertPem string `protobuf:"bytes,3,opt,name=device_cert_pem,json=deviceCertPem,proto3" json:"device_cert_pem,omitempty"`
	// reason is set when status == "rejected".
	Reason string `protobuf:"bytes,4,opt,name=reason,proto3" json:"reason,omitempty"`
}

func (x *DeviceEnrollResponse) Reset() {
	*x = DeviceEnrollResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DeviceEnrollResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeviceEnrollResponse) ProtoMessage() {}

func (x *DeviceEnrollResponse) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeviceEnrollResponse.ProtoReflect.Descriptor instead.
func (*DeviceEnrollResponse) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{55}
}

func (x *DeviceEnrollResponse) GetEnrollmentId() string {
	if x != nil {
...
func (x *DeviceEnrollResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *DeviceEnrollResponse) GetDeviceCertPem() string {
	if x != nil {
...
func (x *DeviceEnrollResponse) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
// EnrollmentStatusRequest is the body of a GetEnrollmentStatus RPC call.
type EnrollmentStatusRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// enrollment_id is the ID returned by EnrollDevice.
	EnrollmentId string `protobuf:"bytes,1,opt,name=enrollment_id,json=enrollmentId,proto3" json:"enrollment_id,omitempty"`
}
...
func (x *EnrollmentStatusRequest) GetEnrollmentId() string {
	if x != nil {
		return x.EnrollmentId
	}
	return ""
...
// AttestationResult is returned by both TPM and Apple SE attestation RPCs.
type AttestationResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// enrollment_id uniquely identifies this enrollment record.
	EnrollmentId string `protobuf:"bytes,1,opt,name=enrollment_id,json=enrollmentId,proto3" json:"enrollment_id,omitempty"`
	// status is one of: "pending" | "approved".
	Status string `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	// device_cert_pem is the issued device certificate, set when status == "approved".
	DeviceCertPem string `protobuf:"bytes,3,opt,name=device_cert_pem,json=deviceCertPem,proto3" json:"device_cert_pem,omitempty"`
}
...
func (x *AttestationResult) GetEnrollmentId() string {
	if x != nil {
		return x.EnrollmentId
	}
	return ""
...
func (x *AttestationResult) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *AttestationResult) GetDeviceCertPem() string {
	if x != nil {
		return x.DeviceCertPem
	}
	return ""
...
// BeginTPMAttestationRequest starts the two-round TPM 2.0 credential activation.
type BeginTPMAttestationRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// ak_pub_pem is the Attestation Key public key encoded as PEM SubjectPublicKeyInfo.
	AkPubPem string `protobuf:"bytes,1,opt,name=ak_pub_pem,json=akPubPem,proto3" json:"ak_pub_pem,omitempty"`
	// ek_cert_pem is the Endorsement Key certificate chain (leaf + intermediates), PEM.
	EkCertPem string `protobuf:"bytes,2,opt,name=ek_cert_pem,json=ekCertPem,proto3" json:"ek_cert_pem,omitempty"`
	// csr_pem is the PKCS#10 certificate signing request, PEM.
	CsrPem string `protobuf:"bytes,3,opt,name=csr_pem,json=csrPem,proto3" json:"csr_pem,omitempty"`
	// system_info is a JSON-encoded metadata blob (hostname, OS, serial, wg_pub_key).
	SystemInfo string `protobuf:"bytes,4,opt,name=system_info,json=systemInfo,proto3" json:"system_info,omitempty"`
}

func (x *BeginTPMAttestationRequest) Reset() {
	*x = BeginTPMAttestationRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BeginTPMAttestationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeginTPMAttestationRequest) ProtoMessage() {}

func (x *BeginTPMAttestationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[58]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeginTPMAttestationRequest.ProtoReflect.Descriptor instead.
func (*BeginTPMAttestationRequest) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{58}
}

func (x *BeginTPMAttestationRequest) GetAkPubPem() string {
	if x != nil {
		return x.AkPubPem
	}
	return ""
...
func (x *BeginTPMAttestationRequest) GetEkCertPem() string {
	if x != nil {
		return x.EkCertPem
	}
	return ""
...
func (x *BeginTPMAttestationRequest) GetCsrPem() string {
	if x != nil {
		return x.CsrPem
	}
	return ""
...
func (x *BeginTPMAttestationRequest) GetSystemInfo() string {
	if x != nil {
		return x.SystemInfo
	}
	return ""
...
// BeginTPMAttestationResponse carries the server's credential challenge.
type BeginTPMAttestationResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// session_id is an opaque 32-byte hex token; pass to CompleteTPMAttestation.
	SessionId string `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	// credential_blob is the output of server.MakeCredential (TPM2B_ID_OBJECT +
	// TPM2B_ENCRYPTED_SECRET). The client decrypts it with TPM2_ActivateCredential.
	CredentialBlob []byte `protobuf:"bytes,2,opt,name=credential_blob,json=credentialBlob,proto3" json:"credential_blob,omitempty"`
}

func (x *BeginTPMAttestationResponse) Reset() {
	*x = BeginTPMAttestationResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *BeginTPMAttestationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeginTPMAttestationResponse) ProtoMessage() {}

func (x *BeginTPMAttestationResponse) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[59]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeginTPMAttestationResponse.ProtoReflect.Descriptor instead.
func (*BeginTPMAttestationResponse) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{59}
}

func (x *BeginTPMAttestationResponse) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *BeginTPMAttestationResponse) GetCredentialBlob() []byte {
	if x != nil {
...
// CompleteTPMAttestationRequest submits the activated secret to finish attestation.
type CompleteTPMAttestationRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// session_id is the opaque token returned by BeginTPMAttestation.
	SessionId string `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	// activated_secret is the plaintext output of TPM2_ActivateCredential.
	ActivatedSecret []byte `protobuf:"bytes,2,opt,name=activated_secret,json=activatedSecret,proto3" json:"activated_secret,omitempty"`
}

func (x *CompleteTPMAttestationRequest) Reset() {
	*x = CompleteTPMAttestationRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CompleteTPMAttestationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompleteTPMAttestationRequest) ProtoMessage() {}

func (x *CompleteTPMAttestationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[60]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompleteTPMAttestationRequest.ProtoReflect.Descriptor instead.
func (*CompleteTPMAttestationRequest) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{60}
}

func (x *CompleteTPMAttestationRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *CompleteTPMAttestationRequest) GetActivatedSecret() []byte {
	if x != nil {
		return x.ActivatedSecret
	}
	return nil
}

// AttestAppleSERequest performs a single-round Apple Secure Enclave attestation.
type AttestAppleSERequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// attestation_pems contains the SE attestation certificate chain
	// (leaf first, root last), one PEM block per element.
	AttestationPems []string `protobuf:"bytes,2,rep,name=attestation_pems,json=attestationPems,proto3" json:"attestation_pems,omitempty"`
	// system_info is a JSON-encoded metadata blob.
	SystemInfo string `protobuf:"bytes,3,opt,name=system_info,json=systemInfo,proto3" json:"system_info,omitempty"`
}

func (x *AttestAppleSERequest) Reset() {
	*x = AttestAppleSERequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *AttestAppleSERequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttestAppleSERequest) ProtoMessage() {}

func (x *AttestAppleSERequest) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[61]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttestAppleSERequest.ProtoReflect.Descriptor instead.
func (*AttestAppleSERequest) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{61}
}

func (x *AttestAppleSERequest) GetCsrPem() string {
	if x != nil {
		return x.CsrPem
	}
	return ""
...
func (x *AttestAppleSERequest) GetAttestationPems() []string {
	if x != nil {
		return x.AttestationPems
	}
	return nil
}

func (x *AttestAppleSERequest) GetSystemInfo() string {
	if x != nil {
		return x.SystemInfo
	}
	return ""
...
var file_management_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x6b, 0x73, 0x22, 0x9d, 0x01, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4b,
	...
	0x74, 0x69, 0x65, 0x73, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0xff, 0x01,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xd3,
	...
	0x64, 0x61, 0x74, 0x65, 0x22, 0x52, 0x0a, 0x12, 0x41, 0x75, 0x74, 0x6f, 0x55, 0x70, 0x64, 0x61,
	...
	0x07, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x73, 0x22, 0xbb, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x6d,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x7e, 0x0a, 0x09, 0x53, 0x53, 0x48, 0x43, 0x6f, 0x6e,
	...
	0x72, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x50, 0x6f, 0x72, 0x74, 0x22, 0xa7,
	0x02, 0x0a, 0x0c, 0x46, 0x69, 0x72, 0x65, 0x77, 0x61, 0x6c, 0x6c, 0x52, 0x75, 0x6c, 0x65, 0x12,
	0x16, 0x0a, 0x06, 0x50, 0x65, 0x65, 0x72, 0x49, 0x50, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x49, 0x44, 0x22, 0x38, 0x0a, 0x0e, 0x4e, 0x65, 0x74, 0x77,
	...
	,
	...
	,
	...
	,
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x5f, 0x62, 0x6c, 0x6f, 0x62, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x0e, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x42, 0x6c,
	0x6f, 0x62, 0x22, 0x69, 0x0a, 0x1d, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x54, 0x50,
	0x4d, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x69, 0x6c, 0x65, 0x64, 0x10, 0x02, 0x2a, 0x4c, 0x0a, 0x0c, 0x52, 0x75, 0x6c, 0x65, 0x50, 0x72,
	...
	0x54, 0x43, 0x50, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x55, 0x44, 0x50, 0x10, 0x03, 0x12, 0x08,
	0x0a, 0x04, 0x49, 0x43, 0x4d, 0x50, 0x10, 0x04, 0x12, 0x0a, 0x0a, 0x06, 0x43, 0x55, 0x53, 0x54,
	0x4f, 0x4d, 0x10, 0x05, 0x2a, 0x20, 0x0a, 0x0d, 0x52, 0x75, 0x6c, 0x65, 0x44, 0x69, 0x72, 0x65,
	...
	0xc4, 0x0a, 0x0a, 0x11, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x65,
	...
	0x74, 0x2e, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x4c, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61,
	...
	0x4c, 0x0a, 0x0c, 0x45, 0x6e, 0x72, 0x6f, 0x6c, 0x6c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x1c, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x63,
	...
	,
	...
	0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_management_proto_goTypes = []interface{}{
	...
	(*DeviceEnrollRequest)(nil),            // 60: management.DeviceEnrollRequest
	(*AttestationProof)(nil),               // 61: management.AttestationProof
	(*DeviceEnrollResponse)(nil),           // 62: management.DeviceEnrollResponse
	(*EnrollmentStatusRequest)(nil),        // 63: management.EnrollmentStatusRequest
	(*AttestationResult)(nil),              // 64: management.AttestationResult
	(*BeginTPMAttestationRequest)(nil),     // 65: management.BeginTPMAttestationRequest
	(*BeginTPMAttestationResponse)(nil),    // 66: management.BeginTPMAttestationResponse
	(*CompleteTPMAttestationRequest)(nil),  // 67: management.CompleteTPMAttestationRequest
	(*AttestAppleSERequest)(nil),           // 68: management.AttestAppleSERequest
	nil,                                    // 69: management.SSHAuth.MachineUsersEntry
	(*PortInfo_Range)(nil),                 // 70: management.PortInfo.Range
...
var file_management_proto_depIdxs = []int32{
	...
	71, // 19: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	72, // 26: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	...
	69, // 39: management.SSHAuth.machine_users:type_name -> management.SSHAuth.MachineUsersEntry
	...
	70, // 53: management.PortInfo.range:type_name -> management.PortInfo.Range
	...
	61, // 61: management.DeviceEnrollRequest.attestation_proof:type_name -> management.AttestationProof
	...
	7,  // 75: management.ManagementService.EnrollDevice:input_type -> management.EncryptedMessage
	7,  // 76: management.ManagementService.GetEnrollmentStatus:input_type -> management.EncryptedMessage
	65, // 77: management.ManagementService.BeginTPMAttestation:input_type -> management.BeginTPMAttestationRequest
	67, // 78: management.ManagementService.CompleteTPMAttestation:input_type -> management.CompleteTPMAttestationRequest
	68, // 79: management.ManagementService.AttestAppleSE:input_type -> management.AttestAppleSERequest
	7,  // 80: management.ManagementService.Login:output_type -> management.EncryptedMessage
	7,  // 81: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	22, // 82: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	23, // 83: management.ManagementService.isHealthy:output_type -> management.Empty
	7,  // 84: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	7,  // 85: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	23, // 86: management.ManagementService.SyncMeta:output_type -> management.Empty
	23, // 87: management.ManagementService.Logout:output_type -> management.Empty
	7,  // 88: management.ManagementService.Job:output_type -> management.EncryptedMessage
	7,  // 89: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	7,  // 90: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	7,  // 91: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
	7,  // 92: management.ManagementService.EnrollDevice:output_type -> management.EncryptedMessage
	7,  // 93: management.ManagementService.GetEnrollmentStatus:output_type -> management.EncryptedMessage
	66, // 94: management.ManagementService.BeginTPMAttestation:output_type -> management.BeginTPMAttestationResponse
	64, // 95: management.ManagementService.CompleteTPMAttestation:output_type -> management.AttestationResult
	64, // 96: management.ManagementService.AttestAppleSE:output_type -> management.AttestationResult
...
func file_management_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_management_proto_msgTypes[53].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeviceEnrollRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_management_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeviceEnrollResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_management_proto_msgTypes[58].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BeginTPMAttestationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_management_proto_msgTypes[59].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BeginTPMAttestationResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_management_proto_msgTypes[60].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CompleteTPMAttestationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_management_proto_msgTypes[61].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AttestAppleSERequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
