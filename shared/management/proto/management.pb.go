...
var file_management_proto_rawDesc = []byte{
	...
	0x65, 0x2a, 0x3a, 0x0a, 0x09, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x12,
	...
	0x01, 0x12, 0x0a, 0x0a, 0x06, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x10, 0x02, 0x2a, 0x6c, 0x0a,
	...
	0x76, 0x36, 0x4f, 0x76, 0x65, 0x72, 0x6c, 0x61, 0x79, 0x10, 0x02, 0x2a, 0x4c, 0x0a, 0x0c, 0x52,
...
var file_management_proto_goTypes = []interface{}{
	...
	(*PortInfo_Range)(nil),                 // 64: management.PortInfo.Range
...
var file_management_proto_depIdxs = []int32{
	...
	65, // 9: management.SyncResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	...
	52, // 13: management.PeerSystemMeta.networkAddresses:type_name -> management.NetworkAddress
	...
	53, // 20: management.LoginResponse.Checks:type_name -> management.Checks
	65, // 21: management.LoginResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	21, // 22: management.ExtendAuthSessionRequest.meta:type_name -> management.PeerSystemMeta
	65, // 23: management.ExtendAuthSessionResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	65, // 24: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	66, // 31: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	28, // 32: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	39, // 33: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	...
	38, // 36: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	45, // 37: management.NetworkMap.Routes:type_name -> management.Route
	46, // 38: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	38, // 39: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	51, // 40: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	55, // 41: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	56, // 42: management.NetworkMap.forwardingRules:type_name -> management.ForwardingRule
	36, // 43: management.NetworkMap.sshAuth:type_name -> management.SSHAuth
	63, // 44: management.SSHAuth.machine_users:type_name -> management.SSHAuth.MachineUsersEntry
	39, // 45: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	31, // 46: management.SSHConfig.jwtConfig:type_name -> management.JWTConfig
	7,  // 47: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	44, // 48: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	44, // 49: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	49, // 50: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	47, // 51: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	48, // 52: management.CustomZone.Records:type_name -> management.SimpleRecord
	50, // 53: management.NameServerGroup.NameServers:type_name -> management.NameServer
	3,  // 54: management.FirewallRule.Direction:type_name -> management.RuleDirection
	4,  // 55: management.FirewallRule.Action:type_name -> management.RuleAction
	2,  // 56: management.FirewallRule.Protocol:type_name -> management.RuleProtocol
	54, // 57: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	64, // 58: management.PortInfo.range:type_name -> management.PortInfo.Range
	4,  // 59: management.RouteFirewallRule.action:type_name -> management.RuleAction
	2,  // 60: management.RouteFirewallRule.protocol:type_name -> management.RuleProtocol
	54, // 61: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	2,  // 62: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	54, // 63: management.ForwardingRule.destinationPort:type_name -> management.PortInfo
	54, // 64: management.ForwardingRule.translatedPort:type_name -> management.PortInfo
	5,  // 65: management.ExposeServiceRequest.protocol:type_name -> management.ExposeProtocol
	37, // 66: management.SSHAuth.MachineUsersEntry.value:type_name -> management.MachineUserIndexes
	...
	26, // 69: management.ManagementService.GetServerKey:input_type -> management.Empty
	26, // 70: management.ManagementService.isHealthy:input_type -> management.Empty
	...
	8,  // 76: management.ManagementService.ExtendAuthSession:input_type -> management.EncryptedMessage
	8,  // 77: management.ManagementService.CreateExpose:input_type -> management.EncryptedMessage
	8,  // 78: management.ManagementService.RenewExpose:input_type -> management.EncryptedMessage
	8,  // 79: management.ManagementService.StopExpose:input_type -> management.EncryptedMessage
	8,  // 80: management.ManagementService.Login:output_type -> management.EncryptedMessage
	8,  // 81: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	25, // 82: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	26, // 83: management.ManagementService.isHealthy:output_type -> management.Empty
	8,  // 84: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	8,  // 85: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	26, // 86: management.ManagementService.SyncMeta:output_type -> management.Empty
	26, // 87: management.ManagementService.Logout:output_type -> management.Empty
	8,  // 88: management.ManagementService.Job:output_type -> management.EncryptedMessage
	8,  // 89: management.ManagementService.ExtendAuthSession:output_type -> management.EncryptedMessage
	8,  // 90: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	8,  // 91: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	8,  // 92: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
