...
var file_management_proto_rawDesc = []byte{
	...
	0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0xa8, 0x02, 0x0a, 0x0d, 0x4e, 0x65, 0x74,
	...
	0x6e, 0x66, 0x69, 0x67, 0x52, 0x04, 0x66, 0x6c, 0x6f, 0x77, 0x12, 0x27, 0x0a, 0x03, 0x6a, 0x77,
	0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x4a, 0x57, 0x54, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x03,
	0x6a, 0x77, 0x74, 0x22, 0x98, 0x01, 0x0a, 0x0a, 0x48, 0x6f, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x64, 0x6e, 0x73, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x85, 0x01,
	...
	0x65, 0x6e, 0x41, 0x67, 0x65, 0x22, 0x7d, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74,
	...
	0x77, 0x6f, 0x72, 0x64, 0x22, 0x93, 0x02, 0x0a, 0x0a, 0x50, 0x65, 0x65, 0x72, 0x43, 0x6f, 0x6e,
	...
	0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x6d, 0x74, 0x75, 0x22, 0xb9, 0x05, 0x0a, 0x0a, 0x4e,
...
var file_management_proto_goTypes = []interface{}{
	...
	(*NetworkMap)(nil),                     // 30: management.NetworkMap
	...
	(*PortInfo_Range)(nil),                 // 50: management.PortInfo.Range
...
var file_management_proto_depIdxs = []int32{
	...
	31, // 6: management.SyncResponse.remotePeers:type_name -> management.RemotePeerConfig
	30, // 7: management.SyncResponse.NetworkMap:type_name -> management.NetworkMap
	46, // 8: management.SyncResponse.Checks:type_name -> management.Checks
	...
	45, // 12: management.PeerSystemMeta.networkAddresses:type_name -> management.NetworkAddress
	...
	46, // 18: management.LoginResponse.Checks:type_name -> management.Checks
	51, // 19: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	27, // 25: management.NetbirdConfig.jwt:type_name -> management.JWTConfig
	4,  // 26: management.HostConfig.protocol:type_name -> management.HostConfig.Protocol
	52, // 27: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	24, // 28: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	32, // 29: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	29, // 30: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	31, // 31: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	38, // 32: management.NetworkMap.Routes:type_name -> management.Route
	39, // 33: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	31, // 34: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	44, // 35: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	48, // 36: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	49, // 37: management.NetworkMap.forwardingRules:type_name -> management.ForwardingRule
	32, // 38: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	27, // 39: management.SSHConfig.jwtConfig:type_name -> management.JWTConfig
	5,  // 40: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	37, // 41: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	37, // 42: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	42, // 43: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	40, // 44: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	41, // 45: management.CustomZone.Records:type_name -> management.SimpleRecord
	43, // 46: management.NameServerGroup.NameServers:type_name -> management.NameServer
	2,  // 47: management.FirewallRule.Direction:type_name -> management.RuleDirection
	3,  // 48: management.FirewallRule.Action:type_name -> management.RuleAction
	1,  // 49: management.FirewallRule.Protocol:type_name -> management.RuleProtocol
	47, // 50: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	50, // 51: management.PortInfo.range:type_name -> management.PortInfo.Range
	3,  // 52: management.RouteFirewallRule.action:type_name -> management.RuleAction
	1,  // 53: management.RouteFirewallRule.protocol:type_name -> management.RuleProtocol
	47, // 54: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	1,  // 55: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	47, // 56: management.ForwardingRule.destinationPort:type_name -> management.PortInfo
	47, // 57: management.ForwardingRule.translatedPort:type_name -> management.PortInfo
	6,  // 58: management.ManagementService.Login:input_type -> management.EncryptedMessage
	6,  // 59: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	22, // 60: management.ManagementService.GetServerKey:input_type -> management.Empty
	22, // 61: management.ManagementService.isHealthy:input_type -> management.Empty
	6,  // 62: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 63: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 64: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	6,  // 65: management.ManagementService.Logout:input_type -> management.EncryptedMessage
	6,  // 66: management.ManagementService.Job:input_type -> management.EncryptedMessage
	6,  // 67: management.ManagementService.Login:output_type -> management.EncryptedMessage
	6,  // 68: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	21, // 69: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	22, // 70: management.ManagementService.isHealthy:output_type -> management.Empty
	6,  // 71: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	6,  // 72: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	22, // 73: management.ManagementService.SyncMeta:output_type -> management.Empty
	22, // 74: management.ManagementService.Logout:output_type -> management.Empty
	6,  // 75: management.ManagementService.Job:output_type -> management.EncryptedMessage
...
func file_management_proto_init() {
	...
	file_management_proto_msgTypes[41].OneofWrappers = []interface{}{
		(*PortInfo_Port)(nil),
		(*PortInfo_Range_)(nil),
	}
	type x struct{}
