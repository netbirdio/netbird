...
type CertSigningType int32

const (
	CertSigningType_CERT_SIGNING_INTERNAL CertSigningType = 0
	CertSigningType_CERT_SIGNING_ACME     CertSigningType = 1
)

// Enum value maps for CertSigningType.
var (
	CertSigningType_name = map[int32]string{
		0: "CERT_SIGNING_INTERNAL",
		1: "CERT_SIGNING_ACME",
	}
	CertSigningType_value = map[string]int32{
		"CERT_SIGNING_INTERNAL": 0,
		"CERT_SIGNING_ACME":     1,
	}
)

func (x CertSigningType) Enum() *CertSigningType {
	p := new(CertSigningType)
	*p = x
	return p
}

func (x CertSigningType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CertSigningType) Descriptor() protoreflect.EnumDescriptor {
	return file_management_proto_enumTypes[4].Descriptor()
}

func (CertSigningType) Type() protoreflect.EnumType {
	return &file_management_proto_enumTypes[4]
}

func (x CertSigningType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CertSigningType.Descriptor instead.
func (CertSigningType) EnumDescriptor() ([]byte, []int) {
...
type PeerConfig struct {
	...
	// CA certificates for the account's internal certificate authority
	CaCertificatesPem [][]byte `protobuf:"bytes,9,rep,name=ca_certificates_pem,json=caCertificatesPem,proto3" json:"ca_certificates_pem,omitempty"`
}
...
func (x *PeerConfig) GetCaCertificatesPem() [][]byte {
	if x != nil {
...
type SignCertificateRequest struct {
	...
	SigningType CertSigningType `protobuf:"varint,2,opt,name=signing_type,json=signingType,proto3,enum=management.CertSigningType" json:"signing_type,omitempty"`
...
func (x *SignCertificateRequest) GetCsrDer() []byte {
	if x != nil {
		return x.CsrDer
	}
	return nil
...
func (x *SignCertificateRequest) GetSigningType() CertSigningType {
	if x != nil {
		return x.SigningType
	}
	return CertSigningType_CERT_SIGNING_INTERNAL
}

func (x *SignCertificateRequest) GetWildcard() bool {
	if x != nil {
		return x.Wildcard
	}
	return false
...
type SignCertificateResponse struct {
	...
	InternalCertPem  []byte `protobuf:"bytes,1,opt,name=internal_cert_pem,json=internalCertPem,proto3" json:"internal_cert_pem,omitempty"`
	InternalChainPem []byte `protobuf:"bytes,2,opt,name=internal_chain_pem,json=internalChainPem,proto3" json:"internal_chain_pem,omitempty"`
	AcmeCertPem      []byte `protobuf:"bytes,3,opt,name=acme_cert_pem,json=acmeCertPem,proto3" json:"acme_cert_pem,omitempty"`
	AcmeChainPem     []byte `protobuf:"bytes,4,opt,name=acme_chain_pem,json=acmeChainPem,proto3" json:"acme_chain_pem,omitempty"`
...
func (x *SignCertificateResponse) GetInternalCertPem() []byte {
	if x != nil {
		return x.InternalCertPem
	}
	return nil
}

func (x *SignCertificateResponse) GetInternalChainPem() []byte {
	if x != nil {
		return x.InternalChainPem
	}
	return nil
}

func (x *SignCertificateResponse) GetAcmeCertPem() []byte {
	if x != nil {
		return x.AcmeCertPem
	}
	return nil
}

func (x *SignCertificateResponse) GetAcmeChainPem() []byte {
	if x != nil {
		return x.AcmeChainPem
	}
	return nil
}

func (x *SignCertificateResponse) GetExpiresAt() int64 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
type GetCACertificatesResponse struct {
	...
	Certificates []*CACertificateInfo `protobuf:"bytes,1,rep,name=certificates,proto3" json:"certificates,omitempty"`
}

func (x *GetCACertificatesResponse) Reset() {
	*x = GetCACertificatesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCACertificatesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[56]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *GetCACertificatesResponse) GetCertificates() []*CACertificateInfo {
	if x != nil {
...
func (x *CACertificateInfo) Reset() {
	*x = CACertificateInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *CACertificateInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CACertificateInfo) ProtoMessage() {}

func (x *CACertificateInfo) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[57]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CACertificateInfo.ProtoReflect.Descriptor instead.
func (*CACertificateInfo) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{57}
}

func (x *CACertificateInfo) GetCertificatePem() []byte {
	if x != nil {
...
func (x *CACertificateInfo) GetFingerprint() string {
	if x != nil {
...
func (x *CACertificateInfo) GetIsActive() bool {
	if x != nil {
		return x.IsActive
	}
	return false
...
func (x *CACertificateInfo) GetNotAfter() int64 {
	if x != nil {
		return x.NotAfter
	}
	return 0
...
var file_management_proto_rawDesc = []byte{
	...
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x83, 0x03, 0x0a, 0x0a, 0x50, 0x65,
	...
	0x2e, 0x0a, 0x13, 0x63, 0x61, 0x5f, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74,
	0x65, 0x73, 0x5f, 0x70, 0x65, 0x6d, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x11, 0x63, 0x61,
	0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x50, 0x65, 0x6d, 0x22,
	...
	,
	...
	0x01, 0x2a, 0x43, 0x0a, 0x0f, 0x43, 0x65, 0x72, 0x74, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x19, 0x0a, 0x15, 0x43, 0x45, 0x52, 0x54, 0x5f, 0x53, 0x49, 0x47,
	0x4e, 0x49, 0x4e, 0x47, 0x5f, 0x49, 0x4e, 0x54, 0x45, 0x52, 0x4e, 0x41, 0x4c, 0x10, 0x00, 0x12,
	0x15, 0x0a, 0x11, 0x43, 0x45, 0x52, 0x54, 0x5f, 0x53, 0x49, 0x47, 0x4e, 0x49, 0x4e, 0x47, 0x5f,
	0x41, 0x43, 0x4d, 0x45, 0x10, 0x01, 0x2a, 0x53, 0x0a, 0x0e, 0x45, 0x78, 0x70, 0x6f, 0x73, 0x65,
	...
	0x58, 0x50, 0x4f, 0x53, 0x45, 0x5f, 0x55, 0x44, 0x50, 0x10, 0x03, 0x32, 0xa1, 0x08, 0x0a, 0x11,
	...
	,
...
var file_management_proto_goTypes = []interface{}{
	...
	(CertSigningType)(0),                   // 4: management.CertSigningType
	...
	(*SignCertificateRequest)(nil),         // 61: management.SignCertificateRequest
	(*SignCertificateResponse)(nil),        // 62: management.SignCertificateResponse
	(*GetCACertificatesRequest)(nil),       // 63: management.GetCACertificatesRequest
	(*GetCACertificatesResponse)(nil),      // 64: management.GetCACertificatesResponse
	(*CACertificateInfo)(nil),              // 65: management.CACertificateInfo
...
var file_management_proto_depIdxs = []int32{
	...
	68, // 19: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	69, // 26: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	...
	31, // 30: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	36, // 31: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	43, // 32: management.NetworkMap.Routes:type_name -> management.Route
	44, // 33: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	36, // 34: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	49, // 35: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	53, // 36: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	54, // 37: management.NetworkMap.forwardingRules:type_name -> management.ForwardingRule
	34, // 38: management.NetworkMap.sshAuth:type_name -> management.SSHAuth
	66, // 39: management.SSHAuth.machine_users:type_name -> management.SSHAuth.MachineUsersEntry
	37, // 40: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	29, // 41: management.SSHConfig.jwtConfig:type_name -> management.JWTConfig
	7,  // 42: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	42, // 43: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	42, // 44: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	47, // 45: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	45, // 46: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	46, // 47: management.CustomZone.Records:type_name -> management.SimpleRecord
	48, // 48: management.NameServerGroup.NameServers:type_name -> management.NameServer
	...
	52, // 52: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	67, // 53: management.PortInfo.range:type_name -> management.PortInfo.Range
	...
	52, // 56: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	1,  // 57: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	52, // 58: management.ForwardingRule.destinationPort:type_name -> management.PortInfo
	52, // 59: management.ForwardingRule.translatedPort:type_name -> management.PortInfo
	5,  // 60: management.ExposeServiceRequest.protocol:type_name -> management.ExposeProtocol
	4,  // 61: management.SignCertificateRequest.signing_type:type_name -> management.CertSigningType
	65, // 62: management.GetCACertificatesResponse.certificates:type_name -> management.CACertificateInfo
	...
	8,  // 76: management.ManagementService.SignCertificate:input_type -> management.EncryptedMessage
	8,  // 77: management.ManagementService.GetCACertificates:input_type -> management.EncryptedMessage
	8,  // 78: management.ManagementService.Login:output_type -> management.EncryptedMessage
	8,  // 79: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	23, // 80: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	24, // 81: management.ManagementService.isHealthy:output_type -> management.Empty
	8,  // 82: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	8,  // 83: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	24, // 84: management.ManagementService.SyncMeta:output_type -> management.Empty
	24, // 85: management.ManagementService.Logout:output_type -> management.Empty
	8,  // 86: management.ManagementService.Job:output_type -> management.EncryptedMessage
	8,  // 87: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	8,  // 88: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	8,  // 89: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
	8,  // 90: management.ManagementService.SignCertificate:output_type -> management.EncryptedMessage
	8,  // 91: management.ManagementService.GetCACertificates:output_type -> management.EncryptedMessage
...
func file_management_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_management_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCACertificatesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_management_proto_msgTypes[56].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCACertificatesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_management_proto_msgTypes[57].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CACertificateInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
