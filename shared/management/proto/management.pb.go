...
var file_management_proto_depIdxs = []int32{
	...
	38, // 67: management.SSHAuth.MachineUsersEntry.value:type_name -> management.MachineUserIndexes
	8,  // 68: management.ManagementService.Login:input_type -> management.EncryptedMessage
	8,  // 69: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	26, // 70: management.ManagementService.GetServerKey:input_type -> management.Empty
	26, // 71: management.ManagementService.isHealthy:input_type -> management.Empty
	8,  // 72: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	8,  // 73: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	8,  // 74: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	8,  // 75: management.ManagementService.Logout:input_type -> management.EncryptedMessage
	8,  // 76: management.ManagementService.Job:input_type -> management.EncryptedMessage
	8,  // 77: management.ManagementService.ExtendAuthSession:input_type -> management.EncryptedMessage
	8,  // 78: management.ManagementService.CreateExpose:input_type -> management.EncryptedMessage
	8,  // 79: management.ManagementService.RenewExpose:input_type -> management.EncryptedMessage
	8,  // 80: management.ManagementService.StopExpose:input_type -> management.EncryptedMessage
	8,  // 81: management.ManagementService.Login:output_type -> management.EncryptedMessage
	8,  // 82: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	25, // 83: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	26, // 84: management.ManagementService.isHealthy:output_type -> management.Empty
	8,  // 85: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	8,  // 86: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	26, // 87: management.ManagementService.SyncMeta:output_type -> management.Empty
	26, // 88: management.ManagementService.Logout:output_type -> management.Empty
	8,  // 89: management.ManagementService.Job:output_type -> management.EncryptedMessage
	8,  // 90: management.ManagementService.ExtendAuthSession:output_type -> management.EncryptedMessage
	8,  // 91: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	8,  // 92: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	8,  // 93: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
