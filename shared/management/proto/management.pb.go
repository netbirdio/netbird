...
func (DeviceAuthorizationFlowProvider) EnumDescriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{32, 0}
}
...
func (x *VNCAuth) GetUserIDClaim() string {
	if x != nil {
		return x.UserIDClaim
	}
	return ""
...
var file_management_proto_rawDesc = []byte{
	...
	0x82, 0x02, 0x0a, 0x07, 0x56, 0x4e, 0x43, 0x41, 0x75, 0x74, 0x68, 0x12, 0x20, 0x0a, 0x0b, 0x55,
	...
	0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x56, 0x4e, 0x43, 0x41,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xbb, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x50,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x3a, 0x0a, 0x09, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x2a, 0x6c, 0x0a, 0x0e, 0x50, 0x65, 0x65, 0x72, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69,
	...
	0x79, 0x49, 0x50, 0x76, 0x36, 0x4f, 0x76, 0x65, 0x72, 0x6c, 0x61, 0x79, 0x10, 0x02, 0x2a, 0x4c,
	...
	0x45, 0x5f, 0x54, 0x4c, 0x53, 0x10, 0x04, 0x32, 0xfd, 0x06, 0x0a, 0x11, 0x4d, 0x61, 0x6e, 0x61,
...
var file_management_proto_goTypes = []interface{}{
	...
	nil,                                    // 63: management.VNCAuth.MachineUsersEntry
...
var file_management_proto_depIdxs = []int32{
	...
	65, // 20: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	66, // 27: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	...
	37, // 32: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	44, // 33: management.NetworkMap.Routes:type_name -> management.Route
	45, // 34: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	37, // 35: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	50, // 36: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	54, // 37: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	55, // 38: management.NetworkMap.forwardingRules:type_name -> management.ForwardingRule
	...
	63, // 42: management.VNCAuth.machine_users:type_name -> management.VNCAuth.MachineUsersEntry
	38, // 43: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	29, // 44: management.SSHConfig.jwtConfig:type_name -> management.JWTConfig
	7,  // 45: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	...
	64, // 56: management.PortInfo.range:type_name -> management.PortInfo.Range
	...
	35, // 64: management.SSHAuth.MachineUsersEntry.value:type_name -> management.MachineUserIndexes
	35, // 65: management.VNCAuth.MachineUsersEntry.value:type_name -> management.MachineUserIndexes
	8,  // 66: management.ManagementService.Login:input_type -> management.EncryptedMessage
	8,  // 67: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	24, // 68: management.ManagementService.GetServerKey:input_type -> management.Empty
	24, // 69: management.ManagementService.isHealthy:input_type -> management.Empty
	8,  // 70: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	8,  // 71: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	8,  // 72: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	8,  // 73: management.ManagementService.Logout:input_type -> management.EncryptedMessage
	8,  // 74: management.ManagementService.Job:input_type -> management.EncryptedMessage
	8,  // 75: management.ManagementService.CreateExpose:input_type -> management.EncryptedMessage
	8,  // 76: management.ManagementService.RenewExpose:input_type -> management.EncryptedMessage
	8,  // 77: management.ManagementService.StopExpose:input_type -> management.EncryptedMessage
...
func file_management_proto_init() {
	...
	file_management_proto_msgTypes[45].OneofWrappers = []interface{}{
		(*PortInfo_Port)(nil),
		(*PortInfo_Range_)(nil),
	}
	type x struct{}
