...
// CACertificateResponse A certificate authority certificate
type CACertificateResponse struct {
	// CertificatePem PEM-encoded CA certificate (only included in single CA detail responses)
	...
	// IsActive Whether this CA certificate is currently active
	IsActive bool `json:"is_active"`

	// NotAfter Certificate validity end time (UTC)
...
// IssuedCertificateResponse An issued certificate
type IssuedCertificateResponse struct {
	// CreatedAt Certificate issuance time (UTC)
	CreatedAt time.Time `json:"created_at"`

	// DnsNames DNS names included in the certificate
	DnsNames []string `json:"dns_names"`

	// HasWildcard Whether the certificate includes a wildcard DNS name
	...
	// PeerId ID of the peer this certificate was issued for
	PeerId string `json:"peer_id"`
	...
	// SigningType How the certificate was signed
...
// GetApiCaCertificatesParams defines parameters for GetApiCaCertificates.
type GetApiCaCertificatesParams struct {
	// PeerId Filter certificates by peer ID
