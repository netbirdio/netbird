...
func (m *Client) Sync(msgHandler func(msg *proto.SyncResponse) error) error {
	if m.SyncFunc == nil {
		return nil
	}
...
func (m *Client) GetServerPublicKey() (*wgtypes.Key, error) {
...
func (m *Client) Register(serverKey wgtypes.Key, setupKey string) (*proto.LoginResponse, error) {
...
func (m *Client) Login(serverKey wgtypes.Key) (*proto.LoginResponse, error) {
	if m.LoginFunc == nil {
		return nil, nil
	}
