...
var file_management_proto_rawDesc = []byte{
	...
	0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x6a, 0x0a, 0x0a, 0x46, 0x6c, 0x6f,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x7d, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74,
	...
	0x77, 0x6f, 0x72, 0x64, 0x22, 0xcb, 0x01, 0x0a, 0x0a, 0x50, 0x65, 0x65, 0x72, 0x43, 0x6f, 0x6e,
	...
	0x65, 0x64, 0x22, 0xb9, 0x05, 0x0a, 0x0a, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x4d, 0x61,
	...
	0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x22, 0x97,
	...
	0x73, 0x22, 0xed, 0x01, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49,
	...
	0x65, 0x22, 0xb4, 0x01, 0x0a, 0x09, 0x44, 0x4e, 0x53, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	...
	0x28, 0x03, 0x52, 0x04, 0x50, 0x6f, 0x72, 0x74, 0x22, 0x8b, 0x02, 0x0a, 0x0c, 0x46, 0x69, 0x72,
	...
	0x72, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x38, 0x0a, 0x0e, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72,
	...
	0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xd1, 0x02, 0x0a, 0x11, 0x52, 0x6f,
	...
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0xf2, 0x01,
...
var file_management_proto_depIdxs = []int32{
	...
	19, // 23: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	26, // 24: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	23, // 25: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	25, // 26: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	32, // 27: management.NetworkMap.Routes:type_name -> management.Route
	33, // 28: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	25, // 29: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	38, // 30: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	42, // 31: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	43, // 32: management.NetworkMap.forwardingRules:type_name -> management.ForwardingRule
	26, // 33: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	4,  // 34: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	31, // 35: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	31, // 36: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	36, // 37: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	34, // 38: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	35, // 39: management.CustomZone.Records:type_name -> management.SimpleRecord
	37, // 40: management.NameServerGroup.NameServers:type_name -> management.NameServer
	1,  // 41: management.FirewallRule.Direction:type_name -> management.RuleDirection
	2,  // 42: management.FirewallRule.Action:type_name -> management.RuleAction
	0,  // 43: management.FirewallRule.Protocol:type_name -> management.RuleProtocol
	41, // 44: management.FirewallRule.PortInfo:type_name -> management.PortInfo
	44, // 45: management.PortInfo.range:type_name -> management.PortInfo.Range
	2,  // 46: management.RouteFirewallRule.action:type_name -> management.RuleAction
	0,  // 47: management.RouteFirewallRule.protocol:type_name -> management.RuleProtocol
	41, // 48: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	0,  // 49: management.ForwardingRule.protocol:type_name -> management.RuleProtocol
	41, // 50: management.ForwardingRule.destinationPort:type_name -> management.PortInfo
	41, // 51: management.ForwardingRule.translatedPort:type_name -> management.PortInfo
	5,  // 52: management.ManagementService.Login:input_type -> management.EncryptedMessage
	5,  // 53: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	17, // 54: management.ManagementService.GetServerKey:input_type -> management.Empty
	17, // 55: management.ManagementService.isHealthy:input_type -> management.Empty
	5,  // 56: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	5,  // 57: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	5,  // 58: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	5,  // 59: management.ManagementService.Login:output_type -> management.EncryptedMessage
	5,  // 60: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	16, // 61: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	17, // 62: management.ManagementService.isHealthy:output_type -> management.Empty
	5,  // 63: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	5,  // 64: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	17, // 65: management.ManagementService.SyncMeta:output_type -> management.Empty
