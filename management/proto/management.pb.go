...
const (
	FirewallProtocol_UNKNOWN FirewallProtocol = 0
	FirewallProtocol_ALL     FirewallProtocol = 1
	FirewallProtocol_TCP     FirewallProtocol = 2
	FirewallProtocol_UDP     FirewallProtocol = 3
	FirewallProtocol_ICMP    FirewallProtocol = 4
)
...
const (
	FirewallDirection_IN  FirewallDirection = 0
	FirewallDirection_OUT FirewallDirection = 1
)
...
const (
	FirewallAction_ACCEPT FirewallAction = 0
	FirewallAction_DROP   FirewallAction = 1
)
...
type RouteFirewallRule_Family int32

const (
	RouteFirewallRule_IPV4 RouteFirewallRule_Family = 0
	RouteFirewallRule_IPV6 RouteFirewallRule_Family = 1
)

// Enum value maps for RouteFirewallRule_Family.
var (
	RouteFirewallRule_Family_name = map[int32]string{
		0: "IPV4",
		1: "IPV6",
	}
	RouteFirewallRule_Family_value = map[string]int32{
		"IPV4": 0,
		"IPV6": 1,
	}
)

func (x RouteFirewallRule_Family) Enum() *RouteFirewallRule_Family {
	p := new(RouteFirewallRule_Family)
	*p = x
	return p
}

func (x RouteFirewallRule_Family) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RouteFirewallRule_Family) Descriptor() protoreflect.EnumDescriptor {
	return file_management_proto_enumTypes[5].Descriptor()
}

func (RouteFirewallRule_Family) Type() protoreflect.EnumType {
	return &file_management_proto_enumTypes[5]
}

func (x RouteFirewallRule_Family) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RouteFirewallRule_Family.Descriptor instead.
func (RouteFirewallRule_Family) EnumDescriptor() ([]byte, []int) {
...
type FirewallRule struct {
	...
	Direction FirewallDirection `protobuf:"varint,2,opt,name=Direction,proto3,enum=management.FirewallDirection" json:"Direction,omitempty"`
	Action    FirewallAction    `protobuf:"varint,3,opt,name=Action,proto3,enum=management.FirewallAction" json:"Action,omitempty"`
	Protocol  FirewallProtocol  `protobuf:"varint,4,opt,name=Protocol,proto3,enum=management.FirewallProtocol" json:"Protocol,omitempty"`
...
func (x *FirewallRule) GetProtocol() FirewallProtocol {
	...
	return FirewallProtocol_UNKNOWN
}
...
type RouteFirewallRule struct {
	...
	Action FirewallAction `protobuf:"varint,3,opt,name=action,proto3,enum=management.FirewallAction" json:"action,omitempty"`
	// Type of IP family for the network.
	Family RouteFirewallRule_Family `protobuf:"varint,4,opt,name=family,proto3,enum=management.RouteFirewallRule_Family" json:"family,omitempty"`
	// Network prefix for the routed network.
	Destination string `protobuf:"bytes,5,opt,name=destination,proto3" json:"destination,omitempty"`
	// Protocol of the routed network.
	Protocol FirewallProtocol `protobuf:"varint,6,opt,name=protocol,proto3,enum=management.FirewallProtocol" json:"protocol,omitempty"`
	// Details about the port.
	PortInfo *PortInfo `protobuf:"bytes,7,opt,name=portInfo,proto3" json:"portInfo,omitempty"`
}
...
func (x *RouteFirewallRule) GetPeerIP() string {
	if x != nil {
		return x.PeerIP
	}
	return ""
...
func (x *RouteFirewallRule) GetDirection() FirewallDirection {
	if x != nil {
		return x.Direction
	}
	return FirewallDirection_IN
...
func (x *RouteFirewallRule) GetAction() FirewallAction {
	if x != nil {
		return x.Action
	}
	return FirewallAction_ACCEPT
...
func (x *RouteFirewallRule) GetFamily() RouteFirewallRule_Family {
	if x != nil {
		return x.Family
	}
	return RouteFirewallRule_IPV4
}
...
func (x *RouteFirewallRule) GetProtocol() FirewallProtocol {
	if x != nil {
		return x.Protocol
	}
	return FirewallProtocol_UNKNOWN
...
func (*PortInfo_Range) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{30, 0}
}
...
var file_management_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x03, 0x6d, 0x61, 0x63, 0x22, 0x96, 0x01, 0x0a, 0x08, 0x50, 0x6f, 0x72, 0x74, 0x49, 0x6e,
	...
	,
	...
	,
	...
	0x50, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x49, 0x43, 0x4d, 0x50, 0x10, 0x04, 0x2a, 0x24, 0x0a,
	0x11, 0x46, 0x69, 0x72, 0x65, 0x77, 0x61, 0x6c, 0x6c, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x06, 0x0a, 0x02, 0x49, 0x4e, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x4f, 0x55,
	0x54, 0x10, 0x01, 0x2a, 0x26, 0x0a, 0x0e, 0x46, 0x69, 0x72, 0x65, 0x77, 0x61, 0x6c, 0x6c, 0x41,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0a, 0x0a, 0x06, 0x41, 0x43, 0x43, 0x45, 0x50, 0x54, 0x10,
	0x00, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x52, 0x4f, 0x50, 0x10, 0x01, 0x32, 0xd1, 0x03, 0x0a, 0x11,
...
var file_management_proto_goTypes = []interface{}{
	(FirewallProtocol)(0),                  // 0: management.FirewallProtocol
	(FirewallDirection)(0),                 // 1: management.FirewallDirection
	(FirewallAction)(0),                    // 2: management.FirewallAction
	...
	(RouteFirewallRule_Family)(0),          // 5: management.RouteFirewallRule.Family
	...
	(*PeerSystemMeta)(nil),                 // 12: management.PeerSystemMeta
	(*LoginResponse)(nil),                  // 13: management.LoginResponse
	(*ServerKeyResponse)(nil),              // 14: management.ServerKeyResponse
	(*Empty)(nil),                          // 15: management.Empty
	(*WiretrusteeConfig)(nil),              // 16: management.WiretrusteeConfig
	(*HostConfig)(nil),                     // 17: management.HostConfig
	(*ProtectedHostConfig)(nil),            // 18: management.ProtectedHostConfig
	(*PeerConfig)(nil),                     // 19: management.PeerConfig
	(*NetworkMap)(nil),                     // 20: management.NetworkMap
	(*RemotePeerConfig)(nil),               // 21: management.RemotePeerConfig
	(*SSHConfig)(nil),                      // 22: management.SSHConfig
	(*DeviceAuthorizationFlowRequest)(nil), // 23: management.DeviceAuthorizationFlowRequest
	(*DeviceAuthorizationFlow)(nil),        // 24: management.DeviceAuthorizationFlow
	(*PKCEAuthorizationFlowRequest)(nil),   // 25: management.PKCEAuthorizationFlowRequest
	(*PKCEAuthorizationFlow)(nil),          // 26: management.PKCEAuthorizationFlow
	(*ProviderConfig)(nil),                 // 27: management.ProviderConfig
	(*Route)(nil),                          // 28: management.Route
	(*DNSConfig)(nil),                      // 29: management.DNSConfig
	(*CustomZone)(nil),                     // 30: management.CustomZone
	(*SimpleRecord)(nil),                   // 31: management.SimpleRecord
	(*NameServerGroup)(nil),                // 32: management.NameServerGroup
	(*NameServer)(nil),                     // 33: management.NameServer
	(*FirewallRule)(nil),                   // 34: management.FirewallRule
	(*NetworkAddress)(nil),                 // 35: management.NetworkAddress
	(*PortInfo)(nil),                       // 36: management.PortInfo
	(*RouteFirewallRule)(nil),              // 37: management.RouteFirewallRule
	(*PortInfo_Range)(nil),                 // 38: management.PortInfo.Range
	(*timestamppb.Timestamp)(nil),          // 39: google.protobuf.Timestamp
}
var file_management_proto_depIdxs = []int32{
	16, // 0: management.SyncResponse.wiretrusteeConfig:type_name -> management.WiretrusteeConfig
	19, // 1: management.SyncResponse.peerConfig:type_name -> management.PeerConfig
	21, // 2: management.SyncResponse.remotePeers:type_name -> management.RemotePeerConfig
	20, // 3: management.SyncResponse.NetworkMap:type_name -> management.NetworkMap
	12, // 4: management.LoginRequest.meta:type_name -> management.PeerSystemMeta
	10, // 5: management.LoginRequest.peerKeys:type_name -> management.PeerKeys
	35, // 6: management.PeerSystemMeta.networkAddresses:type_name -> management.NetworkAddress
	11, // 7: management.PeerSystemMeta.environment:type_name -> management.Environment
	16, // 8: management.LoginResponse.wiretrusteeConfig:type_name -> management.WiretrusteeConfig
	19, // 9: management.LoginResponse.peerConfig:type_name -> management.PeerConfig
	39, // 10: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	17, // 11: management.WiretrusteeConfig.stuns:type_name -> management.HostConfig
	18, // 12: management.WiretrusteeConfig.turns:type_name -> management.ProtectedHostConfig
	17, // 13: management.WiretrusteeConfig.signal:type_name -> management.HostConfig
	3,  // 14: management.HostConfig.protocol:type_name -> management.HostConfig.Protocol
	17, // 15: management.ProtectedHostConfig.hostConfig:type_name -> management.HostConfig
	22, // 16: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	19, // 17: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	21, // 18: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	28, // 19: management.NetworkMap.Routes:type_name -> management.Route
	29, // 20: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	21, // 21: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	34, // 22: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	22, // 23: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	4,  // 24: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	27, // 25: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	27, // 26: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	32, // 27: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	30, // 28: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	31, // 29: management.CustomZone.Records:type_name -> management.SimpleRecord
	33, // 30: management.NameServerGroup.NameServers:type_name -> management.NameServer
	1,  // 31: management.FirewallRule.Direction:type_name -> management.FirewallDirection
	2,  // 32: management.FirewallRule.Action:type_name -> management.FirewallAction
	0,  // 33: management.FirewallRule.Protocol:type_name -> management.FirewallProtocol
	38, // 34: management.PortInfo.range:type_name -> management.PortInfo.Range
	1,  // 35: management.RouteFirewallRule.direction:type_name -> management.FirewallDirection
	2,  // 36: management.RouteFirewallRule.action:type_name -> management.FirewallAction
	5,  // 37: management.RouteFirewallRule.family:type_name -> management.RouteFirewallRule.Family
	0,  // 38: management.RouteFirewallRule.protocol:type_name -> management.FirewallProtocol
	36, // 39: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	6,  // 40: management.ManagementService.Login:input_type -> management.EncryptedMessage
	6,  // 41: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	15, // 42: management.ManagementService.GetServerKey:input_type -> management.Empty
	15, // 43: management.ManagementService.isHealthy:input_type -> management.Empty
	6,  // 44: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 45: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 46: management.ManagementService.Login:output_type -> management.EncryptedMessage
	6,  // 47: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	14, // 48: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	15, // 49: management.ManagementService.isHealthy:output_type -> management.Empty
	6,  // 50: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	6,  // 51: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
...
func file_management_proto_init() {
	...
	file_management_proto_msgTypes[30].OneofWrappers = []interface{}{
		(*PortInfo_Port)(nil),
		(*PortInfo_Range_)(nil),
	}
	type x struct{}
