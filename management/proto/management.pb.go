...
type NetworkMap struct {
	...
	// List of nameservers to be applied
...
func (x *NetworkMap) GetNameServers() []*NameServer {
	if x != nil {
...
// NameServer represents a dns.NameServer object
...
var file_management_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x67, 0x22, 0xb1, 0x02, 0x0a, 0x0a, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x4d,
	...
	0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x06, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x12, 0x38, 0x0a,
	0x0b, 0x4e, 0x61, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x18, 0x06, 0x20, 0x03,
	...
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x6d, 0x6f,
	...
	0x69, 0x67, 0x52, 0x09, 0x73, 0x73, 0x68, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x49, 0x0a,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x48, 0x4f, 0x53, 0x54, 0x45, 0x44, 0x10, 0x00, 0x22, 0xda, 0x01, 0x0a,
	...
	0x6e, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0xb5, 0x01, 0x0a, 0x05, 0x52, 0x6f,
	...
	0x44, 0x22, 0x48, 0x0a, 0x0a, 0x4e, 0x61, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x50, 0x6f, 0x72, 0x74, 0x32, 0xf7, 0x02, 0x0a, 0x11,
...
var file_management_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_management_proto_goTypes = []interface{}{
	...
	(*NameServer)(nil),                     // 22: management.NameServer
...
var file_management_proto_depIdxs = []int32{
	...
	23, // 8: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	22, // 18: management.NetworkMap.NameServers:type_name -> management.NameServer
	...
	2,  // 22: management.ManagementService.Login:input_type -> management.EncryptedMessage
	2,  // 23: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	10, // 24: management.ManagementService.GetServerKey:input_type -> management.Empty
	10, // 25: management.ManagementService.isHealthy:input_type -> management.Empty
	2,  // 26: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	2,  // 27: management.ManagementService.Login:output_type -> management.EncryptedMessage
	2,  // 28: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	9,  // 29: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	10, // 30: management.ManagementService.isHealthy:output_type -> management.Empty
	2,  // 31: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
