...
var file_management_proto_rawDesc = []byte{
	...
	0x74, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xd1, 0x03, 0x0a, 0x11, 0x52,
	...
	0x6e, 0x67, 0x65, 0x73, 0x12, 0x37, 0x0a, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x52, 0x75, 0x6c, 0x65, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69,
...
var file_management_proto_depIdxs = []int32{
	...
	22, // 13: management.LoginResponse.peerConfig:type_name -> management.PeerConfig
	39, // 14: management.LoginResponse.Checks:type_name -> management.Checks
	43, // 15: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	19, // 16: management.WiretrusteeConfig.stuns:type_name -> management.HostConfig
	21, // 17: management.WiretrusteeConfig.turns:type_name -> management.ProtectedHostConfig
	19, // 18: management.WiretrusteeConfig.signal:type_name -> management.HostConfig
	20, // 19: management.WiretrusteeConfig.relay:type_name -> management.RelayConfig
	...
	25, // 22: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	22, // 23: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	24, // 24: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	31, // 25: management.NetworkMap.Routes:type_name -> management.Route
	32, // 26: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	24, // 27: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	37, // 28: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	41, // 29: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	25, // 30: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	4,  // 31: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	30, // 32: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	30, // 33: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	35, // 34: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	33, // 35: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	34, // 36: management.CustomZone.Records:type_name -> management.SimpleRecord
	36, // 37: management.NameServerGroup.NameServers:type_name -> management.NameServer
	...
	42, // 41: management.PortInfo.range:type_name -> management.PortInfo.Range
	1,  // 42: management.RouteFirewallRule.direction:type_name -> management.RuleDirection
	2,  // 43: management.RouteFirewallRule.action:type_name -> management.RuleAction
	5,  // 44: management.RouteFirewallRule.networkType:type_name -> management.RouteFirewallRule.NetworkType
	...
	6,  // 47: management.ManagementService.Login:input_type -> management.EncryptedMessage
	6,  // 48: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	...
	6,  // 51: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 52: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 53: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	6,  // 54: management.ManagementService.Login:output_type -> management.EncryptedMessage
	6,  // 55: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	...
	6,  // 58: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	6,  // 59: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
