...
type RouteFirewallRule_NetworkType int32

const (
	RouteFirewallRule_IPV4 RouteFirewallRule_NetworkType = 0
	RouteFirewallRule_IPV6 RouteFirewallRule_NetworkType = 1
)

// Enum value maps for RouteFirewallRule_NetworkType.
var (
	RouteFirewallRule_NetworkType_name = map[int32]string{
		0: "IPV4",
		1: "IPV6",
	}
	RouteFirewallRule_NetworkType_value = map[string]int32{
		"IPV4": 0,
		"IPV6": 1,
	}
)

func (x RouteFirewallRule_NetworkType) Enum() *RouteFirewallRule_NetworkType {
	p := new(RouteFirewallRule_NetworkType)
	*p = x
	return p
}

func (x RouteFirewallRule_NetworkType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RouteFirewallRule_NetworkType) Descriptor() protoreflect.EnumDescriptor {
	return file_management_proto_enumTypes[5].Descriptor()
}

func (RouteFirewallRule_NetworkType) Type() protoreflect.EnumType {
	return &file_management_proto_enumTypes[5]
}

func (x RouteFirewallRule_NetworkType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RouteFirewallRule_NetworkType.Descriptor instead.
func (RouteFirewallRule_NetworkType) EnumDescriptor() ([]byte, []int) {
...
type RouteFirewallRule struct {
	...
	SourceRange string `protobuf:"bytes,1,opt,name=sourceRange,proto3" json:"sourceRange,omitempty"`
	// Direction of the firewall.
	Direction RuleDirection `protobuf:"varint,2,opt,name=direction,proto3,enum=management.RuleDirection" json:"direction,omitempty"`
	// Action to be taken by the firewall when the rule is applicable.
	Action RuleAction `protobuf:"varint,3,opt,name=action,proto3,enum=management.RuleAction" json:"action,omitempty"`
	// NetworkType of the routed network.
	NetworkType RouteFirewallRule_NetworkType `protobuf:"varint,4,opt,name=networkType,proto3,enum=management.RouteFirewallRule_NetworkType" json:"networkType,omitempty"`
	// Network prefix for the routed network.
	Destination string `protobuf:"bytes,5,opt,name=destination,proto3" json:"destination,omitempty"`
	// Protocol of the routed network.
	Protocol RuleProtocol `protobuf:"varint,6,opt,name=protocol,proto3,enum=management.RuleProtocol" json:"protocol,omitempty"`
...
func (x *RouteFirewallRule) GetSourceRange() string {
	if x != nil {
...
func (x *RouteFirewallRule) GetDirection() RuleDirection {
	if x != nil {
		return x.Direction
	}
	return RuleDirection_IN
...
func (x *RouteFirewallRule) GetNetworkType() RouteFirewallRule_NetworkType {
	if x != nil {
		return x.NetworkType
	}
...
var file_management_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x66, 0x71, 0x64, 0x6e, 0x22, 0xf3, 0x04, 0x0a,
	...
	0x50, 0x6f, 0x72, 0x74, 0x22, 0xd9, 0x01, 0x0a, 0x0c, 0x46, 0x69, 0x72, 0x65, 0x77, 0x61, 0x6c,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x61, 0x63, 0x22, 0x96, 0x01, 0x0a, 0x08, 0x50,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x98, 0x03, 0x0a, 0x11, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x46, 0x69, 0x72,
	0x65, 0x77, 0x61, 0x6c, 0x6c, 0x52, 0x75, 0x6c, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x37, 0x0a, 0x09, 0x64,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2e, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4b, 0x0a, 0x0b, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x54,
	0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x29, 0x2e, 0x6d, 0x61, 0x6e, 0x61,
	0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x46, 0x69, 0x72, 0x65,
	0x77, 0x61, 0x6c, 0x6c, 0x52, 0x75, 0x6c, 0x65, 0x2e, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	...
	0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65,
	...
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6d, 0x61,
	0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x08, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x21, 0x0a, 0x0b, 0x4e,
	0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x49, 0x50,
	0x56, 0x34, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x49, 0x50, 0x56, 0x36, 0x10, 0x01, 0x2a, 0x40,
	...
	0x44, 0x52, 0x4f, 0x50, 0x10, 0x01, 0x32, 0xd1, 0x03, 0x0a, 0x11, 0x4d, 0x61, 0x6e, 0x61, 0x67,
...
var file_management_proto_goTypes = []interface{}{
	...
	(RouteFirewallRule_NetworkType)(0),     // 5: management.RouteFirewallRule.NetworkType
...
var file_management_proto_depIdxs = []int32{
	...
	37, // 23: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	22, // 24: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	4,  // 25: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	...
	1,  // 32: management.FirewallRule.Direction:type_name -> management.RuleDirection
	2,  // 33: management.FirewallRule.Action:type_name -> management.RuleAction
	0,  // 34: management.FirewallRule.Protocol:type_name -> management.RuleProtocol
	38, // 35: management.PortInfo.range:type_name -> management.PortInfo.Range
	1,  // 36: management.RouteFirewallRule.direction:type_name -> management.RuleDirection
	2,  // 37: management.RouteFirewallRule.action:type_name -> management.RuleAction
	5,  // 38: management.RouteFirewallRule.networkType:type_name -> management.RouteFirewallRule.NetworkType
	0,  // 39: management.RouteFirewallRule.protocol:type_name -> management.RuleProtocol
	36, // 40: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	6,  // 41: management.ManagementService.Login:input_type -> management.EncryptedMessage
	6,  // 42: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	15, // 43: management.ManagementService.GetServerKey:input_type -> management.Empty
	15, // 44: management.ManagementService.isHealthy:input_type -> management.Empty
	6,  // 45: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 46: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	6,  // 47: management.ManagementService.Login:output_type -> management.EncryptedMessage
	6,  // 48: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	14, // 49: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	15, // 50: management.ManagementService.isHealthy:output_type -> management.Empty
	6,  // 51: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	6,  // 52: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
