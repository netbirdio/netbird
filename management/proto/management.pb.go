...
type WiretrusteeConfig struct {
	...
	Turns []*HostConfig `protobuf:"bytes,2,rep,name=turns,proto3" json:"turns,omitempty"`
	// a Signal server config
	Signal *HostConfig `protobuf:"bytes,3,opt,name=signal,proto3" json:"signal,omitempty"`
	// a Management server config
	Management *HostConfig `protobuf:"bytes,4,opt,name=management,proto3" json:"management,omitempty"`
}
...
func (x *WiretrusteeConfig) GetTurns() []*HostConfig {
	if x != nil {
		return x.Turns
	}
	return nil
...
func (x *WiretrusteeConfig) GetManagement() *HostConfig {
	if x != nil {
		return x.Management
	}
	return nil
...
// HostConfig describes connection properties of some server (e.g. STUN, TURN, Signal, Management)
// User and Password are mostly used for TURN servers.
...
func (x *HostConfig) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_management_proto_rawDesc = []byte{
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0xd7, 0x01, 0x0a, 0x11, 0x57, 0x69, 0x72, 0x65, 0x74, 0x72,
	...
	0x69, 0x67, 0x52, 0x05, 0x73, 0x74, 0x75, 0x6e, 0x73, 0x12, 0x2c, 0x0a, 0x05, 0x74, 0x75, 0x72,
	0x6e, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x06, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x12, 0x36, 0x0a, 0x0a, 0x6d, 0x61, 0x6e, 0x61, 0x67,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6d, 0x61,
	0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x48, 0x6f, 0x73, 0x74, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x52, 0x0a, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x22,
	0x64, 0x0a, 0x0a, 0x48, 0x6f, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x12, 0x0a,
...
var file_management_proto_goTypes = []interface{}{
	...
	(*WiretrusteeConfig)(nil),    // 7: management.WiretrusteeConfig
	(*HostConfig)(nil),           // 8: management.HostConfig
	(*PeerConfig)(nil),           // 9: management.PeerConfig
	(*RemotePeerConfig)(nil),     // 10: management.RemotePeerConfig
	(*timestamp.Timestamp)(nil),  // 11: google.protobuf.Timestamp
}
var file_management_proto_depIdxs = []int32{
	7,  // 0: management.SyncResponse.wiretrusteeConfig:type_name -> management.WiretrusteeConfig
	9,  // 1: management.SyncResponse.peerConfig:type_name -> management.PeerConfig
	10, // 2: management.SyncResponse.remotePeers:type_name -> management.RemotePeerConfig
	11, // 3: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	8,  // 4: management.WiretrusteeConfig.stuns:type_name -> management.HostConfig
	8,  // 5: management.WiretrusteeConfig.turns:type_name -> management.HostConfig
	8,  // 6: management.WiretrusteeConfig.signal:type_name -> management.HostConfig
	8,  // 7: management.WiretrusteeConfig.management:type_name -> management.HostConfig
	3,  // 8: management.ManagementService.RegisterPeer:input_type -> management.RegisterPeerRequest
	0,  // 9: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	6,  // 10: management.ManagementService.GetServerKey:input_type -> management.Empty
	6,  // 11: management.ManagementService.isHealthy:input_type -> management.Empty
	4,  // 12: management.ManagementService.RegisterPeer:output_type -> management.RegisterPeerResponse
	0,  // 13: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	5,  // 14: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	6,  // 15: management.ManagementService.isHealthy:output_type -> management.Empty
