...
func (FirewallRuleAction) EnumDescriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{30, 1}
}
...
func (FirewallRuleProtocol) EnumDescriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{30, 2}
}
...
var file_management_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x46, 0x0a, 0x06, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x73, 0x12, 0x3c, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x52, 0x0c, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x32,
...
var file_management_proto_goTypes = []interface{}{
	...
	(*ProtectedHostConfig)(nil),            // 19: management.ProtectedHostConfig
	(*PeerConfig)(nil),                     // 20: management.PeerConfig
	(*NetworkMap)(nil),                     // 21: management.NetworkMap
	(*RemotePeerConfig)(nil),               // 22: management.RemotePeerConfig
	(*SSHConfig)(nil),                      // 23: management.SSHConfig
	(*DeviceAuthorizationFlowRequest)(nil), // 24: management.DeviceAuthorizationFlowRequest
	(*DeviceAuthorizationFlow)(nil),        // 25: management.DeviceAuthorizationFlow
	(*PKCEAuthorizationFlowRequest)(nil),   // 26: management.PKCEAuthorizationFlowRequest
	(*PKCEAuthorizationFlow)(nil),          // 27: management.PKCEAuthorizationFlow
	(*ProviderConfig)(nil),                 // 28: management.ProviderConfig
	(*Route)(nil),                          // 29: management.Route
	(*DNSConfig)(nil),                      // 30: management.DNSConfig
	(*CustomZone)(nil),                     // 31: management.CustomZone
	(*SimpleRecord)(nil),                   // 32: management.SimpleRecord
	(*NameServerGroup)(nil),                // 33: management.NameServerGroup
	(*NameServer)(nil),                     // 34: management.NameServer
	(*FirewallRule)(nil),                   // 35: management.FirewallRule
	(*NetworkAddress)(nil),                 // 36: management.NetworkAddress
	(*ProcessCheck)(nil),                   // 37: management.ProcessCheck
...
var file_management_proto_depIdxs = []int32{
	...
	37, // 39: management.Checks.ProcessCheck:type_name -> management.ProcessCheck
