...
type LoginResponse struct {
	...
	PostureChecks []*PostureChecks `protobuf:"bytes,3,rep,name=PostureChecks,proto3" json:"PostureChecks,omitempty"`
}
...
func (x *LoginResponse) GetPostureChecks() []*PostureChecks {
	if x != nil {
...
func (x *PostureChecks) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PostureChecks) ProtoMessage() {}

func (x *PostureChecks) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PostureChecks.ProtoReflect.Descriptor instead.
func (*PostureChecks) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{31}
}

func (x *PostureChecks) GetProcessCheck() *ProcessCheck {
	if x != nil {
...
var file_management_proto_rawDesc = []byte{
	...
	0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0xd5, 0x01, 0x0a, 0x0d, 0x4c, 0x6f, 0x67,
	...
	0x3f, 0x0a, 0x0d, 0x50, 0x6f, 0x73, 0x74, 0x75, 0x72, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d,
	0x65, 0x6e, 0x74, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x75, 0x72, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x73, 0x52, 0x0d, 0x50, 0x6f, 0x73, 0x74, 0x75, 0x72, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73,
	...
	0x63, 0x22, 0x24, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x12, 0x14, 0x0a, 0x05, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x05, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x4d, 0x0a, 0x0d, 0x50, 0x6f, 0x73, 0x74, 0x75,
	0x72, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x12, 0x3c, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x63,
...
var file_management_proto_goTypes = []interface{}{
	...
	(*PostureChecks)(nil),                  // 36: management.PostureChecks
...
var file_management_proto_depIdxs = []int32{
	...
	36, // 10: management.LoginResponse.PostureChecks:type_name -> management.PostureChecks
	37, // 11: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	16, // 12: management.WiretrusteeConfig.stuns:type_name -> management.HostConfig
	17, // 13: management.WiretrusteeConfig.turns:type_name -> management.ProtectedHostConfig
	16, // 14: management.WiretrusteeConfig.signal:type_name -> management.HostConfig
	...
	21, // 17: management.PeerConfig.sshConfig:type_name -> management.SSHConfig
	18, // 18: management.NetworkMap.peerConfig:type_name -> management.PeerConfig
	20, // 19: management.NetworkMap.remotePeers:type_name -> management.RemotePeerConfig
	27, // 20: management.NetworkMap.Routes:type_name -> management.Route
	28, // 21: management.NetworkMap.DNSConfig:type_name -> management.DNSConfig
	20, // 22: management.NetworkMap.offlinePeers:type_name -> management.RemotePeerConfig
	33, // 23: management.NetworkMap.FirewallRules:type_name -> management.FirewallRule
	21, // 24: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	1,  // 25: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	26, // 26: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	26, // 27: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	31, // 28: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	29, // 29: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	30, // 30: management.CustomZone.Records:type_name -> management.SimpleRecord
	32, // 31: management.NameServerGroup.NameServers:type_name -> management.NameServer
	...
	35, // 35: management.PostureChecks.ProcessCheck:type_name -> management.ProcessCheck
	5,  // 36: management.ManagementService.Login:input_type -> management.EncryptedMessage
	5,  // 37: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	14, // 38: management.ManagementService.GetServerKey:input_type -> management.Empty
	14, // 39: management.ManagementService.isHealthy:input_type -> management.Empty
	5,  // 40: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	5,  // 41: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	5,  // 42: management.ManagementService.Login:output_type -> management.EncryptedMessage
	5,  // 43: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	13, // 44: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	14, // 45: management.ManagementService.isHealthy:output_type -> management.Empty
	5,  // 46: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	5,  // 47: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
