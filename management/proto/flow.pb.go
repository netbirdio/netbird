...
func (x *EventFields) GetPortInfo() *FlowPortInfo {
...
func (x *EventFields) GetIcmpInfo() *FlowICMPInfo {
...
type EventFields_PortInfo struct {
	...
	PortInfo *FlowPortInfo `protobuf:"bytes,6,opt,name=port_info,json=portInfo,proto3,oneof"`
}

type EventFields_IcmpInfo struct {
	// ICMP type and code
	IcmpInfo *FlowICMPInfo `protobuf:"bytes,7,opt,name=icmp_info,json=icmpInfo,proto3,oneof"`
}
...
func (x *FlowPortInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FlowPortInfo) ProtoMessage() {}

func (x *FlowPortInfo) ProtoReflect() protoreflect.Message {
	mi := &file_flow_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FlowPortInfo.ProtoReflect.Descriptor instead.
func (*FlowPortInfo) Descriptor() ([]byte, []int) {
	return file_flow_proto_rawDescGZIP(), []int{3}
}

func (x *FlowPortInfo) GetSourcePort() uint32 {
	if x != nil {
		return x.SourcePort
	}
	return 0
...
func (x *FlowPortInfo) GetDestPort() uint32 {
	if x != nil {
		return x.DestPort
	}
	return 0
...
func (x *FlowICMPInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FlowICMPInfo) ProtoMessage() {}

func (x *FlowICMPInfo) ProtoReflect() protoreflect.Message {
	mi := &file_flow_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FlowICMPInfo.ProtoReflect.Descriptor instead.
func (*FlowICMPInfo) Descriptor() ([]byte, []int) {
	return file_flow_proto_rawDescGZIP(), []int{4}
}

func (x *FlowICMPInfo) GetIcmpType() uint32 {
	if x != nil {
		return x.IcmpType
	}
	return 0
...
func (x *FlowICMPInfo) GetIcmpCode() uint32 {
	if x != nil {
		return x.IcmpCode
	}
	return 0
...
var file_flow_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0xbf, 0x02, 0x0a, 0x0b,
	...
	,
	...
	0x0d, 0x52, 0x08, 0x64, 0x65, 0x73, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x22, 0x48, 0x0a, 0x0c, 0x46,
	0x6c, 0x6f, 0x77, 0x49, 0x43, 0x4d, 0x50, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1b, 0x0a, 0x09, 0x69,
...
var file_flow_proto_goTypes = []interface{}{
	...
	(*FlowPortInfo)(nil),          // 5: management.FlowPortInfo
	(*FlowICMPInfo)(nil),          // 6: management.FlowICMPInfo
...
var file_flow_proto_depIdxs = []int32{
	...
	5, // 4: management.EventFields.port_info:type_name -> management.FlowPortInfo
	6, // 5: management.EventFields.icmp_info:type_name -> management.FlowICMPInfo
