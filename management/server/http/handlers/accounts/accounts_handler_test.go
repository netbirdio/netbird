	...
	tt := []struct {
	...
	}{
		{
			...
			expectedSettings: api.AccountSettings{
				...
				RegularUsersViewBlocked:           true,
				RegularUsersGroupPeersViewEnabled: br(false),
		...
		{
			name:           "PutAccount OK enabling regular_users_group_peers_view_enabled",
			expectedBody:   true,
			requestType:    http.MethodPut,
			requestPath:    "/api/accounts/" + accountID,
			requestBody:    bytes.NewBufferString("{\"settings\": {\"peer_login_expiration\": 15552000,\"peer_login_expiration_enabled\": true,\"regular_users_group_peers_view_enabled\":true},\"onboarding\": {\"onboarding_flow_pending\": true,\"signup_form_pending\": true}}"),
			expectedStatus: http.StatusOK,
			expectedSettings: api.AccountSettings{
				PeerLoginExpiration:               15552000,
				PeerLoginExpirationEnabled:        true,
				...
				JwtAllowGroups:                    &[]string{},
				RegularUsersViewBlocked:           false,
				RegularUsersGroupPeersViewEnabled: br(true),
				RoutingPeerDnsResolutionEnabled:   br(false),
				LazyConnectionEnabled:             br(false),
				DnsDomain:                         sr(""),
				AutoUpdateAlways:                  br(false),
		...
		{
			name:           "PutAccount OK explicitly disabling regular_users_group_peers_view_enabled",
			expectedBody:   true,
			requestType:    http.MethodPut,
			requestPath:    "/api/accounts/" + accountID,
			requestBody:    bytes.NewBufferString("{\"settings\": {\"peer_login_expiration\": 15552000,\"peer_login_expiration_enabled\": true,\"regular_users_group_peers_view_enabled\":false},\"onboarding\": {\"onboarding_flow_pending\": true,\"signup_form_pending\": true}}"),
			expectedStatus: http.StatusOK,
			expectedSettings: api.AccountSettings{
				PeerLoginExpiration:               15552000,
				PeerLoginExpirationEnabled:        true,
