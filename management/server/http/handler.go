...
func (apiHandler *apiHandler) addAccountsEndpoint() {
	accountsHandler := accounts.NewAccountsHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addPeersEndpoint() {
	peersHandler := peers.NewPeersHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addUsersEndpoint() {
	userHandler := users.NewUsersHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addUsersTokensEndpoint() {
	tokenHandler := users.NewPATsHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addSetupKeysEndpoint() {
	keysHandler := setup_keys.NewSetupKeysHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addPoliciesEndpoint() {
	policiesHandler := policies.NewPoliciesHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addGroupsEndpoint() {
	groupsHandler := groups.NewGroupsHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addRoutesEndpoint() {
	routesHandler := routes.NewRoutesHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addDNSNameserversEndpoint() {
	nameserversHandler := dns.NewNameserversHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addDNSSettingEndpoint() {
	dnsSettingsHandler := dns.NewDNSSettingsHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addEventsEndpoint() {
	eventsHandler := events.NewEventsHandler(apiHandler.AccountManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addPostureCheckEndpoint() {
	postureCheckHandler := policies.NewPostureChecksHandler(apiHandler.AccountManager, apiHandler.geolocationManager, apiHandler.AuthCfg)
...
func (apiHandler *apiHandler) addLocationsEndpoint() {
	locationHandler := policies.NewGeolocationsHandlerHandler(apiHandler.AccountManager, apiHandler.geolocationManager, apiHandler.AuthCfg)
