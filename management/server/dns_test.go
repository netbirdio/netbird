...
func createDNSManager(t *testing.T) (*DefaultAccountManager, error) {
	...
	return BuildManager(context.Background(), store, NewPeersUpdateManager(nil), NewJobManager(nil), nil, "", "netbird.test", eventStore, nil, false, MockIntegratedValidator{}, metrics, port_forwarding.NewControllerMock(), settingsMockManager, permissionsManager, false)
}
