...
func TestDefaultJsonFields(t *testing.T) {
	...
	var tests = []struct {
		...
		},
		{
			...
			unmarshallTargets: []any{types.Account{}.Settings.JWTAllowGroups, types.Account{}.Settings.NetworkRange, types.Account{}.Settings.NetworkRangeV6, types.Account{}.Settings.PeerExposeGroups,
				types.Account{}.Settings.IPv6EnabledGroups, types.Account{}.Settings.Extra.IntegratedValidatorGroups},
		},
		{
			...
			unmarshallTargets: []any{route.Route{}.Network, route.Route{}.Domains, route.Route{}.PeerGroups, route.Route{}.AccessControlGroups},
		},
		{
			...
			unmarshallTargets: []any{types.Account{}.Network.Net, types.Account{}.Network.NetV6},
		},
		{
