...
func TestAccount_getPeersByPolicy(t *testing.T) {
	...
	t.Run("check first peer map details", func(t *testing.T) {
		...
		epectedFirewallRules := []*FirewallRule{
			{PeerID: "cfif97at2r9s73au3q00", PeerIP: "100.65.14.88", Direction: "src", Action: "accept", Port: ""},
			{PeerID: "cfif97at2r9s73au3q00", PeerIP: "100.65.14.88", Direction: "dst", Action: "accept", Port: ""},

			{PeerID: "cfif97at2r9s73au3q0g", PeerIP: "100.65.80.39", Direction: "dst", Action: "accept", Port: ""},
			{PeerID: "cfif97at2r9s73au3q0g", PeerIP: "100.65.80.39", Direction: "src", Action: "accept", Port: ""},

			{PeerID: "cfif97at2r9s73au3q10", PeerIP: "100.65.254.139", Direction: "dst", Action: "accept", Port: ""},
			{PeerID: "cfif97at2r9s73au3q10", PeerIP: "100.65.254.139", Direction: "src", Action: "accept", Port: ""},

			{PeerID: "cfif97at2r9s73au3q20", PeerIP: "100.65.62.5", Direction: "dst", Action: "accept", Port: ""},
			{PeerID: "cfif97at2r9s73au3q20", PeerIP: "100.65.62.5", Direction: "src", Action: "accept", Port: ""},

			{PeerID: "cfj4tiqt2r9s73dmeun0", PeerIP: "100.65.32.206", Direction: "dst", Action: "accept", Port: ""},
			{PeerID: "cfj4tiqt2r9s73dmeun0", PeerIP: "100.65.32.206", Direction: "src", Action: "accept", Port: ""},

			{PeerID: "cg7h032t2r9s73cg5fk0", PeerIP: "100.65.250.202", Direction: "dst", Action: "accept", Port: ""},
			{PeerID: "cg7h032t2r9s73cg5fk0", PeerIP: "100.65.250.202", Direction: "src", Action: "accept", Port: ""},

			{PeerID: "cgcnkj2t2r9s73cg5vv0", PeerIP: "100.65.13.186", Direction: "dst", Action: "accept", Port: ""},
			{PeerID: "cgcnkj2t2r9s73cg5vv0", PeerIP: "100.65.13.186", Direction: "src", Action: "accept", Port: ""},

			{PeerID: "cgcol4qt2r9s73cg601g", PeerIP: "100.65.29.55", Direction: "dst", Action: "accept", Port: ""},
			{PeerID: "cgcol4qt2r9s73cg601g", PeerIP: "100.65.29.55", Direction: "src", Action: "accept", Port: ""},
		}
