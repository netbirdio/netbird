...
type MockAccountManager struct {
	...
	CreateRouteFunc                 func(accountID string, prefix, peer, peersGroup, description, netID string, masquerade bool, metric int, groups []string, enabled bool, userID string) (*route.Route, error)
...
func (am *MockAccountManager) CreateRoute(accountID string, network, peerID, peersGroup, description, netID string, masquerade bool, metric int, groups []string, enabled bool, userID string) (*route.Route, error) {
	if am.CreateRouteFunc != nil {
		return am.CreateRouteFunc(accountID, network, peerID, peersGroup, description, netID, masquerade, metric, groups, enabled, userID)
	}
