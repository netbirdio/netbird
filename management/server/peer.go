...
func (am *DefaultAccountManager) UpdateAccountPeers(ctx context.Context, accountID string) {
	...
	for _, peer := range account.Peers {
		...
		go func(p *nbpeer.Peer) {
			...
			update := toSyncResponse(ctx, &types.Config{}, p, nil, nil, remotePeerNetworkMap, am.GetDNSDomain(), postureChecks, dnsCache, account.Settings.RoutingPeerDNSResolutionEnabled, extraSetting)
...
func (am *DefaultAccountManager) UpdateAccountPeer(ctx context.Context, accountId string, peerId string) {
	...
	update := toSyncResponse(ctx, &types.Config{}, peer, nil, nil, remotePeerNetworkMap, am.GetDNSDomain(), postureChecks, dnsCache, account.Settings.RoutingPeerDNSResolutionEnabled, extraSettings)
