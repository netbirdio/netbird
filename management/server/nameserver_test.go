...
func TestCreateNameServerGroup(t *testing.T) {
	...
	// name should be within size constrain
	// nameservers should be valid
	// nameservers list size should be valid
	// groups id should exist
	// group should not be empty and valid string
	type input struct {
		network     string
		netID       string
		peer        string
