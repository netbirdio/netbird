...
type Body struct {
	...
	SessionId          *int64 `protobuf:"varint,9,opt,name=sessionId,proto3,oneof" json:"sessionId,omitempty"`
}
...
func (x *Body) GetSessionId() int64 {
...
var file_signalexchange_proto_rawDesc = []byte{
	...
	0x6e, 0x49, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x09, 0x73, 0x65, 0x73,
