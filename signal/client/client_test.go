	...
	Describe("Exchanging messages", func() {
		Context("between connected peers", func() {
			It("should be successful", func() {
				...
				go func() {
					err := clientA.Receive(nil, func(msg *sigProto.Message) error {
				...
				go func() {
					err := clientB.Receive(nil, func(msg *sigProto.Message) error {
	...
	Describe("Connecting to the Signal stream channel", func() {
		Context("with a signal client", func() {
			It("should be successful", func() {
				...
				go func() {
					err := client.Receive(nil, func(msg *sigProto.Message) error {
						return nil
					})
					if err != nil {
						return
