...
// — placed in the function-scope defer so every return path (panic, backoff exhausted, 
// ctx cancel) closes it. Callers that need to observe "is the goroutine still alive?" use
