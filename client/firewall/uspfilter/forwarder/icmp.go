...
func (f *Forwarder) handleICMP(id stack.TransportEndpointID, pkt stack.PacketBufferPtr) bool {
	flowID := uuid.New()
	f.sendICMPEvent(flowstore.TypeStart, flowID, id)
	...
	if err != nil {
		...
		f.sendICMPEvent(flowstore.TypeEnd, flowID, id)
...
func (f *Forwarder) sendICMPEvent(typ flowstore.Type, flowID uuid.UUID, id stack.TransportEndpointID) {
