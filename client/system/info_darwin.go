...
func GetInfo(ctx context.Context) *Info {
	...
	gio := &Info{Kernel: sysName, OSVersion: strings.TrimSpace(string(swVersion)), Core: release, Platform: machine, OS: sysName, GoOS: runtime.GOOS, CPUs: runtime.NumCPU(), Ipv6Supported: true}
