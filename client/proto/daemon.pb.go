...
type DownRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// keepInterface, when set, tells the daemon to leave the OS-level WireGuard
	// interface in place instead of destroying it on shutdown. Set only by the
	// service-stop path ahead of an in-place binary upgrade; regular `netbird
	// down` calls leave this unset.
	KeepInterface bool `protobuf:"varint,1,opt,name=keepInterface,proto3" json:"keepInterface,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DownRequest) GetKeepInterface() bool {
	if x != nil {
		return x.KeepInterface
	}
	return false
}
...
const file_daemon_proto_rawDesc = "" +
	...
	"\x10sessionExpiresAt\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x10sessionExpiresAt\"3\n" +
	"\vDownRequest\x12$\n" +
	"\rkeepInterface\x18\x01 \x01(\bR\rkeepInterface\"\x0e\n" +
	"\fDownResponse\"P\n" +
