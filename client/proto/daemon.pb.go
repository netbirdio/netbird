...
var file_daemon_proto_goTypes = []any{
	...
	(*WailsUIReadyRequest)(nil),                // 75: daemon.WailsUIReadyRequest
	(*WailsUIReadyResponse)(nil),               // 76: daemon.WailsUIReadyResponse
	...
	(*RequestExtendAuthSessionRequest)(nil),    // 88: daemon.RequestExtendAuthSessionRequest
	(*RequestExtendAuthSessionResponse)(nil),   // 89: daemon.RequestExtendAuthSessionResponse
	(*WaitExtendAuthSessionRequest)(nil),       // 90: daemon.WaitExtendAuthSessionRequest
	(*WaitExtendAuthSessionResponse)(nil),      // 91: daemon.WaitExtendAuthSessionResponse
	(*DismissSessionWarningRequest)(nil),       // 92: daemon.DismissSessionWarningRequest
	(*DismissSessionWarningResponse)(nil),      // 93: daemon.DismissSessionWarningResponse
	(*StartCPUProfileRequest)(nil),             // 94: daemon.StartCPUProfileRequest
	(*StartCPUProfileResponse)(nil),            // 95: daemon.StartCPUProfileResponse
	(*StopCPUProfileRequest)(nil),              // 96: daemon.StopCPUProfileRequest
	(*StopCPUProfileResponse)(nil),             // 97: daemon.StopCPUProfileResponse
	(*InstallerResultRequest)(nil),             // 98: daemon.InstallerResultRequest
	(*InstallerResultResponse)(nil),            // 99: daemon.InstallerResultResponse
	(*ExposeServiceRequest)(nil),               // 100: daemon.ExposeServiceRequest
	(*ExposeServiceEvent)(nil),                 // 101: daemon.ExposeServiceEvent
	(*ExposeServiceReady)(nil),                 // 102: daemon.ExposeServiceReady
	(*StartCaptureRequest)(nil),                // 103: daemon.StartCaptureRequest
	(*CapturePacket)(nil),                      // 104: daemon.CapturePacket
	(*StartBundleCaptureRequest)(nil),          // 105: daemon.StartBundleCaptureRequest
	(*StartBundleCaptureResponse)(nil),         // 106: daemon.StartBundleCaptureResponse
	(*StopBundleCaptureRequest)(nil),           // 107: daemon.StopBundleCaptureRequest
	(*StopBundleCaptureResponse)(nil),          // 108: daemon.StopBundleCaptureResponse
	nil,                                        // 109: daemon.Network.ResolvedIPsEntry
	(*PortInfo_Range)(nil),                     // 110: daemon.PortInfo.Range
	nil,                                        // 111: daemon.SystemEvent.MetadataEntry
	(*durationpb.Duration)(nil),                // 112: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),              // 113: google.protobuf.Timestamp
}
var file_daemon_proto_depIdxs = []int32{
	112, // 0: daemon.LoginRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	25,  // 1: daemon.StatusResponse.fullStatus:type_name -> daemon.FullStatus
	113, // 2: daemon.StatusResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	113, // 3: daemon.PeerState.connStatusUpdate:type_name -> google.protobuf.Timestamp
	113, // 4: daemon.PeerState.lastWireguardHandshake:type_name -> google.protobuf.Timestamp
	112, // 5: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	...
	109, // 16: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	110, // 17: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	...
	113, // 28: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	111, // 29: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	57,  // 30: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	112, // 31: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	70,  // 32: daemon.ListProfilesResponse.profiles:type_name -> daemon.Profile
	113, // 33: daemon.WaitExtendAuthSessionResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	1,   // 34: daemon.ExposeServiceRequest.protocol:type_name -> daemon.ExposeProtocol
	102, // 35: daemon.ExposeServiceEvent.ready:type_name -> daemon.ExposeServiceReady
	112, // 36: daemon.StartCaptureRequest.duration:type_name -> google.protobuf.Duration
	112, // 37: daemon.StartBundleCaptureRequest.timeout:type_name -> google.protobuf.Duration
	...
	103, // 58: daemon.DaemonService.StartCapture:input_type -> daemon.StartCaptureRequest
	105, // 59: daemon.DaemonService.StartBundleCapture:input_type -> daemon.StartBundleCaptureRequest
	107, // 60: daemon.DaemonService.StopBundleCapture:input_type -> daemon.StopBundleCaptureRequest
	...
	66,  // 67: daemon.DaemonService.RemoveProfile:input_type -> daemon.RemoveProfileRequest
	68,  // 68: daemon.DaemonService.ListProfiles:input_type -> daemon.ListProfilesRequest
	71,  // 69: daemon.DaemonService.GetActiveProfile:input_type -> daemon.GetActiveProfileRequest
	73,  // 70: daemon.DaemonService.Logout:input_type -> daemon.LogoutRequest
	77,  // 71: daemon.DaemonService.GetFeatures:input_type -> daemon.GetFeaturesRequest
	80,  // 72: daemon.DaemonService.TriggerUpdate:input_type -> daemon.TriggerUpdateRequest
	82,  // 73: daemon.DaemonService.GetPeerSSHHostKey:input_type -> daemon.GetPeerSSHHostKeyRequest
	84,  // 74: daemon.DaemonService.RequestJWTAuth:input_type -> daemon.RequestJWTAuthRequest
	86,  // 75: daemon.DaemonService.WaitJWTToken:input_type -> daemon.WaitJWTTokenRequest
	88,  // 76: daemon.DaemonService.RequestExtendAuthSession:input_type -> daemon.RequestExtendAuthSessionRequest
	90,  // 77: daemon.DaemonService.WaitExtendAuthSession:input_type -> daemon.WaitExtendAuthSessionRequest
	92,  // 78: daemon.DaemonService.DismissSessionWarning:input_type -> daemon.DismissSessionWarningRequest
	94,  // 79: daemon.DaemonService.StartCPUProfile:input_type -> daemon.StartCPUProfileRequest
	96,  // 80: daemon.DaemonService.StopCPUProfile:input_type -> daemon.StopCPUProfileRequest
	98,  // 81: daemon.DaemonService.GetInstallerResult:input_type -> daemon.InstallerResultRequest
	100, // 82: daemon.DaemonService.ExposeService:input_type -> daemon.ExposeServiceRequest
	75,  // 83: daemon.DaemonService.WailsUIReady:input_type -> daemon.WailsUIReadyRequest
	6,   // 84: daemon.DaemonService.Login:output_type -> daemon.LoginResponse
	8,   // 85: daemon.DaemonService.WaitSSOLogin:output_type -> daemon.WaitSSOLoginResponse
	10,  // 86: daemon.DaemonService.Up:output_type -> daemon.UpResponse
	12,  // 87: daemon.DaemonService.Status:output_type -> daemon.StatusResponse
	12,  // 88: daemon.DaemonService.SubscribeStatus:output_type -> daemon.StatusResponse
	14,  // 89: daemon.DaemonService.Down:output_type -> daemon.DownResponse
	16,  // 90: daemon.DaemonService.GetConfig:output_type -> daemon.GetConfigResponse
	27,  // 91: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	29,  // 92: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	29,  // 93: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	34,  // 94: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	36,  // 95: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	38,  // 96: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	40,  // 97: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	45,  // 98: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	47,  // 99: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	49,  // 100: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	51,  // 101: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	55,  // 102: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	104, // 103: daemon.DaemonService.StartCapture:output_type -> daemon.CapturePacket
	106, // 104: daemon.DaemonService.StartBundleCapture:output_type -> daemon.StartBundleCaptureResponse
	108, // 105: daemon.DaemonService.StopBundleCapture:output_type -> daemon.StopBundleCaptureResponse
	57,  // 106: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	59,  // 107: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	42,  // 108: daemon.DaemonService.RegisterUILog:output_type -> daemon.RegisterUILogResponse
	61,  // 109: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	63,  // 110: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	65,  // 111: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	67,  // 112: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	69,  // 113: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	72,  // 114: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	74,  // 115: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	78,  // 116: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	81,  // 117: daemon.DaemonService.TriggerUpdate:output_type -> daemon.TriggerUpdateResponse
	83,  // 118: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	85,  // 119: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	87,  // 120: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	89,  // 121: daemon.DaemonService.RequestExtendAuthSession:output_type -> daemon.RequestExtendAuthSessionResponse
	91,  // 122: daemon.DaemonService.WaitExtendAuthSession:output_type -> daemon.WaitExtendAuthSessionResponse
	93,  // 123: daemon.DaemonService.DismissSessionWarning:output_type -> daemon.DismissSessionWarningResponse
	95,  // 124: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	97,  // 125: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	99,  // 126: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
	101, // 127: daemon.DaemonService.ExposeService:output_type -> daemon.ExposeServiceEvent
	76,  // 128: daemon.DaemonService.WailsUIReady:output_type -> daemon.WailsUIReadyResponse
	84,  // [84:129] is the sub-list for method output_type
	39,  // [39:84] is the sub-list for method input_type
