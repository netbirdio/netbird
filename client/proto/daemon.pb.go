...
var file_daemon_proto_depIdxs = []int32{
	...
	44, // 11: daemon.FullStatus.events:type_name -> daemon.SystemEvent
	27, // 12: daemon.ListNetworksResponse.routes:type_name -> daemon.Network
	47, // 13: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	...
	1,  // 17: daemon.SystemEvent.severity:type_name -> daemon.SystemEvent.Severity
	2,  // 18: daemon.SystemEvent.category:type_name -> daemon.SystemEvent.Category
	50, // 19: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	48, // 20: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	44, // 21: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	26, // 22: daemon.Network.ResolvedIPsEntry.value:type_name -> daemon.IPList
	3,  // 23: daemon.DaemonService.Login:input_type -> daemon.LoginRequest
	5,  // 24: daemon.DaemonService.WaitSSOLogin:input_type -> daemon.WaitSSOLoginRequest
	7,  // 25: daemon.DaemonService.Up:input_type -> daemon.UpRequest
	9,  // 26: daemon.DaemonService.Status:input_type -> daemon.StatusRequest
	11, // 27: daemon.DaemonService.Down:input_type -> daemon.DownRequest
	13, // 28: daemon.DaemonService.GetConfig:input_type -> daemon.GetConfigRequest
	22, // 29: daemon.DaemonService.ListNetworks:input_type -> daemon.ListNetworksRequest
	24, // 30: daemon.DaemonService.SelectNetworks:input_type -> daemon.SelectNetworksRequest
	24, // 31: daemon.DaemonService.DeselectNetworks:input_type -> daemon.SelectNetworksRequest
	28, // 32: daemon.DaemonService.DebugBundle:input_type -> daemon.DebugBundleRequest
	30, // 33: daemon.DaemonService.GetLogLevel:input_type -> daemon.GetLogLevelRequest
	32, // 34: daemon.DaemonService.SetLogLevel:input_type -> daemon.SetLogLevelRequest
	35, // 35: daemon.DaemonService.ListStates:input_type -> daemon.ListStatesRequest
	37, // 36: daemon.DaemonService.CleanState:input_type -> daemon.CleanStateRequest
	39, // 37: daemon.DaemonService.DeleteState:input_type -> daemon.DeleteStateRequest
	41, // 38: daemon.DaemonService.SetNetworkMapPersistence:input_type -> daemon.SetNetworkMapPersistenceRequest
	43, // 39: daemon.DaemonService.SubscribeEvents:input_type -> daemon.SubscribeRequest
	45, // 40: daemon.DaemonService.GetEvents:input_type -> daemon.GetEventsRequest
	4,  // 41: daemon.DaemonService.Login:output_type -> daemon.LoginResponse
	6,  // 42: daemon.DaemonService.WaitSSOLogin:output_type -> daemon.WaitSSOLoginResponse
	8,  // 43: daemon.DaemonService.Up:output_type -> daemon.UpResponse
	10, // 44: daemon.DaemonService.Status:output_type -> daemon.StatusResponse
	12, // 45: daemon.DaemonService.Down:output_type -> daemon.DownResponse
	14, // 46: daemon.DaemonService.GetConfig:output_type -> daemon.GetConfigResponse
	23, // 47: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	25, // 48: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	25, // 49: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	29, // 50: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	31, // 51: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	33, // 52: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	36, // 53: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	38, // 54: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	40, // 55: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	42, // 56: daemon.DaemonService.SetNetworkMapPersistence:output_type -> daemon.SetNetworkMapPersistenceResponse
	44, // 57: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	46, // 58: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
