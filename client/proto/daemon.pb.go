...
const file_daemon_proto_rawDesc = "" +
	...
	"\x12port_auto_assigned\x18\x04 \x01(\bR\x10portAutoAssigned\"\x16\n" +
	"\x14FlushDNSCacheRequest\"\x17\n" +
	"\x15FlushDNSCacheResponse*b\n" +
	"\bLogLevel\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\t\n" +
	...
	"\rExposeService\x12\x1c.daemon.ExposeServiceRequest\x1a\x1a.daemon.ExposeServiceEvent\"\x000\x01\x12N\n" +
	"\rFlushDNSCache\x12\x1c.daemon.FlushDNSCacheRequest\x1a\x1d.daemon.FlushDNSCacheResponse\"\x00B\bZ\x06/protob\x06proto3"
...
var file_daemon_proto_msgTypes = make([]protoimpl.MessageInfo, 95)
var file_daemon_proto_goTypes = []any{
	...
	(*FlushDNSCacheRequest)(nil),               // 95: daemon.FlushDNSCacheRequest
	(*FlushDNSCacheResponse)(nil),              // 96: daemon.FlushDNSCacheResponse
	nil,                                        // 97: daemon.Network.ResolvedIPsEntry
	(*PortInfo_Range)(nil),                     // 98: daemon.PortInfo.Range
	nil,                                        // 99: daemon.SystemEvent.MetadataEntry
...
var file_daemon_proto_depIdxs = []int32{
	...
	100, // 1: daemon.LoginRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	28,  // 2: daemon.StatusResponse.fullStatus:type_name -> daemon.FullStatus
	101, // 3: daemon.PeerState.connStatusUpdate:type_name -> google.protobuf.Timestamp
	101, // 4: daemon.PeerState.lastWireguardHandshake:type_name -> google.protobuf.Timestamp
	100, // 5: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	...
	97,  // 16: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	98,  // 17: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	...
	101, // 28: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	99,  // 29: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	58,  // 30: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	100, // 31: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	...
	95,  // 73: daemon.DaemonService.FlushDNSCache:input_type -> daemon.FlushDNSCacheRequest
	...
	79,  // 102: daemon.DaemonService.TriggerUpdate:output_type -> daemon.TriggerUpdateResponse
	81,  // 103: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	83,  // 104: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	85,  // 105: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	87,  // 106: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	89,  // 107: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	7,   // 108: daemon.DaemonService.NotifyOSLifecycle:output_type -> daemon.OSLifecycleResponse
	91,  // 109: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
	93,  // 110: daemon.DaemonService.ExposeService:output_type -> daemon.ExposeServiceEvent
	96,  // 111: daemon.DaemonService.FlushDNSCache:output_type -> daemon.FlushDNSCacheResponse
