...
var file_daemon_proto_msgTypes = make([]protoimpl.MessageInfo, 103)
var file_daemon_proto_goTypes = []any{
	...
	(*RequestExtendAuthSessionRequest)(nil),    // 83: daemon.RequestExtendAuthSessionRequest
	(*RequestExtendAuthSessionResponse)(nil),   // 84: daemon.RequestExtendAuthSessionResponse
	(*WaitExtendAuthSessionRequest)(nil),       // 85: daemon.WaitExtendAuthSessionRequest
	(*WaitExtendAuthSessionResponse)(nil),      // 86: daemon.WaitExtendAuthSessionResponse
	(*DismissSessionWarningRequest)(nil),       // 87: daemon.DismissSessionWarningRequest
	(*DismissSessionWarningResponse)(nil),      // 88: daemon.DismissSessionWarningResponse
	(*StartCPUProfileRequest)(nil),             // 89: daemon.StartCPUProfileRequest
	(*StartCPUProfileResponse)(nil),            // 90: daemon.StartCPUProfileResponse
	(*StopCPUProfileRequest)(nil),              // 91: daemon.StopCPUProfileRequest
	(*StopCPUProfileResponse)(nil),             // 92: daemon.StopCPUProfileResponse
	(*InstallerResultRequest)(nil),             // 93: daemon.InstallerResultRequest
	(*InstallerResultResponse)(nil),            // 94: daemon.InstallerResultResponse
	(*ExposeServiceRequest)(nil),               // 95: daemon.ExposeServiceRequest
	(*ExposeServiceEvent)(nil),                 // 96: daemon.ExposeServiceEvent
	(*ExposeServiceReady)(nil),                 // 97: daemon.ExposeServiceReady
	(*StartCaptureRequest)(nil),                // 98: daemon.StartCaptureRequest
	(*CapturePacket)(nil),                      // 99: daemon.CapturePacket
	(*StartBundleCaptureRequest)(nil),          // 100: daemon.StartBundleCaptureRequest
	(*StartBundleCaptureResponse)(nil),         // 101: daemon.StartBundleCaptureResponse
	(*StopBundleCaptureRequest)(nil),           // 102: daemon.StopBundleCaptureRequest
	(*StopBundleCaptureResponse)(nil),          // 103: daemon.StopBundleCaptureResponse
	nil,                                        // 104: daemon.Network.ResolvedIPsEntry
	(*PortInfo_Range)(nil),                     // 105: daemon.PortInfo.Range
	nil,                                        // 106: daemon.SystemEvent.MetadataEntry
	(*durationpb.Duration)(nil),                // 107: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),              // 108: google.protobuf.Timestamp
}
var file_daemon_proto_depIdxs = []int32{
	107, // 0: daemon.LoginRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	25,  // 1: daemon.StatusResponse.fullStatus:type_name -> daemon.FullStatus
	108, // 2: daemon.StatusResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	108, // 3: daemon.PeerState.connStatusUpdate:type_name -> google.protobuf.Timestamp
	108, // 4: daemon.PeerState.lastWireguardHandshake:type_name -> google.protobuf.Timestamp
	107, // 5: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	...
	104, // 16: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	105, // 17: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	...
	108, // 28: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	106, // 29: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	55,  // 30: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	107, // 31: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	68,  // 32: daemon.ListProfilesResponse.profiles:type_name -> daemon.Profile
	108, // 33: daemon.WaitExtendAuthSessionResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	1,   // 34: daemon.ExposeServiceRequest.protocol:type_name -> daemon.ExposeProtocol
	97,  // 35: daemon.ExposeServiceEvent.ready:type_name -> daemon.ExposeServiceReady
	107, // 36: daemon.StartCaptureRequest.duration:type_name -> google.protobuf.Duration
	107, // 37: daemon.StartBundleCaptureRequest.timeout:type_name -> google.protobuf.Duration
	...
	44,  // 54: daemon.DaemonService.CleanState:input_type -> daemon.CleanStateRequest
	46,  // 55: daemon.DaemonService.DeleteState:input_type -> daemon.DeleteStateRequest
	48,  // 56: daemon.DaemonService.SetSyncResponsePersistence:input_type -> daemon.SetSyncResponsePersistenceRequest
	51,  // 57: daemon.DaemonService.TracePacket:input_type -> daemon.TracePacketRequest
	98,  // 58: daemon.DaemonService.StartCapture:input_type -> daemon.StartCaptureRequest
	100, // 59: daemon.DaemonService.StartBundleCapture:input_type -> daemon.StartBundleCaptureRequest
	102, // 60: daemon.DaemonService.StopBundleCapture:input_type -> daemon.StopBundleCaptureRequest
	54,  // 61: daemon.DaemonService.SubscribeEvents:input_type -> daemon.SubscribeRequest
	56,  // 62: daemon.DaemonService.GetEvents:input_type -> daemon.GetEventsRequest
	58,  // 63: daemon.DaemonService.SwitchProfile:input_type -> daemon.SwitchProfileRequest
	60,  // 64: daemon.DaemonService.SetConfig:input_type -> daemon.SetConfigRequest
	62,  // 65: daemon.DaemonService.AddProfile:input_type -> daemon.AddProfileRequest
	64,  // 66: daemon.DaemonService.RemoveProfile:input_type -> daemon.RemoveProfileRequest
	66,  // 67: daemon.DaemonService.ListProfiles:input_type -> daemon.ListProfilesRequest
	69,  // 68: daemon.DaemonService.GetActiveProfile:input_type -> daemon.GetActiveProfileRequest
	71,  // 69: daemon.DaemonService.Logout:input_type -> daemon.LogoutRequest
	73,  // 70: daemon.DaemonService.GetFeatures:input_type -> daemon.GetFeaturesRequest
	75,  // 71: daemon.DaemonService.TriggerUpdate:input_type -> daemon.TriggerUpdateRequest
	77,  // 72: daemon.DaemonService.GetPeerSSHHostKey:input_type -> daemon.GetPeerSSHHostKeyRequest
	79,  // 73: daemon.DaemonService.RequestJWTAuth:input_type -> daemon.RequestJWTAuthRequest
	81,  // 74: daemon.DaemonService.WaitJWTToken:input_type -> daemon.WaitJWTTokenRequest
	83,  // 75: daemon.DaemonService.RequestExtendAuthSession:input_type -> daemon.RequestExtendAuthSessionRequest
	85,  // 76: daemon.DaemonService.WaitExtendAuthSession:input_type -> daemon.WaitExtendAuthSessionRequest
	87,  // 77: daemon.DaemonService.DismissSessionWarning:input_type -> daemon.DismissSessionWarningRequest
	89,  // 78: daemon.DaemonService.StartCPUProfile:input_type -> daemon.StartCPUProfileRequest
	91,  // 79: daemon.DaemonService.StopCPUProfile:input_type -> daemon.StopCPUProfileRequest
	93,  // 80: daemon.DaemonService.GetInstallerResult:input_type -> daemon.InstallerResultRequest
	95,  // 81: daemon.DaemonService.ExposeService:input_type -> daemon.ExposeServiceRequest
	6,   // 82: daemon.DaemonService.Login:output_type -> daemon.LoginResponse
	8,   // 83: daemon.DaemonService.WaitSSOLogin:output_type -> daemon.WaitSSOLoginResponse
	10,  // 84: daemon.DaemonService.Up:output_type -> daemon.UpResponse
	12,  // 85: daemon.DaemonService.Status:output_type -> daemon.StatusResponse
	12,  // 86: daemon.DaemonService.SubscribeStatus:output_type -> daemon.StatusResponse
	14,  // 87: daemon.DaemonService.Down:output_type -> daemon.DownResponse
	16,  // 88: daemon.DaemonService.GetConfig:output_type -> daemon.GetConfigResponse
	27,  // 89: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	29,  // 90: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	29,  // 91: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	34,  // 92: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	36,  // 93: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	38,  // 94: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	40,  // 95: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	43,  // 96: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	45,  // 97: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	47,  // 98: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	49,  // 99: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	53,  // 100: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	99,  // 101: daemon.DaemonService.StartCapture:output_type -> daemon.CapturePacket
	101, // 102: daemon.DaemonService.StartBundleCapture:output_type -> daemon.StartBundleCaptureResponse
	103, // 103: daemon.DaemonService.StopBundleCapture:output_type -> daemon.StopBundleCaptureResponse
	55,  // 104: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	57,  // 105: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	59,  // 106: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	61,  // 107: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	63,  // 108: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	65,  // 109: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	67,  // 110: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	70,  // 111: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	72,  // 112: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	74,  // 113: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	76,  // 114: daemon.DaemonService.TriggerUpdate:output_type -> daemon.TriggerUpdateResponse
	78,  // 115: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	80,  // 116: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	82,  // 117: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	84,  // 118: daemon.DaemonService.RequestExtendAuthSession:output_type -> daemon.RequestExtendAuthSessionResponse
	86,  // 119: daemon.DaemonService.WaitExtendAuthSession:output_type -> daemon.WaitExtendAuthSessionResponse
	88,  // 120: daemon.DaemonService.DismissSessionWarning:output_type -> daemon.DismissSessionWarningResponse
	90,  // 121: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	92,  // 122: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	94,  // 123: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
	96,  // 124: daemon.DaemonService.ExposeService:output_type -> daemon.ExposeServiceEvent
...
func file_daemon_proto_init() {
	...
	file_daemon_proto_msgTypes[79].OneofWrappers = []any{}
