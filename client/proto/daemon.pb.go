...
type PeerState struct {
	...
	LastHealthCheck            *timestamppb.Timestamp `protobuf:"bytes,16,opt,name=lastHealthCheck,proto3" json:"lastHealthCheck,omitempty"`
	Healthy                    bool                   `protobuf:"varint,17,opt,name=healthy,proto3" json:"healthy,omitempty"`
	Latency                    *durationpb.Duration   `protobuf:"bytes,18,opt,name=latency,proto3" json:"latency,omitempty"`
}
...
func (x *PeerState) GetLastHealthCheck() *timestamppb.Timestamp {
	if x != nil {
...
func (x *PeerState) GetHealthy() bool {
	if x != nil {
		return x.Healthy
	}
	return false
...
var file_daemon_proto_rawDesc = []byte{
	...
	0x22, 0x96, 0x06, 0x0a, 0x09, 0x50, 0x65, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0e,
	...
	,
...
var file_daemon_proto_depIdxs = []int32{
	...
	18, // 3: daemon.PeerState.lastHealthCheck:type_name -> google.protobuf.Timestamp
	19, // 4: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	15, // 5: daemon.FullStatus.managementState:type_name -> daemon.ManagementState
	14, // 6: daemon.FullStatus.signalState:type_name -> daemon.SignalState
	13, // 7: daemon.FullStatus.localPeerState:type_name -> daemon.LocalPeerState
	12, // 8: daemon.FullStatus.peers:type_name -> daemon.PeerState
	16, // 9: daemon.FullStatus.relays:type_name -> daemon.RelayState
