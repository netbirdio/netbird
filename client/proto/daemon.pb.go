...
type GetConfigResponse struct {
	...
	DeviceAuthorizationFlow *DeviceAuthorizationFlow `protobuf:"bytes,6,opt,name=deviceAuthorizationFlow,proto3" json:"deviceAuthorizationFlow,omitempty"`
}
...
func (x *GetConfigResponse) GetDeviceAuthorizationFlow() *DeviceAuthorizationFlow {
	if x != nil {
		return x.DeviceAuthorizationFlow
	}
	return nil
}
...
type DeviceAuthorizationFlow struct {
	...
	Provider       DeviceAuthorizationFlowProvider `protobuf:"varint,1,opt,name=Provider,proto3,enum=daemon.DeviceAuthorizationFlowProvider" json:"Provider,omitempty"`
...
var file_daemon_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x8e, 0x02, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52,
	...
	,
	...
	0x69, 0x64, 0x65, 0x72, 0x12, 0x3e, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x64,
	0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x2e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x43, 0x6f,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x48, 0x4f, 0x53, 0x54, 0x45, 0x44, 0x10, 0x00, 0x22, 0x84, 0x01, 0x0a,
	...
	0x6e, 0x63, 0x65, 0x32, 0xaa, 0x02, 0x0a, 0x0d, 0x44, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x53, 0x65,
...
var file_daemon_proto_goTypes = []interface{}{
	(DeviceAuthorizationFlowProvider)(0), // 0: daemon.DeviceAuthorizationFlow.provider
	(*LoginRequest)(nil),                 // 1: daemon.LoginRequest
	(*LoginResponse)(nil),                // 2: daemon.LoginResponse
	(*UpRequest)(nil),                    // 3: daemon.UpRequest
	(*UpResponse)(nil),                   // 4: daemon.UpResponse
	(*StatusRequest)(nil),                // 5: daemon.StatusRequest
	(*StatusResponse)(nil),               // 6: daemon.StatusResponse
	(*DownRequest)(nil),                  // 7: daemon.DownRequest
	(*DownResponse)(nil),                 // 8: daemon.DownResponse
	(*GetConfigRequest)(nil),             // 9: daemon.GetConfigRequest
	(*GetConfigResponse)(nil),            // 10: daemon.GetConfigResponse
	(*DeviceAuthorizationFlow)(nil),      // 11: daemon.DeviceAuthorizationFlow
	(*ProviderConfig)(nil),               // 12: daemon.ProviderConfig
}
var file_daemon_proto_depIdxs = []int32{
	11, // 0: daemon.GetConfigResponse.deviceAuthorizationFlow:type_name -> daemon.DeviceAuthorizationFlow
	0,  // 1: daemon.DeviceAuthorizationFlow.Provider:type_name -> daemon.DeviceAuthorizationFlow.provider
	12, // 2: daemon.DeviceAuthorizationFlow.ProviderConfig:type_name -> daemon.ProviderConfig
	1,  // 3: daemon.DaemonService.Login:input_type -> daemon.LoginRequest
	3,  // 4: daemon.DaemonService.Up:input_type -> daemon.UpRequest
	5,  // 5: daemon.DaemonService.Status:input_type -> daemon.StatusRequest
	7,  // 6: daemon.DaemonService.Down:input_type -> daemon.DownRequest
	9,  // 7: daemon.DaemonService.GetConfig:input_type -> daemon.GetConfigRequest
	2,  // 8: daemon.DaemonService.Login:output_type -> daemon.LoginResponse
	4,  // 9: daemon.DaemonService.Up:output_type -> daemon.UpResponse
	6,  // 10: daemon.DaemonService.Status:output_type -> daemon.StatusResponse
	8,  // 11: daemon.DaemonService.Down:output_type -> daemon.DownResponse
	10, // 12: daemon.DaemonService.GetConfig:output_type -> daemon.GetConfigResponse
