...
type DaemonCertSigningType int32

const (
	DaemonCertSigningType_DAEMON_CERT_SIGNING_INTERNAL DaemonCertSigningType = 0
	DaemonCertSigningType_DAEMON_CERT_SIGNING_ACME     DaemonCertSigningType = 1
)

// Enum value maps for DaemonCertSigningType.
var (
	DaemonCertSigningType_name = map[int32]string{
		0: "DAEMON_CERT_SIGNING_INTERNAL",
		1: "DAEMON_CERT_SIGNING_ACME",
	}
	DaemonCertSigningType_value = map[string]int32{
		"DAEMON_CERT_SIGNING_INTERNAL": 0,
		"DAEMON_CERT_SIGNING_ACME":     1,
	}
)

func (x DaemonCertSigningType) Enum() *DaemonCertSigningType {
	p := new(DaemonCertSigningType)
	*p = x
	return p
}

func (x DaemonCertSigningType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DaemonCertSigningType) Descriptor() protoreflect.EnumDescriptor {
	return file_daemon_proto_enumTypes[2].Descriptor()
}

func (DaemonCertSigningType) Type() protoreflect.EnumType {
	return &file_daemon_proto_enumTypes[2]
}

func (x DaemonCertSigningType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DaemonCertSigningType.Descriptor instead.
func (DaemonCertSigningType) EnumDescriptor() ([]byte, []int) {
...
type CertificateRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SigningType   DaemonCertSigningType  `protobuf:"varint,1,opt,name=signing_type,json=signingType,proto3,enum=daemon.DaemonCertSigningType" json:"signing_type,omitempty"`
...
func (x *CertificateRequest) GetSigningType() DaemonCertSigningType {
	if x != nil {
		return x.SigningType
	}
	return DaemonCertSigningType_DAEMON_CERT_SIGNING_INTERNAL
}

func (x *CertificateRequest) GetWildcard() bool {
	if x != nil {
		return x.Wildcard
	}
	return false
...
func (x *CertificateResponse) GetCertPath() string {
	if x != nil {
		return x.CertPath
	}
	return ""
...
func (x *CertificateResponse) GetKeyPath() string {
	if x != nil {
		return x.KeyPath
	}
	return ""
...
func (x *CertificateResponse) GetDnsNames() []string {
	if x != nil {
		return x.DnsNames
	}
	return nil
...
func (x *CertificateStatusRequest) Reset() {
	*x = CertificateStatusRequest{}
	mi := &file_daemon_proto_msgTypes[90]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CertificateStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CertificateStatusRequest) ProtoMessage() {}

func (x *CertificateStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[90]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CertificateStatusRequest.ProtoReflect.Descriptor instead.
func (*CertificateStatusRequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{90}
}

type CertificateStatusResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	HasCertificate bool                   `protobuf:"varint,1,opt,name=has_certificate,json=hasCertificate,proto3" json:"has_certificate,omitempty"`
	...
	CaTrusted      bool                   `protobuf:"varint,6,opt,name=ca_trusted,json=caTrusted,proto3" json:"ca_trusted,omitempty"`
	CertPath       string                 `protobuf:"bytes,7,opt,name=cert_path,json=certPath,proto3" json:"cert_path,omitempty"`
...
func (x *CertificateStatusResponse) GetHasCertificate() bool {
	if x != nil {
...
func (x *CertificateStatusResponse) GetDnsNames() []string {
	if x != nil {
		return x.DnsNames
	}
	return nil
...
func (x *CertificateStatusResponse) GetExpiresAt() int64 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
func (x *CertificateStatusResponse) GetIssuedAt() int64 {
	if x != nil {
		return x.IssuedAt
	}
	return 0
...
func (x *CertificateStatusResponse) GetIssuer() string {
	if x != nil {
		return x.Issuer
	}
	return ""
...
func (x *CertificateStatusResponse) GetCaTrusted() bool {
	if x != nil {
		return x.CaTrusted
	}
	return false
...
func (x *CertificateStatusResponse) GetCertPath() string {
	if x != nil {
		return x.CertPath
	}
	return ""
...
func (x *CertificateStatusResponse) GetKeyPath() string {
	if x != nil {
		return x.KeyPath
	}
	return ""
...
type TrustCARequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TrustCARequest) Reset() {
	*x = TrustCARequest{}
...
func (x *TrustCARequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrustCARequest) ProtoMessage() {}

func (x *TrustCARequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[92]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrustCARequest.ProtoReflect.Descriptor instead.
func (*TrustCARequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{92}
}

type TrustCAResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Success        bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	CaFingerprints []string               `protobuf:"bytes,2,rep,name=ca_fingerprints,json=caFingerprints,proto3" json:"ca_fingerprints,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *TrustCAResponse) Reset() {
	*x = TrustCAResponse{}
...
func (x *TrustCAResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrustCAResponse) ProtoMessage() {}

func (x *TrustCAResponse) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[93]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrustCAResponse.ProtoReflect.Descriptor instead.
func (*TrustCAResponse) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{93}
}

func (x *TrustCAResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *TrustCAResponse) GetCaFingerprints() []string {
	if x != nil {
...
type UntrustCARequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UntrustCARequest) Reset() {
	*x = UntrustCARequest{}
...
func (x *UntrustCARequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UntrustCARequest) ProtoMessage() {}

func (x *UntrustCARequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[94]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UntrustCARequest.ProtoReflect.Descriptor instead.
func (*UntrustCARequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{94}
}

type UntrustCAResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *UntrustCAResponse) Reset() {
	*x = UntrustCAResponse{}
...
func (x *UntrustCAResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UntrustCAResponse) ProtoMessage() {}

func (x *UntrustCAResponse) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[95]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UntrustCAResponse.ProtoReflect.Descriptor instead.
func (*UntrustCAResponse) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{95}
}

func (x *UntrustCAResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
const file_daemon_proto_rawDesc = "" +
	...
	"\rExposeService\x12\x1c.daemon.ExposeServiceRequest\x1a\x1a.daemon.ExposeServiceEvent\"\x000\x01\x12O\n" +
	...
	"\tUntrustCA\x12\x18.daemon.UntrustCARequest\x1a\x19.daemon.UntrustCAResponse\"\x00B\bZ\x06/protob\x06proto3"
...
var file_daemon_proto_goTypes = []any{
	...
	(DaemonCertSigningType)(0),                 // 2: daemon.DaemonCertSigningType
	(OSLifecycleRequest_CycleType)(0),          // 3: daemon.OSLifecycleRequest.CycleType
	(SystemEvent_Severity)(0),                  // 4: daemon.SystemEvent.Severity
	(SystemEvent_Category)(0),                  // 5: daemon.SystemEvent.Category
	(*EmptyRequest)(nil),                       // 6: daemon.EmptyRequest
	(*OSLifecycleRequest)(nil),                 // 7: daemon.OSLifecycleRequest
	(*OSLifecycleResponse)(nil),                // 8: daemon.OSLifecycleResponse
	...
	(*GetFeaturesRequest)(nil),                 // 77: daemon.GetFeaturesRequest
	(*GetFeaturesResponse)(nil),                // 78: daemon.GetFeaturesResponse
	(*GetPeerSSHHostKeyRequest)(nil),           // 79: daemon.GetPeerSSHHostKeyRequest
	(*GetPeerSSHHostKeyResponse)(nil),          // 80: daemon.GetPeerSSHHostKeyResponse
	(*RequestJWTAuthRequest)(nil),              // 81: daemon.RequestJWTAuthRequest
	(*RequestJWTAuthResponse)(nil),             // 82: daemon.RequestJWTAuthResponse
	(*WaitJWTTokenRequest)(nil),                // 83: daemon.WaitJWTTokenRequest
	(*WaitJWTTokenResponse)(nil),               // 84: daemon.WaitJWTTokenResponse
	(*StartCPUProfileRequest)(nil),             // 85: daemon.StartCPUProfileRequest
	(*StartCPUProfileResponse)(nil),            // 86: daemon.StartCPUProfileResponse
	(*StopCPUProfileRequest)(nil),              // 87: daemon.StopCPUProfileRequest
	(*StopCPUProfileResponse)(nil),             // 88: daemon.StopCPUProfileResponse
	(*InstallerResultRequest)(nil),             // 89: daemon.InstallerResultRequest
	(*InstallerResultResponse)(nil),            // 90: daemon.InstallerResultResponse
	(*ExposeServiceRequest)(nil),               // 91: daemon.ExposeServiceRequest
	(*ExposeServiceEvent)(nil),                 // 92: daemon.ExposeServiceEvent
	(*ExposeServiceReady)(nil),                 // 93: daemon.ExposeServiceReady
	(*CertificateRequest)(nil),                 // 94: daemon.CertificateRequest
	(*CertificateResponse)(nil),                // 95: daemon.CertificateResponse
	(*CertificateStatusRequest)(nil),           // 96: daemon.CertificateStatusRequest
	(*CertificateStatusResponse)(nil),          // 97: daemon.CertificateStatusResponse
	(*TrustCARequest)(nil),                     // 98: daemon.TrustCARequest
	(*TrustCAResponse)(nil),                    // 99: daemon.TrustCAResponse
	(*UntrustCARequest)(nil),                   // 100: daemon.UntrustCARequest
	(*UntrustCAResponse)(nil),                  // 101: daemon.UntrustCAResponse
...
var file_daemon_proto_depIdxs = []int32{
	3,   // 0: daemon.OSLifecycleRequest.type:type_name -> daemon.OSLifecycleRequest.CycleType
	105, // 1: daemon.LoginRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	29,  // 2: daemon.StatusResponse.fullStatus:type_name -> daemon.FullStatus
	106, // 3: daemon.PeerState.connStatusUpdate:type_name -> google.protobuf.Timestamp
	106, // 4: daemon.PeerState.lastWireguardHandshake:type_name -> google.protobuf.Timestamp
	105, // 5: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	...
	59,  // 13: daemon.FullStatus.events:type_name -> daemon.SystemEvent
	...
	102, // 16: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	103, // 17: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	...
	45,  // 23: daemon.ListStatesResponse.states:type_name -> daemon.State
	54,  // 24: daemon.TracePacketRequest.tcp_flags:type_name -> daemon.TCPFlags
	56,  // 25: daemon.TracePacketResponse.stages:type_name -> daemon.TraceStage
	4,   // 26: daemon.SystemEvent.severity:type_name -> daemon.SystemEvent.Severity
	5,   // 27: daemon.SystemEvent.category:type_name -> daemon.SystemEvent.Category
	106, // 28: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	104, // 29: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	59,  // 30: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	105, // 31: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	...
	93,  // 34: daemon.ExposeServiceEvent.ready:type_name -> daemon.ExposeServiceReady
	2,   // 35: daemon.CertificateRequest.signing_type:type_name -> daemon.DaemonCertSigningType
	34,  // 36: daemon.Network.ResolvedIPsEntry.value:type_name -> daemon.IPList
	9,   // 37: daemon.DaemonService.Login:input_type -> daemon.LoginRequest
	11,  // 38: daemon.DaemonService.WaitSSOLogin:input_type -> daemon.WaitSSOLoginRequest
	13,  // 39: daemon.DaemonService.Up:input_type -> daemon.UpRequest
	15,  // 40: daemon.DaemonService.Status:input_type -> daemon.StatusRequest
	17,  // 41: daemon.DaemonService.Down:input_type -> daemon.DownRequest
	19,  // 42: daemon.DaemonService.GetConfig:input_type -> daemon.GetConfigRequest
	30,  // 43: daemon.DaemonService.ListNetworks:input_type -> daemon.ListNetworksRequest
	32,  // 44: daemon.DaemonService.SelectNetworks:input_type -> daemon.SelectNetworksRequest
	32,  // 45: daemon.DaemonService.DeselectNetworks:input_type -> daemon.SelectNetworksRequest
	6,   // 46: daemon.DaemonService.ForwardingRules:input_type -> daemon.EmptyRequest
	39,  // 47: daemon.DaemonService.DebugBundle:input_type -> daemon.DebugBundleRequest
	41,  // 48: daemon.DaemonService.GetLogLevel:input_type -> daemon.GetLogLevelRequest
	43,  // 49: daemon.DaemonService.SetLogLevel:input_type -> daemon.SetLogLevelRequest
	46,  // 50: daemon.DaemonService.ListStates:input_type -> daemon.ListStatesRequest
	48,  // 51: daemon.DaemonService.CleanState:input_type -> daemon.CleanStateRequest
	50,  // 52: daemon.DaemonService.DeleteState:input_type -> daemon.DeleteStateRequest
	52,  // 53: daemon.DaemonService.SetSyncResponsePersistence:input_type -> daemon.SetSyncResponsePersistenceRequest
	55,  // 54: daemon.DaemonService.TracePacket:input_type -> daemon.TracePacketRequest
	58,  // 55: daemon.DaemonService.SubscribeEvents:input_type -> daemon.SubscribeRequest
	60,  // 56: daemon.DaemonService.GetEvents:input_type -> daemon.GetEventsRequest
	62,  // 57: daemon.DaemonService.SwitchProfile:input_type -> daemon.SwitchProfileRequest
	64,  // 58: daemon.DaemonService.SetConfig:input_type -> daemon.SetConfigRequest
	66,  // 59: daemon.DaemonService.AddProfile:input_type -> daemon.AddProfileRequest
	68,  // 60: daemon.DaemonService.RemoveProfile:input_type -> daemon.RemoveProfileRequest
	70,  // 61: daemon.DaemonService.ListProfiles:input_type -> daemon.ListProfilesRequest
	73,  // 62: daemon.DaemonService.GetActiveProfile:input_type -> daemon.GetActiveProfileRequest
	75,  // 63: daemon.DaemonService.Logout:input_type -> daemon.LogoutRequest
	77,  // 64: daemon.DaemonService.GetFeatures:input_type -> daemon.GetFeaturesRequest
	79,  // 65: daemon.DaemonService.GetPeerSSHHostKey:input_type -> daemon.GetPeerSSHHostKeyRequest
	81,  // 66: daemon.DaemonService.RequestJWTAuth:input_type -> daemon.RequestJWTAuthRequest
	83,  // 67: daemon.DaemonService.WaitJWTToken:input_type -> daemon.WaitJWTTokenRequest
	85,  // 68: daemon.DaemonService.StartCPUProfile:input_type -> daemon.StartCPUProfileRequest
	87,  // 69: daemon.DaemonService.StopCPUProfile:input_type -> daemon.StopCPUProfileRequest
	7,   // 70: daemon.DaemonService.NotifyOSLifecycle:input_type -> daemon.OSLifecycleRequest
	89,  // 71: daemon.DaemonService.GetInstallerResult:input_type -> daemon.InstallerResultRequest
	91,  // 72: daemon.DaemonService.ExposeService:input_type -> daemon.ExposeServiceRequest
	94,  // 73: daemon.DaemonService.RequestCertificate:input_type -> daemon.CertificateRequest
	96,  // 74: daemon.DaemonService.GetCertificateStatus:input_type -> daemon.CertificateStatusRequest
	98,  // 75: daemon.DaemonService.TrustCA:input_type -> daemon.TrustCARequest
	100, // 76: daemon.DaemonService.UntrustCA:input_type -> daemon.UntrustCARequest
	10,  // 77: daemon.DaemonService.Login:output_type -> daemon.LoginResponse
	12,  // 78: daemon.DaemonService.WaitSSOLogin:output_type -> daemon.WaitSSOLoginResponse
	14,  // 79: daemon.DaemonService.Up:output_type -> daemon.UpResponse
	16,  // 80: daemon.DaemonService.Status:output_type -> daemon.StatusResponse
	18,  // 81: daemon.DaemonService.Down:output_type -> daemon.DownResponse
	20,  // 82: daemon.DaemonService.GetConfig:output_type -> daemon.GetConfigResponse
	31,  // 83: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	33,  // 84: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	33,  // 85: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	38,  // 86: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	40,  // 87: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	42,  // 88: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	44,  // 89: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	47,  // 90: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	49,  // 91: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	51,  // 92: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	53,  // 93: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	57,  // 94: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	59,  // 95: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	61,  // 96: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	63,  // 97: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	65,  // 98: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	67,  // 99: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	69,  // 100: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	71,  // 101: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	74,  // 102: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	76,  // 103: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	78,  // 104: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	80,  // 105: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	82,  // 106: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	84,  // 107: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	86,  // 108: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	88,  // 109: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	8,   // 110: daemon.DaemonService.NotifyOSLifecycle:output_type -> daemon.OSLifecycleResponse
	90,  // 111: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
	92,  // 112: daemon.DaemonService.ExposeService:output_type -> daemon.ExposeServiceEvent
	95,  // 113: daemon.DaemonService.RequestCertificate:output_type -> daemon.CertificateResponse
	97,  // 114: daemon.DaemonService.GetCertificateStatus:output_type -> daemon.CertificateStatusResponse
	99,  // 115: daemon.DaemonService.TrustCA:output_type -> daemon.TrustCAResponse
	101, // 116: daemon.DaemonService.UntrustCA:output_type -> daemon.UntrustCAResponse
