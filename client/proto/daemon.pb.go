...
type PeerState struct {
	...
	LastHealthCheck            *timestamppb.Timestamp `protobuf:"bytes,17,opt,name=lastHealthCheck,proto3" json:"lastHealthCheck,omitempty"`
	Healthy                    bool                   `protobuf:"varint,18,opt,name=healthy,proto3" json:"healthy,omitempty"`
	Latency                    *durationpb.Duration   `protobuf:"bytes,19,opt,name=latency,proto3" json:"latency,omitempty"`
}
...
var file_daemon_proto_rawDesc = []byte{
	...
	0x22, 0xae, 0x06, 0x0a, 0x09, 0x50, 0x65, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0e,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x12, 0x44, 0x0a, 0x0f,
	...
	0x63, 0x6b, 0x12, 0x18, 0x0a, 0x07, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x79, 0x18, 0x12, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x07, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x79, 0x12, 0x33, 0x0a, 0x07,
	0x6c, 0x61, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
...
var file_daemon_proto_depIdxs = []int32{
	...
	19, // 3: daemon.PeerState.lastHealthCheck:type_name -> google.protobuf.Timestamp
	20, // 4: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	...
	17, // 10: daemon.FullStatus.dns_servers:type_name -> daemon.NSGroupState
	...
	1,  // 17: daemon.DaemonService.Login:output_type -> daemon.LoginResponse
	3,  // 18: daemon.DaemonService.WaitSSOLogin:output_type -> daemon.WaitSSOLoginResponse
	5,  // 19: daemon.DaemonService.Up:output_type -> daemon.UpResponse
	7,  // 20: daemon.DaemonService.Status:output_type -> daemon.StatusResponse
	9,  // 21: daemon.DaemonService.Down:output_type -> daemon.DownResponse
	11, // 22: daemon.DaemonService.GetConfig:output_type -> daemon.GetConfigResponse
