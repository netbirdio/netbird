...
var file_daemon_proto_rawDesc = []byte{
	...
	0x08, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2a, 0x62, 0x0a, 0x08, 0x4c, 0x6f, 0x67,
	...
	0x10, 0x06, 0x12, 0x09, 0x0a, 0x05, 0x54, 0x52, 0x41, 0x43, 0x45, 0x10, 0x07, 0x32, 0xfd, 0x0b,
	...
	0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x08, 0x5a,
...
var file_daemon_proto_goTypes = []interface{}{
	...
	nil,                                      // 58: daemon.Network.ResolvedIPsEntry
	(*PortInfo_Range)(nil),                   // 59: daemon.PortInfo.Range
	nil,                                      // 60: daemon.SystemEvent.MetadataEntry
	(*durationpb.Duration)(nil),              // 61: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),            // 62: google.protobuf.Timestamp
}
var file_daemon_proto_depIdxs = []int32{
	61, // 0: daemon.LoginRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	22, // 1: daemon.StatusResponse.fullStatus:type_name -> daemon.FullStatus
	62, // 2: daemon.PeerState.connStatusUpdate:type_name -> google.protobuf.Timestamp
	62, // 3: daemon.PeerState.lastWireguardHandshake:type_name -> google.protobuf.Timestamp
	61, // 4: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	...
	58, // 13: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	59, // 14: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	...
	62, // 25: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	60, // 26: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	...
	57, // 71: daemon.DaemonService.GetProfiles:output_type -> daemon.GetProfilesResponse
