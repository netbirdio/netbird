...
// NotifySleepRequest for notifying about system sleep event
type NotifySleepRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *NotifySleepRequest) Reset() {
	*x = NotifySleepRequest{}
	mi := &file_daemon_proto_msgTypes[77]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NotifySleepRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotifySleepRequest) ProtoMessage() {}

func (x *NotifySleepRequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[77]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotifySleepRequest.ProtoReflect.Descriptor instead.
func (*NotifySleepRequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{77}
}

// NotifySleepResponse is empty as no data needs to be returned
type NotifySleepResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *NotifySleepResponse) Reset() {
	*x = NotifySleepResponse{}
	mi := &file_daemon_proto_msgTypes[78]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NotifySleepResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NotifySleepResponse) ProtoMessage() {}

func (x *NotifySleepResponse) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[78]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NotifySleepResponse.ProtoReflect.Descriptor instead.
func (*NotifySleepResponse) Descriptor() ([]byte, []int) {
...
const file_daemon_proto_rawDesc = "" +
	...
	"\texpiresIn\x18\x03 \x01(\x03R\texpiresIn\"\x14\n" +
	"\x12NotifySleepRequest\"\x15\n" +
	"\x13NotifySleepResponse*b\n" +
	"\bLogLevel\x12\v\n" +
	...
	"\fWaitJWTToken\x12\x1b.daemon.WaitJWTTokenRequest\x1a\x1c.daemon.WaitJWTTokenResponse\"\x00\x12H\n" +
	"\vNotifySleep\x12\x1a.daemon.NotifySleepRequest\x1a\x1b.daemon.NotifySleepResponse\"\x00B\bZ\x06/protob\x06proto3"
...
var file_daemon_proto_goTypes = []any{
	...
	(*NotifySleepRequest)(nil),                 // 80: daemon.NotifySleepRequest
	(*NotifySleepResponse)(nil),                // 81: daemon.NotifySleepResponse
	nil,                                        // 82: daemon.Network.ResolvedIPsEntry
	(*PortInfo_Range)(nil),                     // 83: daemon.PortInfo.Range
	nil,                                        // 84: daemon.SystemEvent.MetadataEntry
	(*durationpb.Duration)(nil),                // 85: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),              // 86: google.protobuf.Timestamp
}
var file_daemon_proto_depIdxs = []int32{
	85, // 0: daemon.LoginRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	24, // 1: daemon.StatusResponse.fullStatus:type_name -> daemon.FullStatus
	86, // 2: daemon.PeerState.connStatusUpdate:type_name -> google.protobuf.Timestamp
	86, // 3: daemon.PeerState.lastWireguardHandshake:type_name -> google.protobuf.Timestamp
	85, // 4: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	...
	82, // 15: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	83, // 16: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	...
	86, // 27: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	84, // 28: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	54, // 29: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	85, // 30: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	...
	80, // 64: daemon.DaemonService.NotifySleep:input_type -> daemon.NotifySleepRequest
	5,  // 65: daemon.DaemonService.Login:output_type -> daemon.LoginResponse
	7,  // 66: daemon.DaemonService.WaitSSOLogin:output_type -> daemon.WaitSSOLoginResponse
	9,  // 67: daemon.DaemonService.Up:output_type -> daemon.UpResponse
	11, // 68: daemon.DaemonService.Status:output_type -> daemon.StatusResponse
	13, // 69: daemon.DaemonService.Down:output_type -> daemon.DownResponse
	15, // 70: daemon.DaemonService.GetConfig:output_type -> daemon.GetConfigResponse
	26, // 71: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	28, // 72: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	28, // 73: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	33, // 74: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	35, // 75: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	37, // 76: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	39, // 77: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	42, // 78: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	44, // 79: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	46, // 80: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	48, // 81: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	52, // 82: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	54, // 83: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	56, // 84: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	58, // 85: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	60, // 86: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	62, // 87: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	64, // 88: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	66, // 89: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	69, // 90: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	71, // 91: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	73, // 92: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	75, // 93: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	77, // 94: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	79, // 95: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	81, // 96: daemon.DaemonService.NotifySleep:output_type -> daemon.NotifySleepResponse
