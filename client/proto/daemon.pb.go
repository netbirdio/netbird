...
var file_daemon_proto_msgTypes = make([]protoimpl.MessageInfo, 106)
var file_daemon_proto_goTypes = []any{
	...
	(*RequestExtendAuthSessionRequest)(nil),    // 86: daemon.RequestExtendAuthSessionRequest
	(*RequestExtendAuthSessionResponse)(nil),   // 87: daemon.RequestExtendAuthSessionResponse
	(*WaitExtendAuthSessionRequest)(nil),       // 88: daemon.WaitExtendAuthSessionRequest
	(*WaitExtendAuthSessionResponse)(nil),      // 89: daemon.WaitExtendAuthSessionResponse
	(*DismissSessionWarningRequest)(nil),       // 90: daemon.DismissSessionWarningRequest
	(*DismissSessionWarningResponse)(nil),      // 91: daemon.DismissSessionWarningResponse
	(*StartCPUProfileRequest)(nil),             // 92: daemon.StartCPUProfileRequest
	(*StartCPUProfileResponse)(nil),            // 93: daemon.StartCPUProfileResponse
	(*StopCPUProfileRequest)(nil),              // 94: daemon.StopCPUProfileRequest
	(*StopCPUProfileResponse)(nil),             // 95: daemon.StopCPUProfileResponse
	(*InstallerResultRequest)(nil),             // 96: daemon.InstallerResultRequest
	(*InstallerResultResponse)(nil),            // 97: daemon.InstallerResultResponse
	(*ExposeServiceRequest)(nil),               // 98: daemon.ExposeServiceRequest
	(*ExposeServiceEvent)(nil),                 // 99: daemon.ExposeServiceEvent
	(*ExposeServiceReady)(nil),                 // 100: daemon.ExposeServiceReady
	(*StartCaptureRequest)(nil),                // 101: daemon.StartCaptureRequest
	(*CapturePacket)(nil),                      // 102: daemon.CapturePacket
	(*StartBundleCaptureRequest)(nil),          // 103: daemon.StartBundleCaptureRequest
	(*StartBundleCaptureResponse)(nil),         // 104: daemon.StartBundleCaptureResponse
	(*StopBundleCaptureRequest)(nil),           // 105: daemon.StopBundleCaptureRequest
	(*StopBundleCaptureResponse)(nil),          // 106: daemon.StopBundleCaptureResponse
	nil,                                        // 107: daemon.Network.ResolvedIPsEntry
	(*PortInfo_Range)(nil),                     // 108: daemon.PortInfo.Range
	nil,                                        // 109: daemon.SystemEvent.MetadataEntry
	(*durationpb.Duration)(nil),                // 110: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),              // 111: google.protobuf.Timestamp
}
var file_daemon_proto_depIdxs = []int32{
	110, // 0: daemon.LoginRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	25,  // 1: daemon.StatusResponse.fullStatus:type_name -> daemon.FullStatus
	111, // 2: daemon.StatusResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	111, // 3: daemon.PeerState.connStatusUpdate:type_name -> google.protobuf.Timestamp
	111, // 4: daemon.PeerState.lastWireguardHandshake:type_name -> google.protobuf.Timestamp
	110, // 5: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	...
	107, // 16: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	108, // 17: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	...
	111, // 28: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	109, // 29: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	57,  // 30: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	110, // 31: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	70,  // 32: daemon.ListProfilesResponse.profiles:type_name -> daemon.Profile
	111, // 33: daemon.WaitExtendAuthSessionResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	1,   // 34: daemon.ExposeServiceRequest.protocol:type_name -> daemon.ExposeProtocol
	100, // 35: daemon.ExposeServiceEvent.ready:type_name -> daemon.ExposeServiceReady
	110, // 36: daemon.StartCaptureRequest.duration:type_name -> google.protobuf.Duration
	110, // 37: daemon.StartBundleCaptureRequest.timeout:type_name -> google.protobuf.Duration
	...
	101, // 58: daemon.DaemonService.StartCapture:input_type -> daemon.StartCaptureRequest
	103, // 59: daemon.DaemonService.StartBundleCapture:input_type -> daemon.StartBundleCaptureRequest
	105, // 60: daemon.DaemonService.StopBundleCapture:input_type -> daemon.StopBundleCaptureRequest
	...
	78,  // 72: daemon.DaemonService.TriggerUpdate:input_type -> daemon.TriggerUpdateRequest
	80,  // 73: daemon.DaemonService.GetPeerSSHHostKey:input_type -> daemon.GetPeerSSHHostKeyRequest
	82,  // 74: daemon.DaemonService.RequestJWTAuth:input_type -> daemon.RequestJWTAuthRequest
	84,  // 75: daemon.DaemonService.WaitJWTToken:input_type -> daemon.WaitJWTTokenRequest
	86,  // 76: daemon.DaemonService.RequestExtendAuthSession:input_type -> daemon.RequestExtendAuthSessionRequest
	88,  // 77: daemon.DaemonService.WaitExtendAuthSession:input_type -> daemon.WaitExtendAuthSessionRequest
	90,  // 78: daemon.DaemonService.DismissSessionWarning:input_type -> daemon.DismissSessionWarningRequest
	92,  // 79: daemon.DaemonService.StartCPUProfile:input_type -> daemon.StartCPUProfileRequest
	94,  // 80: daemon.DaemonService.StopCPUProfile:input_type -> daemon.StopCPUProfileRequest
	96,  // 81: daemon.DaemonService.GetInstallerResult:input_type -> daemon.InstallerResultRequest
	98,  // 82: daemon.DaemonService.ExposeService:input_type -> daemon.ExposeServiceRequest
	...
	102, // 102: daemon.DaemonService.StartCapture:output_type -> daemon.CapturePacket
	104, // 103: daemon.DaemonService.StartBundleCapture:output_type -> daemon.StartBundleCaptureResponse
	106, // 104: daemon.DaemonService.StopBundleCapture:output_type -> daemon.StopBundleCaptureResponse
	...
	79,  // 116: daemon.DaemonService.TriggerUpdate:output_type -> daemon.TriggerUpdateResponse
	81,  // 117: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	83,  // 118: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	85,  // 119: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	87,  // 120: daemon.DaemonService.RequestExtendAuthSession:output_type -> daemon.RequestExtendAuthSessionResponse
	89,  // 121: daemon.DaemonService.WaitExtendAuthSession:output_type -> daemon.WaitExtendAuthSessionResponse
	91,  // 122: daemon.DaemonService.DismissSessionWarning:output_type -> daemon.DismissSessionWarningResponse
	93,  // 123: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	95,  // 124: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	97,  // 125: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
	99,  // 126: daemon.DaemonService.ExposeService:output_type -> daemon.ExposeServiceEvent
