...
type SleepDownRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SleepDownRequest) Reset() {
	*x = SleepDownRequest{}
...
func (x *SleepDownRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SleepDownRequest) ProtoMessage() {}

func (x *SleepDownRequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SleepDownRequest.ProtoReflect.Descriptor instead.
func (*SleepDownRequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{13}
}

type SleepDownResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SleepDownResponse) Reset() {
	*x = SleepDownResponse{}
...
func (x *SleepDownResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SleepDownResponse) ProtoMessage() {}

func (x *SleepDownResponse) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SleepDownResponse.ProtoReflect.Descriptor instead.
func (*SleepDownResponse) Descriptor() ([]byte, []int) {
...
const file_daemon_proto_rawDesc = "" +
	...
	"\vDownRequest\"\x0e\n" +
	"\fDownResponse\"\x12\n" +
	"\x10SleepDownRequest\"\x13\n" +
	"\x11SleepDownResponse\"P\n" +
	...
	"\x05TRACE\x10\a2\x8a\x13\n" +
	"\rDaemonService\x126\n" +
	"\x05Login\x12\x14.daemon.LoginRequest\x1a\x15.daemon.LoginResponse\"\x00\x12K\n" +
	"\fWaitSSOLogin\x12\x1b.daemon.WaitSSOLoginRequest\x1a\x1c.daemon.WaitSSOLoginResponse\"\x00\x12-\n" +
	"\x02Up\x12\x11.daemon.UpRequest\x1a\x12.daemon.UpResponse\"\x00\x129\n" +
	"\x06WakeUp\x12\x15.daemon.WakeUpRequest\x1a\x16.daemon.WakeUpResponse\"\x00\x129\n" +
	...
	"\tSleepDown\x12\x18.daemon.SleepDownRequest\x1a\x19.daemon.SleepDownResponse\"\x00\x12B\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(*WakeUpRequest)(nil),                      // 10: daemon.WakeUpRequest
	(*WakeUpResponse)(nil),                     // 11: daemon.WakeUpResponse
	(*StatusRequest)(nil),                      // 12: daemon.StatusRequest
	(*StatusResponse)(nil),                     // 13: daemon.StatusResponse
	(*DownRequest)(nil),                        // 14: daemon.DownRequest
	(*DownResponse)(nil),                       // 15: daemon.DownResponse
	(*SleepDownRequest)(nil),                   // 16: daemon.SleepDownRequest
	(*SleepDownResponse)(nil),                  // 17: daemon.SleepDownResponse
	...
	nil,                                        // 84: daemon.Network.ResolvedIPsEntry
	(*PortInfo_Range)(nil),                     // 85: daemon.PortInfo.Range
	nil,                                        // 86: daemon.SystemEvent.MetadataEntry
	(*durationpb.Duration)(nil),                // 87: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),              // 88: google.protobuf.Timestamp
}
var file_daemon_proto_depIdxs = []int32{
	87, // 0: daemon.LoginRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	28, // 1: daemon.StatusResponse.fullStatus:type_name -> daemon.FullStatus
	88, // 2: daemon.PeerState.connStatusUpdate:type_name -> google.protobuf.Timestamp
	88, // 3: daemon.PeerState.lastWireguardHandshake:type_name -> google.protobuf.Timestamp
	87, // 4: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	26, // 5: daemon.SSHServerState.sessions:type_name -> daemon.SSHSessionInfo
	23, // 6: daemon.FullStatus.managementState:type_name -> daemon.ManagementState
	22, // 7: daemon.FullStatus.signalState:type_name -> daemon.SignalState
	21, // 8: daemon.FullStatus.localPeerState:type_name -> daemon.LocalPeerState
	20, // 9: daemon.FullStatus.peers:type_name -> daemon.PeerState
	24, // 10: daemon.FullStatus.relays:type_name -> daemon.RelayState
	25, // 11: daemon.FullStatus.dns_servers:type_name -> daemon.NSGroupState
	58, // 12: daemon.FullStatus.events:type_name -> daemon.SystemEvent
	27, // 13: daemon.FullStatus.sshServerState:type_name -> daemon.SSHServerState
	34, // 14: daemon.ListNetworksResponse.routes:type_name -> daemon.Network
	84, // 15: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	85, // 16: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	35, // 17: daemon.ForwardingRule.destinationPort:type_name -> daemon.PortInfo
	35, // 18: daemon.ForwardingRule.translatedPort:type_name -> daemon.PortInfo
	36, // 19: daemon.ForwardingRulesResponse.rules:type_name -> daemon.ForwardingRule
	...
	44, // 22: daemon.ListStatesResponse.states:type_name -> daemon.State
	53, // 23: daemon.TracePacketRequest.tcp_flags:type_name -> daemon.TCPFlags
	55, // 24: daemon.TracePacketResponse.stages:type_name -> daemon.TraceStage
	...
	88, // 27: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	86, // 28: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	58, // 29: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	87, // 30: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	71, // 31: daemon.ListProfilesResponse.profiles:type_name -> daemon.Profile
	33, // 32: daemon.Network.ResolvedIPsEntry.value:type_name -> daemon.IPList
	...
	10, // 36: daemon.DaemonService.WakeUp:input_type -> daemon.WakeUpRequest
	12, // 37: daemon.DaemonService.Status:input_type -> daemon.StatusRequest
	14, // 38: daemon.DaemonService.Down:input_type -> daemon.DownRequest
	16, // 39: daemon.DaemonService.SleepDown:input_type -> daemon.SleepDownRequest
	18, // 40: daemon.DaemonService.GetConfig:input_type -> daemon.GetConfigRequest
	29, // 41: daemon.DaemonService.ListNetworks:input_type -> daemon.ListNetworksRequest
	31, // 42: daemon.DaemonService.SelectNetworks:input_type -> daemon.SelectNetworksRequest
	31, // 43: daemon.DaemonService.DeselectNetworks:input_type -> daemon.SelectNetworksRequest
	3,  // 44: daemon.DaemonService.ForwardingRules:input_type -> daemon.EmptyRequest
	38, // 45: daemon.DaemonService.DebugBundle:input_type -> daemon.DebugBundleRequest
	40, // 46: daemon.DaemonService.GetLogLevel:input_type -> daemon.GetLogLevelRequest
	42, // 47: daemon.DaemonService.SetLogLevel:input_type -> daemon.SetLogLevelRequest
	45, // 48: daemon.DaemonService.ListStates:input_type -> daemon.ListStatesRequest
	47, // 49: daemon.DaemonService.CleanState:input_type -> daemon.CleanStateRequest
	49, // 50: daemon.DaemonService.DeleteState:input_type -> daemon.DeleteStateRequest
	51, // 51: daemon.DaemonService.SetSyncResponsePersistence:input_type -> daemon.SetSyncResponsePersistenceRequest
	54, // 52: daemon.DaemonService.TracePacket:input_type -> daemon.TracePacketRequest
	57, // 53: daemon.DaemonService.SubscribeEvents:input_type -> daemon.SubscribeRequest
	59, // 54: daemon.DaemonService.GetEvents:input_type -> daemon.GetEventsRequest
	61, // 55: daemon.DaemonService.SwitchProfile:input_type -> daemon.SwitchProfileRequest
	63, // 56: daemon.DaemonService.SetConfig:input_type -> daemon.SetConfigRequest
	65, // 57: daemon.DaemonService.AddProfile:input_type -> daemon.AddProfileRequest
	67, // 58: daemon.DaemonService.RemoveProfile:input_type -> daemon.RemoveProfileRequest
	69, // 59: daemon.DaemonService.ListProfiles:input_type -> daemon.ListProfilesRequest
	72, // 60: daemon.DaemonService.GetActiveProfile:input_type -> daemon.GetActiveProfileRequest
	74, // 61: daemon.DaemonService.Logout:input_type -> daemon.LogoutRequest
	76, // 62: daemon.DaemonService.GetFeatures:input_type -> daemon.GetFeaturesRequest
	78, // 63: daemon.DaemonService.GetPeerSSHHostKey:input_type -> daemon.GetPeerSSHHostKeyRequest
	80, // 64: daemon.DaemonService.RequestJWTAuth:input_type -> daemon.RequestJWTAuthRequest
	82, // 65: daemon.DaemonService.WaitJWTToken:input_type -> daemon.WaitJWTTokenRequest
	5,  // 66: daemon.DaemonService.Login:output_type -> daemon.LoginResponse
	7,  // 67: daemon.DaemonService.WaitSSOLogin:output_type -> daemon.WaitSSOLoginResponse
	9,  // 68: daemon.DaemonService.Up:output_type -> daemon.UpResponse
	11, // 69: daemon.DaemonService.WakeUp:output_type -> daemon.WakeUpResponse
	13, // 70: daemon.DaemonService.Status:output_type -> daemon.StatusResponse
	15, // 71: daemon.DaemonService.Down:output_type -> daemon.DownResponse
	17, // 72: daemon.DaemonService.SleepDown:output_type -> daemon.SleepDownResponse
	19, // 73: daemon.DaemonService.GetConfig:output_type -> daemon.GetConfigResponse
	30, // 74: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	32, // 75: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	32, // 76: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	37, // 77: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	39, // 78: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	41, // 79: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	43, // 80: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	46, // 81: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	48, // 82: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	50, // 83: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	52, // 84: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	56, // 85: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	58, // 86: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	60, // 87: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	62, // 88: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	64, // 89: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	66, // 90: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	68, // 91: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	70, // 92: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	73, // 93: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	75, // 94: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	77, // 95: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	79, // 96: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	81, // 97: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	83, // 98: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
