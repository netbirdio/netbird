...
type Config struct {
	...
	//   
	//   A special value of 'stun' will use the STUN server's XORMappedAddress to set the External IP value; this is
	//   for installations behind dynamic DHCP assuming the above restrictions are met.
	//
	...
	//    
	//  if the "internal" argument is present and "stun" is specified, the STUN request will be generated by a connection
	//    originating from the internal ip/interface 
	//
	//   examples:
