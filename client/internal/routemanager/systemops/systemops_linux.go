...
func getSetupRules() []ruleParams {
	return []ruleParams{
		{105, 0, syscall.RT_TABLE_MAIN, netlink.FAMILY_V4, false, 8, "rule with suppress prefixlen v4"},
		{105, 0, syscall.RT_TABLE_MAIN, netlink.FAMILY_V6, false, 8, "rule with suppress prefixlen v6"},
