...
"sqlite3" when blank) you explicitly check if authS...

### Prompt 57

func (c *CombinedConfig) ToManagementConfig() (*nbconfig.Config, error) {
This function has 103 lines of code, which is greater than the 100 authorized. Split it into smaller functions.

### Prompt 58

given the combined/ version I want to support file location of the storage for sql store, authStore and activityStore
