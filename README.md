...
| <ul><li> - \[x] Peer-to-peer encryption </ul></li>              	 | <ul><li> - \[x] IdP integrations </ul></li>                       	 | <ul><li> - \[x] Single-line self-hosting installation script </ul></li>              	 | <ul><li> - \[x] Windows </ul></li>  	 |
| <ul><li> - \[x] Connection relay fallback </ul></li>            	 | <ul><li> - \[x] SSO & MFA support </ul></li>                      	 | 	                                                                                      | <ul><li> - \[x] Android </ul></li>  	 |
| <ul><li> - \[x] Routes to external networks </ul></li>  	         | <ul><li> - \[x] Access control - groups & rules. </ul></li>      	  | 	                                                                                      | <ul><li> - \[x] iOS </ul></li>      	 |
