...
| <ul><li>- \[x] NAT traversal with BPF</ui></li> | <ul><li>- \[x] [Multiuser support](https://docs.netbird.io/how-to/add-users-to-your-network)</ui></li> | -  \[x] Peer-to-peer encryption</ui></li> || <ul><li>- \[x] iOS</ui></li> |
